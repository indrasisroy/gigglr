...
Route::post('/'.ADMINSEPARATOR.'/deleteusergroupimageadmin',['as' => 'adminimagedeleteroutegroup','uses' => 'admin\AdminuserController@adminusergroupimagedelete']);
    ...
    Route::get('/'.ADMINSEPARATOR.'/admin_issue_with_artist', ['as' => 'admin_issue_with_artist', 'uses' => 'admin\Admin_issue_with_artist_Controller@index']);
     ...
     Route::post('/'.ADMINSEPARATOR.'/sendmail', ['as' => 'admin_issue_with_artist_send_mail', 'uses' => 'admin\Admin_issue_with_artist_Controller@sendmail']);
...
Route::group(['middleware' => ['frontweb']], function () {
   ...
   // Route::get('/profile', ['as' => 'frontendprofile', 'uses' => 'frontend\FrontendprofileController@index']);
    ...
    Route::get('/groupprofile/{seoname?}/{bkflag?}', ['as' => 'frontendgroup', 'uses' => 'frontend\FrontendGroupController@index']);
    ...
    Route::get('/group/{seoname?}', ['as' => 'frontendeditgroup', 'uses' => 'frontend\FrontendGroupController@editgroup']);
    ...
    Route::get('/groupprofilesubmit', ['as' => 'frontendgroupprofilesubmit', 'uses' => 'frontend\FrontendGroupController@groupprofilesubmit']);
...
//******
    ...
    Route::get('/paymentsuccess', ['as' => 'frontendpaymentprocess', 'uses' => 'frontend\FrontendpaymentController@paymentsuccess']);
     Route::get('/showtransactionlist', ['as' => 'frontendshowtransactionlist', 'uses' => 'frontend\FrontendpaymentController@showtransactionlist']);
    
    
     Route::get('/paytobank', ['as' => 'frontendpaytobank', 'uses' => 'frontend\FrontendpaymentController@paytobank']);
