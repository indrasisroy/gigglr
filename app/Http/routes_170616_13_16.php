...
Route::group(['middleware' => ['frontweb']], function () {
   ...
   // Route::get('/profile', ['as' => 'frontendprofile', 'uses' => 'frontend\FrontendprofileController@index']);
     Route::get('/profile/{seoname?}', ['as' => 'frontendprofile', 'uses' => 'frontend\FrontendprofileController@index']);
    ...
    Route::get('/group/{seoname?}', ['as' => 'frontendgroup', 'uses' => 'frontend\FrontendGroupController@index']);
   ...
   //
    Route::get('/venue/{seoname?}', ['as' => 'frontendpublicVenue', 'uses' => 'frontend\FrontendVenueLocationController@index']);
        ...
        Route::post('/presskituploadsaveVenue', ['as' => 'frontendpresskituploadsaveVenue', 'uses' => 'frontend\FrontendVenueLocationController@presskituploadsave']);
