...
Route::group(['middleware' => ['frontweb']], function () {
    ...
    //*********** Frontend group routes starts here
    ...
    //Route::get('/group/{url?}', ['as' => 'frontendgroupedit', 'uses' => 'frontend\FrontendgroupController@editgroup'])->where(['url' => '[0-9]+']);
    ...
    //*********** Frontend group create or edit routes end here
