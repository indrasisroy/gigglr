...
Route::group(['middleware' => ['web']], function () {
    ...
    //****************** For skill Pannel********************
     ...
     Route::get('/'.ADMINSEPARATOR.'/association', ['as' => 'adminassociationroute', 'uses' => 'AdminassociationController@index']);
     Route::get('/'.ADMINSEPARATOR.'/associationadd/{id?}', ['as' => 'adminassociationaddroute', 'uses' => 'AdminassociationController@addassociation'])->where(['id' => '[0-9]+']);
     Route::post('/'.ADMINSEPARATOR.'/associationsave', ['as' => 'adminassociationsaveroute', 'uses' => 'AdminassociationController@saveassociation']);
     Route::get('/'.ADMINSEPARATOR.'/associationdel/{id?}', ['as' => 'adminassociationdelroute', 'uses' => 'AdminassociationController@delassociation'])->where(['id' => '[0-9]+']);
     Route::post('/'.ADMINSEPARATOR.'/associationstatus', ['as' => 'adminassociationstatusroute', 'uses' => 'AdminassociationController@statuschangeassociation']);
     
     Route::post('/'.ADMINSEPARATOR.'/associationcategorynamechange', ['as' => 'adminassociationcommonroute', 'uses' => 'AdminassociationController@commonchangecategory']);
     Route::post('/'.ADMINSEPARATOR.'/associationgenrenamechange', ['as' => 'adminassociationcommonroute', 'uses' => 'AdminassociationController@commonchangegenre']);
    ...
    //****************** For Language Management********************
     ...
     //******************* For FAQ Management ****************
     Route::get('/'.ADMINSEPARATOR.'/faq', ['as' => 'adminfaqroute', 'uses' => 'AdminfaqController@index']);
     Route::get('/'.ADMINSEPARATOR.'/faqadd/{id?}', ['as' => 'adminfaqaddroute', 'uses' => 'AdminfaqController@addfaq'])->where(['id' => '[0-9]+']);
     Route::post('/'.ADMINSEPARATOR.'/faqsave', ['as' => 'adminfaqsaveroute', 'uses' => 'AdminfaqController@savefaq']);
     Route::get('/'.ADMINSEPARATOR.'/faqdel/{id?}', ['as' => 'adminfaqdelroute', 'uses' => 'AdminfaqController@delfaq'])->where(['id' => '[0-9]+']);
     Route::post('/'.ADMINSEPARATOR.'/faqstatus', ['as' => 'adminfaqstatusroute', 'uses' => 'AdminfaqController@statuschangefaq']);
     
     
     //****************** For Contact-us Management********************
     Route::get('/'.ADMINSEPARATOR.'/contactus', ['as' => 'admincontactusroute', 'uses' => 'AdmincontactusController@index']);
     Route::get('/'.ADMINSEPARATOR.'/contactusdel/{id?}', ['as' => 'admincontactusdelroute', 'uses' => 'AdmincontactusController@delcontact'])->where(['id' => '[0-9]+']);

     
     //****************** For Banner Management Pannel********************

     Route::get('/'.ADMINSEPARATOR.'/banner', ['as' => 'adminbannerroute', 'uses' => 'AdminbannerController@index']);
     Route::get('/'.ADMINSEPARATOR.'/banneradd/{id?}', ['as' => 'adminbanneraddroute', 'uses' => 'AdminbannerController@addbanner'])->where(['id' => '[0-9]+']);
     Route::post('/'.ADMINSEPARATOR.'/bannersave', ['as' => 'adminbannersaveroute', 'uses' => 'AdminbannerController@savebanner']);
     Route::get('/'.ADMINSEPARATOR.'/bannerdel/{id?}', ['as' => 'adminbannerdelroute', 'uses' => 'AdminbannerController@delbanner'])->where(['id' => '[0-9]+']);
     Route::post('/'.ADMINSEPARATOR.'/bannerstatus', ['as' => 'adminbannerstatusroute', 'uses' => 'AdminbannerController@statuschangebanner']);
...
Route::group(['middleware' => ['frontweb']], function () {
    ...
    Route::get('/', ['as' => 'frontendhomeroute', 'uses' => 'FrontendhomeController@index']);
    Route::post('/registeruser', ['as' => 'frontendregisteruser', 'uses' => 'FrontendhomeController@registeruser']);
    Route::post('/loginuser', ['as' => 'frontendloginuser', 'uses' => 'FrontendhomeController@loginuser']);
    Route::get('/editprofile', ['as' => 'frontendeditprofile', 'uses' => 'FrontenduserController@index']);
    Route::get('/logout', ['as' => 'frontendlogout', 'uses' => 'FrontendhomeController@logout']);
    Route::post('/saveuserurls', ['as' => 'frontendsaveuserurls', 'uses' => 'FrontenduserController@saveuserurls']);
    Route::post('/saveuserskills', ['as' => 'frontendsaveuserskills', 'uses' => 'FrontenduserController@saveuserskills']);
    Route::post('/saveuserdesc', ['as' => 'frontendsaveuserdesc', 'uses' => 'FrontenduserController@saveuserdesc']);
    Route::post('/saveusername', ['as' => 'frontendsaveusername', 'uses' => 'FrontenduserController@saveusername']);
    Route::post('/populatesubskill', ['as' => 'frontendpopulatesubskill', 'uses' => 'FrontenduserController@populatesubskill']);
    Route::post('/saveskilldata', ['as' => 'frontendsaveskilldata', 'uses' => 'FrontenduserController@saveskilldata']);
     Route::post('/deletemyskill', ['as' => 'frontenddeletemyskill', 'uses' => 'FrontenduserController@deletemyskill']);
    
    //*********** forget password routes starts here
    Route::post('/forgotpass', ['as' => 'frontendforgotpass', 'uses' => 'FrontendhomeController@forgotpassword']);
