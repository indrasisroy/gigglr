...
Route::group(['middleware' => ['frontweb']], function () {
    ...
    Route::post('/saveuserurls', ['as' => 'frontendsaveuserurls', 'uses' => 'FrontendhomeController@saveuserurls']);
    Route::post('/saveuserskills', ['as' => 'frontendsaveuserskills', 'uses' => 'FrontendhomeController@saveuserskills']);
