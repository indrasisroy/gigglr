...
Route::post('/'.ADMINSEPARATOR.'/deleteusergroupimageadmin',['as' => 'adminimagedeleteroutegroup','uses' => 'admin\AdminuserController@adminusergroupimagedelete']);
    ...
    //****************** For Language Management********************
     ...
     Route::post('/'.ADMINSEPARATOR.'/faqstatus', ['as' => 'adminfaqstatusroute', 'uses' => 'admin\AdminfaqController@statuschangefaq']);
        ...
        //*****for multiple faq delete
    Route::get('/'.ADMINSEPARATOR.'/multiplefaqdelete/{id?}', ['as' => 'adminmultiplefaqdeleteroute', 'uses' => 'admin\AdminfaqController@faqdeletemultiple'])->where(['id' => '[A-Za-z0-9,=]+']);     
     //*****for multiple faq delete
     ...
     Route::get('/'.ADMINSEPARATOR.'/contactusdetails/{id?}', ['as' => 'admincontactusdetailsroute', 'uses' => 'admin\AdmincontactusController@detailsview']);
     Route::get('/'.ADMINSEPARATOR.'/contactusdetailsemail/{id?}', ['as' => 'admincontactusdetailsemailroute', 'uses' => 'admin\AdmincontactusController@detailsviewemailpage']);
      Route::post('/'.ADMINSEPARATOR.'/sendemailcontactform', ['as' => 'admincontactusdetailsemailsendroute', 'uses' => 'admin\AdmincontactusController@sendemail']);
     ...
     Route::post('/'.ADMINSEPARATOR.'/amenitiesstatus', ['as' => 'adminamenitiesstatusroute', 'uses' => 'admin\AdminamenitiesController@statuschangeamenities']);
      ...
      //*****for multiple amenities delete
    Route::get('/'.ADMINSEPARATOR.'/multipleamenitiesdelete/{id?}', ['as' => 'adminmultipleamenitiesdeleteroute', 'uses' => 'admin\AdminamenitiesController@amenitiesdeletemultiple'])->where(['id' => '[A-Za-z0-9,=]+']);     
     //*****for multiple amenities delete
    ...
    Route::post('/'.ADMINSEPARATOR.'/populategenre', ['as' => 'adminhomesearchspopulategenre', 'uses' => 'admin\AdminhomesearchController@populategenre']);
     ...
     Route::post('/'.ADMINSEPARATOR.'/supportbypageordering', ['as' => 'adminsupportbypageorderingroute', 'uses' => 'admin\AdminsupportbypageController@orderingchangesupportbypage']);
    ...
    Route::post('/'.ADMINSEPARATOR.'/artistbookertransactionbyadmin', ['as' => 'admin_issue_with_artist_artistbookertransactionbyadmin', 'uses' => 'admin\Admin_issue_with_artist_Controller@artistbookertransactionbyadmin']);
    ...
    Route::get('/'.ADMINSEPARATOR.'/view_venue/{id}', ['as' => 'admin_issue_with_venue_view', 'uses' => 'admin\Admin_issue_with_venue_Controller@view']);
     ...
     Route::get('/'.ADMINSEPARATOR.'/reply_from_admin_venue/{id}', ['as' => 'reply_from_admin_venue', 'uses' => 'admin\Admin_issue_with_venue_Controller@reply_view']);
    ...
    Route::get('/'.ADMINSEPARATOR.'/reply_from_admin_booker/{id}', ['as' => 'reply_from_admin_booker', 'uses' => 'admin\Admin_issue_with_booker_Controller@reply_view']);
 ...
 //**************** for admin display tooltip message starts************************
 Route::get('/'.ADMINSEPARATOR.'/tooltipmessages', ['as' => 'admintooltipmessages', 'uses' => 'admin\AdmintooltipController@index']);
 Route::get('/'.ADMINSEPARATOR.'/tooltipmessagesadd/{id?}', ['as' => 'admintooltipmessagesadd', 'uses' => 'admin\AdmintooltipController@addtooltipmessages'])->where(['id' => '[0-9]+']);
 Route::post('/'.ADMINSEPARATOR.'/tooltipmessagessave', ['as' => 'admintooltipmessagessave', 'uses' => 'admin\AdmintooltipController@savetooltip']);
 //**************** for admin display tooltip message ends************************



 //**********************Send activation link from admin starts here *****************

 
 Route::post('/'.ADMINSEPARATOR.'/sendactivationlinkfromadmin',['as' => 'adminreactivationlinkroute','uses' => 'admin\AdminuserController@sendactivationlinkadmin']);

 
 //**********************Send activation link from admin ends here ******************

 //**************** for faq order starts **********

  Route::post('/'.ADMINSEPARATOR.'/faqordersave', ['as' => 'adminfaqordersave', 'uses' => 'admin\AdminfaqController@faqordersave']);

 //**************** for faq order ends *********
    
 //****************** For Admin Test Send Mail Pannel starts********************
    Route::get('/'.ADMINSEPARATOR.'/admintestmail', ['as' => 'admintestmailroute', 'uses' => 'admin\AdmintestmailController@admintestmail']);
    Route::post('/'.ADMINSEPARATOR.'/sendadmintestmail', ['as' => 'sendadmintestmailroute', 'uses' => 'admin\AdmintestmailController@sendadmintestmail']); 



 //****************** For Admin Test Send Mail Pannel ends********************
...
Route::group(['middleware' => ['frontweb']], function () {
    ...
    Route::post('/contactsupportfrmsub', ['as' => 'frontendcontactsupportfrmsub', 'uses' => 'frontend\FrontendHelpController@contactsupportsubfunc']);
    
    Route::post('/refreshingpicker', ['as' => 'frontendrefreshingpickers', 'uses' => 'frontend\FrontendHelpController@refreshingpicker']);
    
    Route::get('/showdisputerecords', ['as' => 'frontendshowdisputerecords', 'uses' => 'frontend\FrontendHelpController@showdisputerecordsfunc']);
     Route::get('/showdisputereplies/{id}', ['as' => 'frontendshowdisputereplies', 'uses' => 'frontend\FrontendHelpController@showdisputerepliesfunc']);
     Route::post('/frontend-dispute-replies-loadmore', ['as' => 'frontenddisputerepliesloadmore', 'uses' => 'frontend\FrontendHelpController@disputerepliesloadmorefunc']);
     Route::post('/frontdisputereplyfrmsub', ['as' => 'frontenddisputerepliesfrm', 'uses' => 'frontend\FrontendHelpController@frontdisputereplyfrmsubfunc']);
     Route::post('/frontend-dispute-records-loadmore', ['as' => 'frontenddisputerecordsloadmore', 'uses' => 'frontend\FrontendHelpController@disputerecordsloadmorefunc']);
    ...
    //********** Frontend Support routes ends here
      ...
      Route::get('/a/{seoname?}/{bkflag?}', ['as' => 'frontendprofile', 'uses' => 'frontend\FrontendprofileController@index']);
    ...
    Route::post('/getGenere',['as' => 'profilecategorygenere', 'uses' =>'frontend\FrontendprofileController@getgenere']);
     ...
     Route::post('/bookingconfirmartist',['as' => 'frontendartistbookingconfirmartist', 'uses' =>'frontend\FrontendprofileController@completebooking']);//
      ...
      Route::get('/getreviewdata/{extraparam?}', ['as' => 'frontendgetreviewdata', 'uses' => 'frontend\FrontendreviewController@getreviewdata']);
      Route::get('/checkreviewdatatopopulate/{extraparam?}', ['as' => 'frontendcheckreviewdatatopopulate', 'uses' => 'frontend\FrontendreviewController@checkreviewdatatopopulate']);
    ...
    Route::get('/unsubscribe', ['as' => 'frontendunsubscription', 'uses' => 'frontend\FrontendSubscriptionController@unsubscribe']);
    ...
    Route::get('/g/{seoname?}/{bkflag?}', ['as' => 'frontendgroup', 'uses' => 'frontend\FrontendGroupController@index']);
  ...
  //*********** for group seo ends
    ...
    Route::get('/v/{seoname?}/{bkflag?}', ['as' => 'frontendpublicVenue', 'uses' => 'frontend\FrontendVenueLocationController@index']);
...
//******
    ...
    Route::post('/sendescrowmailtobkr', ['as' => 'frontendsendescrowmailtobkr', 'uses' => 'frontend\FrontendGigRosterController@sendescrowmailtobkr']);
    ...
    Route::post('/makecreditcardpaymentrefund', ['as' => 'frontendmakecreditcardpaymentrefund', 'uses' => 'frontend\FrontendpaymentController@makecreditcardpaymentrefund']);
    ...
    //******* for payment related ends *************
     ...
     //****** cron related starts **************
    Route::get('/releaseescrowpayment/{extraparam?}', ['as' => 'frontendreleaseescrowpayment', 'uses' => 'frontend\FrontendchronController@releaseescrowpayment']);
    Route::get('/cancelgigevent/{extraparam?}', ['as' => 'frontendcancelgigevent', 'uses' => 'frontend\FrontendchronController@cancelgigevent']);
    
    Route::get('/checkchronmail/{extraparam?}', ['as' => 'frontendcheckchronmail', 'uses' => 'frontend\FrontendtestemailController@checkchronmail']);
    
    Route::get('/cancelationpaymentreleased/{extraparam?}', ['as' => 'frontendcancelationpaymentreleased', 'uses' => 'frontend\FrontendchronController@cancelationpaymentreleased']);




      Route::get('/releaseofsecuritypayment/{extraparam?}', ['as' => 'frontendreleasesecuritypayment', 'uses' => 'frontend\FrontendchronController@releaseofsecuritymoneytoagvwallet']);

      Route::get('/sendeventnotifyemail/{extraparam?}', ['as' => 'frontendsendeventnotifyemail', 'uses' => 'frontend\FrontendchronController@eventnotifytouseremail']);
    
     Route::get('/checkrefundstatus/{extraparam?}', ['as' => 'frontendcheckrefundstatus', 'uses' => 'frontend\FrontendchronController@checkrefundstatus']);




     Route::get('/canceleventonreqexp/{extraparam?}', ['as' => 'frontendcheckcanceleventonreqexp', 'uses' => 'frontend\FrontendchronController@canceleventonreqexpfnc']);

     Route::get('/canceleventonbookerinsufffund/{extraparam?}', ['as' => 'frontendcanceleventonbookerinsufffund', 'uses' => 'frontend\FrontendchronController@canceleventonbookerinsufffund']);


    
    Route::get('/refundtest/{extraparam?}', ['as' => 'frontendrefundtest', 'uses' => 'frontend\FrontendtestpaymentController@refundtest']);
    
    Route::get('/getservertimezone/{extraparam?}', ['as' => 'getservertimezone', 'uses' => 'frontend\FrontendtestpaymentController@getservertimezone']);
    ...
    //********************************  validation for booking request starts here step wise *************


    Route::post('/artistbookingaddrescheck',['as' => 'frontendartistbookingaddrescheck', 'uses' =>'frontend\FrontendprofileController@artistbookingaddresschk']);

    Route::post('/artistduplicatedatafunc',['as' => 'frontendartistduplicatedatafunc', 'uses' =>'frontend\FrontendprofileController@checkduplicatebookingartist']);

    Route::post('/groupduplicatedatafunc',['as' => 'frontendgroupduplicatedatafunc', 'uses' =>'frontend\FrontendGroupController@checkduplicatedatafuncgroup']);
    
    Route::post('/groupbookingaddrescheck',['as' => 'frontendgroupbookingaddrescheck', 'uses' =>'frontend\FrontendGroupController@groupbookingaddresschk']);


    Route::post('/venueduplicatedatafunc',['as' => 'frontendvenueduplicatedatafunc', 'uses' =>'frontend\FrontendVenueLocationController@checkduplicatedatafuncvenue']);
    
    
    //********************************  validation for booking request ends here step wise  **************





Route::get('/checklatlongvaluefrtst/{extraparam?}', ['as' => 'frontendchecklatlongvaluefrtst', 'uses' => 'frontend\FrontendtestemailController@checklatlongvaluefrtst']);
...
//******  Test email for php info starts here *****************
    
    Route::get('/phpinfocheck/{extraparam?}', ['as' => 'frontendcheckphpinfocheck', 'uses' => 'frontend\FrontendtestemailController@phpinfocheckfunc']);
    
    Route::get('/checktimezonedata/{extraparam?}', ['as' => 'frontendchecktimezonedata', 'uses' => 'frontend\FrontendtestemailController@checktimezonedata']);
    
    

//******  Test email for php info ends here *******************
