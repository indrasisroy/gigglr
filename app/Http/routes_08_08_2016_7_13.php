...
Route::group(['middleware' => ['web']], function () {
    ...
    //****************** For User Management********************
     ...
     //******download press kit
     Route::post('/'.ADMINSEPARATOR.'/userpresskitadmin', ['as' => 'adminuserpressroute', 'uses' => 'admin\AdminuserController@userpresskitadmindownload']);
...
//******
    ...
    Route::get('/testingmail', ['as' => 'testingmail', 'uses' => 'frontend\FrontendPublicprofilegigController@testingmail']);
