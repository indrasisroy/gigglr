                                            ...
                                            if($comp_datetime2_cdt > $comp_datetime1_evr)
                                            {
                                                ...
                                                if($gigpostrequestflag==2) // if individual
                                                {
                                                    ...
                                                    //***** update gig_master query ends *********
                                                     ...
                                                     $mail5 = $this->commonmailcancelonnegotiation($giguniqueid,$flagvalchk=2);
                                                 ...
                                                 elseif($gigpostrequestflag==1) // if gig post
                                                {
                                                    ...
                                                    //***** update gig_bidrequest query ends *********
                                                      ...
                                                      // $mail5 = $this->commonmailcancelonnegotiation($giguniqueid,$flagvalchk=5);
                                        ...
                                        if(!empty($evnt_tz_expdttime) && !empty($evnt_tz_curdttime))
                                        {
                                            ...
                                            if($comp_datetime2_cdt > $comp_datetime1_evr)
                                            {
                                                ...
                                                if($gigpostrequestflag==1)
                                                {
                                                    ...
                                                    $mail3 = $this->commonmailcancelonnegotiation($giguniqueid,$flagvalchk=1);
                                                }
                                                elseif($gigpostrequestflag==2)
                                                {
                                                    //**** mail to booker as well as to  artist/group/venue 
                                                    $mail3 = $this->commonmailcancelonnegotiation($giguniqueid,$flagvalchk=2);
                                                }
                    ...
                    foreach($trackgigpostidAr as $kggid=> $totgbrrows)
                    {
                        ...
                        if($totgbrrows==$exprdgbrrows_tot)
                        {
                            ...
                            */
                            ...
                            $mail3 = $this->commonmailcancelonnegotiation($giguniqueid,$flagvalchk=3);
...
public function commonmailcancelonnegotiation($giguniqueid,$flagvalchk)
{
                ...
                }else if($typeval == '2')
                {
                    ...
                    //     ->get();
                        ...
                        $groupdata = DB::table('group_master')
                            ...
                            ->where('group_master.id',$artistid)
                            ->first();
                            echo "<pre>";
                ...
                }else if($typeval == '3')
                {
                    // $selecttable = 'venue_master';
                            $venuedata = DB::table('venue_master')
                                ...
                                ->where('venue_master.id',$artistid)
                                ->first();
