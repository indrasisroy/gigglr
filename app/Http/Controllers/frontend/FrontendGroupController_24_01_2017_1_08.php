...
//************ Get event ID ends here
                                        ...
                                        $replaceto =array(ucfirst($artistvenuegroupfirstname),ucfirst($artistvenuegrouplastname),'Group',$profilealias,ucfirst($address1val),ucfirst($address2val),$city,$zipdata,$state_name,$country_name,ucfirst($sender_name),ucfirst($booker_name),$Emailskill,$Emailsubskill,$EmailWhen,$sitename,$copyright_year,$bsurl,$logoIMG,$bkngexpirdate,$expirtim,$evntid);
                                        ...
                                        $replaceto =array(ucfirst($bookerdetail[0]->first_name),ucfirst($booker_name),$sitename,$copyright_year,$bsurl,$logoIMG,$evntid);
                                        ...
                                        $returnArray['message'] = 'Great! your Booking Request was sent';
                                        }else{
