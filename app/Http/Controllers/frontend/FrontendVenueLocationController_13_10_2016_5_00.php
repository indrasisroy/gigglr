                ...
                //******
                 ...
                 $data['venuebooking_skill']=$fetchvenueskillAr;
                  ...
                  // added for category and genre end //
                    ...
                    $sess_id = $request->session()->get('front_id_sess');
                    if($sess_id!=''){
                    $login_currency = DB::table('user_master')->select('currency')
                    ->where('id',$sess_id)
                    ->first();
                    ...
                    $group_currency = DB::select( DB::raw("SELECT urm.currency FROM `venue_master` as venue, `user_master`as urm WHERE venue.`id`='".$user_id."' and venue.`creater_id`= urm.`id`"));
...
$chkvalid=$this->checksavebookingrequest_venue($request);
 // echo "<pre>";
                    ...
                    $artistvenuegroup_qry = DB::table('user_master')
                                          ...
                                          //*********getting category and genere data ends
                                               ...
                                               //*********
                                                  ...
                                                  $EmailWhen = $Newdate." at ".$Newtime;
                                               //*********

                   $bookerqry = $this->commonn_email($bookeremail,$bookerusrname,$flag=2,$jj='');
                   $artistvenuegroup_qry = $this->booking_email($artistvenuegroupusrname,$artistvenuegroupemail,$bookerusrname,$bookingcategory_name,$bookinggenre_name,$address1val,$address2val,$towndata,$statename->state_name,$zipdata,$countryname->country_name,$EmailWhen);
...
//************************** save booking options data starts
    ...
    //         {
             ...
             public function commonn_email($receiver_email,$receiver_name,$flag,$bookernm)
      {
         ...
         public function booking_email($artistvenuegroupusrname,$artistvenuegroupemail,$bookerusrname,$bookingcategory_name,$bookinggenre_name,$address1val,$address2val,$towndata,$statename,$zipdata,$countryname,$bkngdate)
      {
            //echo "receiver_name=>".$receiver_name;die;
       ...
       public function checksavevenueaddressamenities($request){
        ...
        public function checksavebookingrequest_venue($request){
                    $validator = Validator::make($request->all(), [
