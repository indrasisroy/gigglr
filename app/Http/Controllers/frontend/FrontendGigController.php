      ...
      if($chkvalid===true)
      {
            ...
            if($latlog['flag']=='1'){
                ...
                $bokingexpired = $bkngexpirdate.' '.$expirtim;
                 ...
                 $chkvalidduplicte=$this->checkpostagigduplicate($request,$final_latitude,$final_longitude,$bkngdate,$strttim);

                  if($chkvalidduplicte == 0)
                     {
         ...
         $booker_country_code = $booker_country->country;
                  ...
                  'event_end_date_time'=>$endtimedt." ".$endtim,//$bkngdate." ".$endtim,
                 ...
                 }else
                 {
                         ...
                         $returnArray['message'] = 'You have already posted a gig for this location at this time';
                 }
...
$validator = Validator::make($request->all(), [
    ...
    function checkpostagigduplicate($request,$final_latitude,$final_longitude,$bkngdate,$strttim)
    {
     $sessionid = $request->input('loginID');
     $latitude = $final_latitude;
     $longitude = $final_longitude;
     $bookingstartdatetime = $bkngdate.' '.$strttim;


     $rt = DB::table('gig_master')->where([ ['artist_id', '=', '0'], ['booker_id', '=', $sessionid],['event_address_lat', '=', $latitude],['event_address_long', '=', $longitude],['event_start_date_time','=',$bookingstartdatetime],['booking_status','=','2'],['gigpostrequestflag','=','1'],])->get();
      
      $countduplocatebooking = 0;
      $countduplocatebooking = count($rt);
   //  echo "Number of rows returned  ".$countduplocatebooking;die;
     return $countduplocatebooking;
