             ...
             public function commonn_email($receiver_email,$receiver_name,$flag,$eventidtoemail,$bookernm)
      {
            //echo "receiver_name=>".$receiver_name;die;
                  ...
                  }else if($flag == 2)
                  {
                    ...
                    $replaceto =array(ucfirst($receiver_name),ucfirst($receiver_name),$sitename,$copyright_year,$bsurl,$logoIMG,$eventidtoemail);
