...
// die;
 ...
 //****************insert into gig_notify table***********//
                    ...
                    $artistvenuegroup_qry = $this->booking_email_artist($artistvenuegroupusrname,$artistvenuegroupemail,$bookerusrname,$bookingcategory_name,$bookinggenre_name,$address1val,$address2val,$towndata,$statename->state_name,$zipdata,$countryname->country_name,$EmailWhen);
