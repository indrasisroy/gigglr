...
class FrontendHelpController extends Controller
{
    ...
    {
        $against_artist_query=''; $against_group_query=''; $against_venue_query=''; $against_booker_query='';
        $datasupport=array(); $against_artist=array(); $against_group=array(); $against_venue=array(); $against_booker=array(); $against_artist_content=array(); $against_group_content=array(); $against_venue_content=array(); $against_booker_content=array();
...
AND ((DATE_FORMAT(gm.event_end_date_time, '%Y-%m-%d') >= '".$prev_date."') AND (DATE_FORMAT(gm.event_end_date_time, '%Y-%m-%d') <= '".$today."'))"
			);
