       ...
       public function registeruser(Request $request)
    {
           ...
           if($chkvalid===true)
           {
                 ...
                 // $activation_link=$bsurl."activateuser/".time()."/".base64_encode($isInserted);
                  ...
                  $replaceto =array(ucfirst($nickname),$email,$password,$sitename,$copyright_year,$bsurl,$logoIMG,$activation_link_text);
                ...
                $validator->after(function($validator)  use ($userData)  {
                       ...
                       $password=$userData['password'];
                        ...
                        //****fetch data to check starts
                                ...
                                {
                                         $validator->errors()->add('email', "The e-mail or password is incorrect.");
                                }
                ...
                $validator->after(function($validator)  use ($userData)  {
                       ...
                       $email=$userData['email'];
                        ...
                        //****fetch data to check starts
                                ...
                                {
                                         $validator->errors()->add('email', "The e-mail entered is incorrect.");
                                }
