                  ...
                  //  echo "<br>";
                   $artist_type = $qryfornotifyuserobj->type_flag;
                        ...
                        $email='';$artistname='';
                           $wherefar=array("id"=>$artistid);
                            ...
                            $userdta_db=$userdta_db->first();
                                ...
                                $sndmailartist = $this->sendemailnotify($when,$event_zip,$category,$genre,$eventid,$address1,$address2,$country,$state,$city,$eventdate,$artistname,$artistname,$email);
                            ...
                            $sndmailbooker = $this->sendemailnotify($when,$event_zip,$category,$genre,$eventid,$address1,$address2,$country,$state,$city,$eventdate,$bookername,$artistname,$bookeremail);    
                    ...
                    {   
                            ...
                            $sndmailgrp = $this->sendemailnotify($when,$event_zip,$category,$genre,$eventid,$address1,$address2,$country,$state,$city,$eventdate,$artistnickname,$groupname,$email);
                    ...
                    {   
                        ...
                        $sndmailvenue = $this->sendemailnotify($when,$event_zip,$category,$genre,$eventid,$address1,$address2,$country,$state,$city,$eventdate,$artistnickname,$venuename,$email);   
...
public function sendemailnotify($when,$event_zip,$category,$genre,$eventid,$address1,$address2,$country,$state,$city,$eventdate,$artistnickname,$argvvenuename,$emailto)
{   
    // echo "*********<br>";
    // echo $eventid;
    // echo "wr=".$address1;
    ...
    // echo "**********<br>";
                   ...
                   // *********Helper Function Starts here
                    ...
                    $replacefrom =array('{Accountfname}','{ARGRPVNU}','{PROFILEALIAS}','{SKILL}','{SUBSKILL}','{WHEN}','{add1}','{add2}','{State}','{Zip}','{SITENAME}','{YEAR}','{BASE_URL}','{LOGO_IMG}');

                    $replaceto =array($artistnickname,$eventid,$argvvenuename,$category,$genre,$when,$address1,$address2,$state,$event_zip,$sitename,$copyright_year,$bsurl,$logoIMG);
