...
class FrontendhomeController extends Controller
{
    ...
    public function index(Request $request)
    {
          ...
          //****   random home search data fetch starts   ****//
                      ...
                      $home_search_db=$home_search_db->select(DB::raw('hs.id,hs.title,hs.location,hs.description,hs.skill_id,hs.image_name,hs.image_title'));
                      ...
                      $data['homesearchAr']=$homesearchAr;
