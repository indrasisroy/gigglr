...
AND gm.id NOT IN (SELECT cancel_gig_id from contact_us)
        ...
        if(isset($sess_user_id) && $sess_user_id!=0)
        {
			$against_artist_nest_query = DB::select("SELECT id,(event_end_date_time + INTERVAL 24 HOUR) AS event_end FROM gig_master WHERE booker_id='".$sess_user_id."' AND type_flag='1' AND booking_status='1' AND artist_id!='0'");
...
//AND gm.id NOT IN (SELECT gig_id from resolve_dispute)"
			...
			$against_group_nest_query = DB::select("SELECT id,(event_end_date_time + INTERVAL 24 HOUR) AS event_end FROM gig_master WHERE booker_id='".$sess_user_id."' AND type_flag='2' AND booking_status='1' AND artist_id!='0'");
			//print_r($against_artist_nest_query);die;
...
//			);
			...
			$against_venue_nest_query = DB::select("SELECT id,(event_end_date_time + INTERVAL 24 HOUR) AS event_end FROM gig_master WHERE booker_id='".$sess_user_id."' AND type_flag='3' AND booking_status='1' AND artist_id!='0'");
			//print_r($against_artist_nest_query);die;
...
//			);
			...
			$against_booker_nest_query = DB::select("SELECT id,(event_end_date_time + INTERVAL 24 HOUR) AS event_end FROM gig_master WHERE ( (artist_id='".$sess_user_id."' AND type_flag='1')
...
//			);
	...
	AND gm.id NOT IN (SELECT cancel_gig_id from contact_us)
			...
			$against_artist_nest_query = DB::select("SELECT id,(event_end_date_time + INTERVAL 24 HOUR) AS event_end FROM gig_master WHERE booker_id='".$frontloginuserid."' AND type_flag='1' AND booking_status='1' AND artist_id!='0'");
...
AND gm.id NOT IN (SELECT gig_id from resolve_dispute)"
			...
			$against_group_nest_query = DB::select("SELECT id,(event_end_date_time + INTERVAL 24 HOUR) AS event_end FROM gig_master WHERE booker_id='".$frontloginuserid."' AND type_flag='2' AND booking_status='1' AND artist_id!='0'");
...
AND gm.id NOT IN (SELECT gig_id from resolve_dispute)"
			...
			$against_venue_nest_query = DB::select("SELECT id,(event_end_date_time + INTERVAL 24 HOUR) AS event_end FROM gig_master WHERE booker_id='".$frontloginuserid."' AND type_flag='3' AND booking_status='1' AND artist_id!='0'");
...
AND gm.id NOT IN (SELECT gig_id from resolve_dispute)"
			...
			$against_booker_nest_query = DB::select("SELECT id,(event_end_date_time + INTERVAL 24 HOUR) AS event_end FROM gig_master WHERE ( (artist_id='".$frontloginuserid."' AND type_flag='1')
