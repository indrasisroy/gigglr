...
class FrontendRosterController extends Controller
{
    ...
    public function giguserfeeds(Request $request)
    {
        ...
        where
        ( DATEDIFF( now( ) , DATE_FORMAT( rcl.event_end_date_time , '%Y-%m-%d %H:%i:%s' ) ) <=30 ) AND
        
        DATE_FORMAT(rcl.event_start_date_time,'%Y-%m-%d')  BETWEEN STR_TO_DATE('".$selectedfirstdate."','%Y-%m-%d') AND STR_TO_DATE('".$selectedlastdate."','%Y-%m-%d')
       ...
       UNION
        ...
        where
        ( DATEDIFF( now( ) , DATE_FORMAT( psq.event_end_date_time , '%Y-%m-%d %H:%i:%s' ) ) <=30 ) AND
        DATE_FORMAT(psq.event_start_date_time,'%Y-%m-%d')  BETWEEN STR_TO_DATE('".$selectedfirstdate."','%Y-%m-%d') AND STR_TO_DATE('".$selectedlastdate."','%Y-%m-%d')
