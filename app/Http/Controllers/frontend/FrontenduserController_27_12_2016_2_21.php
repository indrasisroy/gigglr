...
class FrontenduserController extends Controller
{
    ...
    public function index(Request $request)
    {
               ...
               // echo "=fetchskillmasterdata==><pre>";  print_r($fetchskillmasterdata); echo "</pre>";
                ...
                //*** fetch this user related images starts                              
                  ...
                  // $presskitflagcheck = 0;
                  // $presskitcheck = DB::table('user_presskit')->where('user_id',$user_id)->first();
                  // if($presskitcheck)
                  // {
                  //   $presskitflagcheck = 1;
                  // }else
    ...
    public function checksaveuserurls($request,$id=0)
          ...
          public function saveuserdesc(Request $request)
        {
            ...
            $user_description = html_entity_decode($request->input('user_description',''));
    ...
    public function checksaveusername($request,$id=0)
           {
                ...
                "nickname" => "required"         
                   ...
                   "nickname.required" => " Your profile title or alias is required"                  
     ...
     //*************************** delete skill data starts
          ...
          public function deletemyskill(Request $request)
        {
           ...
           if($chkvalid===true)
           {
                 ...
                 //*** save  data of user starts
                        ...
                        //*******this section is added for delete checking starts here
                         ...
                         $countdplicktchk =0;
                                                          ...
                                                          ->where('gig_master.artist_id',$user_id)
                                                          ...
                                                          ->where('gig_master.booker_id',$user_id)
                                                          ->where('gig_skill_rel.genre',$skill_sub_id)
                                                          ->get();
                        ...
                        //*******this section is added for delete checking ends here
        ...
        // echo "Sub skill is ".$skill_sub_id;
        //  echo "<pre>";
       ...
       //************************** upload presskit starts
            ...
            {   
                        $validator = Validator::make($request->all(), [
                                    ...
                                    "abndata.numeric" => "This ABN Cannot be saved",//"Only numerics are allowed",
                        ]);
            ...
            public function checkabnlengthvalid($request)
            {
                        ...
                        if($abnlength>11)
                        {
                                    $errorMsg[]="An ABN can only be up to 11 numbers";//" Maximum 11 digits ";
                        }
            ...
            public function savepagemetatagcustfunc(Request $request)
            {
             ...
             public function savepageseotagcustfunc(Request $request)
            {
                        $pagemetatagdata = addslashes(trim($request->input('pagemetatagdata','')));
                        $id=0; $flag_id=0; $error_message=''; $responseAr=array(); $error_msgAr=array();
                        $chkvalid=$this->checksavepagemetatag($request,$id);
            ...
            {
                        $validator = Validator::make($request->all(), [
                                    "pagemetatagdata" => array('required:required','max:100','regex:/^[a-zA-Z0-9-_]+$/'),//alpha_dash
                              //  "pagemetatagdata" => 'required|max:100|alpha_num',
                        ],[
                       ...
                       // $userData['request']=$request;
                         ...
                         $validator->after(function($validator)  use ($userData)  { 
                            ...
                            {
                              $chkseoname = DB::table('user_master')->where('user_type',3)->where('id','<>',$userid)->where('seo_name',$pagemetatagdata)->get();
