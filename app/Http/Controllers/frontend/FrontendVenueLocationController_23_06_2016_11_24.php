...
class FrontendVenueLocationController extends Controller
{
    ...
    public function index(Request $request)
    {
                       ...
                       $uu = $request->segment(2);
                        ...
                        //$user_id = 0;
                        $user_single = DB::table('venue_master')->where('nickname',$uu)->first();
                        if($user_single)
                        {
               ...
               //***********Fetch Venue amenities starts here
    ...
    public function edit_venue(Request $request)
    {
       ...
       {    // }
                   ...
                   if(empty($chkvenuexistsqry)){
                                      ...
                                      ['create_date' => date('Y-m-d H:i:s'), 'creater_id' =>$sess_idchk]
          ...
          public function saveusernamevenue(Request $request)
        {
           ...
           if($chkvalid===true)
           {
                 ...
                 //*** save  data of user starts
                        ...
                        ->update(
                        ['modified_date' => date('Y-m-d H:i:s'),'venue_name' => $nickname,'nickname' => $seotitle]
                        );
    ...
    public function checksaveusername($request,$id=0)
           {
                ...
                "nickname" => "required|min:5|max:50|unique:venue_master,venue_name,".$id         
