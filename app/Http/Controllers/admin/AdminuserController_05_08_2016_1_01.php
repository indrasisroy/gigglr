...
class AdminuserController extends Controller
{
    ...
    public function saveuser(Request $request)
    {
            ...
            $instagram_url = $request->input('instagramurl');  
             ...
             $datepicker2 = trim($request->input('datepicker2')); 
    ...
    public function validateuserall(Request $request,$userid=0)
    {
        $validator = Validator::make($request->all(), [
                ...
                'gender'=>"required",
                'datepicker2'=> "required|date|date_format:m/d/Y",
                'address1'=>"required",
                'country_id'=>"required",
                'state_id'=>"required",
                'city'=>"required",
            ...
            [   'first_name.required'=>' * First name is required ',
                ...
                'datepicker2.required'=>'* Date is required',
                'datepicker2.date'=>'* Enter valid date',
                'datepicker2.date_format'=>'* Enter valid date format',
