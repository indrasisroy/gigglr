...
if($formtype == 1)
{
                ...
                if(empty($uid))
                {
                  ...
                  $replaceto =array(ucfirst($nickname),$email,$pwd,$sitenm,$copyrightyr,$bsurl,$logoIMG);
...
//********for venue section
                        ...
                        {
                             $fetchcategory_qry = DB::table('venue_skill_rel')
                                            ->join('skill_master', function ($join)
                                            {
                                            $join->on('venue_skill_rel.skill_id','=','skill_master.id')
                                            ->orOn('venue_skill_rel.skill_sub_id','=','skill_master.id');
                                            })
                                            ->distinct()
                                            ->select('skill_master.name','skill_master.parent_id','skill_master.id')
                                            ->where([['venue_id','=',$vnuID],['v_creator_id','=',$vnucreatrID],['catag_type_id','=','3'],])
                                    ...
                                    $languageidAr = array();
                                    $countfetchcategory_qry = count($fetchcategory_qry);
                                    $i = 0;
                                    foreach($fetchcategory_qry as $fetchcategory_obj)
                                    {
                                        $i++;
                                        if($i == $countfetchcategory_qry)
                                        {
                                            $j = '.';
                                        }else
                                        {
                                       ...
                                       if($fetchcategory_obj->parent_id==0)
                                     {
                                        $languageidAr[]='<br><strong>'.stripslashes($fetchcategory_obj->name).'</strong> : ';
                                     }

                                     if($fetchcategory_obj->parent_id!=0)
                                     {
                                        $languageidAr[]='  '.stripslashes($fetchcategory_obj->name).'<a data-toggle="modal" onclick="showmemenue('.$fetchcategory_obj->id.','.$fetchcategory_obj->parent_id.');" href="javascript:void(0)" data-subskillidvenue='.$fetchcategory_obj->id.'#########'.$fetchcategory_obj->parent_id.' id=prnt'.$fetchcategory_obj->id.' class="subskilldeleteajax"> <i class="fa fa-times" aria-hidden="true"></i> </a>'.$j;
                                     }
              ...
              public function skillwisesubskillsavefuncgroup(Request $request)
                          ...
                          public function skillwisesubskilldisplaygroup(Request $request)
                        {
                           ...
                           public function commongroupcategory_subcategory($groupID,$grupcreatrID)
                            {
                                $fetchcategory_qry = DB::table('group_skill_rel')
                                            ->join('skill_master', function ($join)
                                            {
                                            $join->on('group_skill_rel.skill_id','=','skill_master.id')
                                            ->orOn('group_skill_rel.skill_sub_id','=','skill_master.id');
                                            })
                                            ->distinct()
                                            ->select('skill_master.name','skill_master.parent_id','skill_master.id')
                                            ->where([['group_id','=',$groupID],['g_creator_id','=',$grupcreatrID],['catag_type_id','=','2'],])
                                    ...
                                    foreach($fetchcategory_qry as $fetchcategory_obj)
                                    {
                                     ...
                                     if($fetchcategory_obj->parent_id!=0)
                                     {
                                        $languageidAr[]='  '.stripslashes($fetchcategory_obj->name).'<a data-toggle="modal" onclick="showmedelgroup('.$fetchcategory_obj->id.','.$fetchcategory_obj->parent_id.');" href="javascript:void(0)" data-subskillidvenue='.$fetchcategory_obj->id.'#########'.$fetchcategory_obj->parent_id.' id=prnt'.$fetchcategory_obj->id.' class="subskilldeleteajax"> <i class="fa fa-times" aria-hidden="true"></i> </a>'.$j;
                                     }
                ...
                public function userskillwisesubskillshowfunc(Request $request)
                {
                 ...
                 public function userskillwisesubskillsavefunc(Request $request)
                        ...
                        public function skillwisesubskilldisplayeuser(Request $request)
                        {
                            ...
                            {
                                $fetchcategory_qry = DB::table('user_skill_rel')
                                            ->join('skill_master', function ($join)
                                            {
                                            $join->on('user_skill_rel.skill_id','=','skill_master.id')
                                            ->orOn('user_skill_rel.skill_sub_id','=','skill_master.id');
                                            })
                                            ->distinct()
                                            ->select('skill_master.name','skill_master.parent_id','skill_master.id')
                                            ->where([['user_id','=',$userID],['catag_type_id','=','1'],])
                                    ...
                                    foreach($fetchcategory_qry as $fetchcategory_obj)
                                    {
                                     ...
                                     if($fetchcategory_obj->parent_id!=0)
                                     {
                                        $languageidAr[]='  '.stripslashes($fetchcategory_obj->name).'<a data-toggle="confirmation" onclick="showmedeluser('.$fetchcategory_obj->id.','.$fetchcategory_obj->parent_id.');" href="javascript:void(0)" data-subskillidvenue='.$fetchcategory_obj->id.'#########'.$fetchcategory_obj->parent_id.' id=prnt'.$fetchcategory_obj->id.' class="subskilldeleteajax"> <i class="fa fa-times" aria-hidden="true"></i> </a>'.$j;
                                     }
