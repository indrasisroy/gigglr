     ...
     public function logincheck(Request $request)
      {
          ...
          if($validate_login===true)
          {
               // return redirect(ADMINSEPARATOR.'/login');
                    ...
                    $status=0;$user_type=1;$userid=0;$last_login_ip='';
          ...
          public function get_client_ip_server() {
           ...
           public function validateloginform($request)
           {
               $password = $request->input('password');
                    ...
                    'username' => 'required|max:100|checkadminusername:'.$password,
                    'password'=>'required'
                    
                    ],['username.required'=>'*Username field required',
                       'password.required'=>'*Password field required',
                       'username.checkadminusername'=>'*Either username or password is incorrect',
                       ]);
