    ...
    public function index(Request $request, $id=0)
    {
        ...
        // }
            ...
            $selectfields=" id,payment_for,charge_token,payment_description,payment_status,
                ...
                $user_order_translist=$user_order_translist->select(DB::raw('uo.id,uo.payment_for,uo.charge_token,uo.payment_description,uo.payment_status,uo.total_price,uo.payment_scheme,uo.debitorcredit,uo.gigmaster_id,uo.invoice_num,uo.user_id,uo.create_date,lc.currency_icon,IF(uo.gigmaster_id >0, (select gm.giguniqueid from gig_master as gm where gm.id=uo.gigmaster_id),"----") as giguniqueid'));
                $user_order_translist=$user_order_translist->where('uo.user_id',$id);
