...
if($formtype == 1)
{
            ...
            else
            {
                if(empty($uid))
                {
                   // $request->session()->flash('admin_errormsgdata_sess', 'Please complete all required fields');
        ...
        $validator = Validator::make($request->all(), [
            ...
            //********for upload press kit validation starts here
                     ...
                     $validator->after(function($validator)  use ($userData)  {
                                    ...
                                    $validatepresschk=$this->presskitisinvalid($request,$addeditid);
   ...
   public function presskitisinvalid($request,$addeditid=0)
        {   
