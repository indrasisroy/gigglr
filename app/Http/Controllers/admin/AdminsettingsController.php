...
// exit();
    ...
    public function updatesettings(Request $request)
    {
		  $imgarray =array();
           ...
           $copyright_year=addslashes($request->input('copyright_year'));


		       $wc_text = addslashes($request->input('wctext'));
           //$spwctext = addslashes($request->input('spwctext'));
           //$hlpwctext = addslashes($request->input('hlpwctext'));
           ...
           $facebook_api = addslashes($request->input('facebook_api'));
		   ...
		   $service_charge = addslashes($request->input('service_charge'));
		   $site_commission = addslashes($request->input('site_commission'));
		   $referral_commission = addslashes($request->input('referral_commission'));
		   //echo $service_charge."  ".$site_commission;die;
...
$chkimgresp=Imageuploadlib::imageupload($request,$filecontrolname="afterlogin_logo_image",$allowedFileExtAr,$allowedFileExtSizeAr,$allowedFileResolAr,$func,$addeditid=0,$destinationsourcePath2) ;
      ...
      //'support_welcome_text' =>$spwctext,
      //'help_welcome_text' =>$hlpwctext,
       ...
       public function dashboard(Request $request)
          ...
          //'hlpwctext'=>'required',
					...
					'referral_commission' => 'numeric|min:0|max:100',
                       ...
                       'copyright_year'=>'Copy Right field is required',
					   'wctext.required'=>'Welcome text field is required',
             //'spwctext.required'=>'Support text field is required',
             //'hlpwctext.required'=>'Help text field is required',
                       ...
                       'facebook_api.required'=>'Facebook App ID is required',
					   ...
					   'pin_publishable_key.required'=>'Pin Publishable Key field is required',
						'service_charge.integer'=>'Only numbers are allowed',
						'site_commission.integer'=>'Only numbers are allowed',
						'referral_commission.integer'=>'Only numbers are allowed',
             // 'service_charge.max'=>'Maximum two digits are allowed',
