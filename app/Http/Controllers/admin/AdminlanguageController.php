        ...
        **/
        ...
        public function checklanguageform($request,$id=0)
        {
                $validator = Validator::make($request->all(),
                        [
                                'language_name' => "required|alpha_spaces|unique:language,language_name,".$id,
                                'language_3_code' => "required|regex:(^[a-zA-Z]+$)|min:3|max:3|unique:language,language_3_code,".$id,
                        ],
                        [
                                'language_name.required'=>'*Language name field required',
                                'language_name.alpha_spaces'=>'*Language name can only contain letters and spaces',
                                ...
                                'language_3_code.regex'=>'*Language 3 letter code can only contain letters and no-spaces',
                                'language_3_code.min'=>'*Minimum 3 letters to put in the field',
                                'language_3_code.max'=>'*Maximum 3 letters to put in the field',
