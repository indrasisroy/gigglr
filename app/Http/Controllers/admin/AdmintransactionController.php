...
class AdmintransactionController extends Controller
{
    ...
    public function index(Request $request, $id=0)
    {
        ...
        if(!empty($errormsgdata))
        {
          ...
          //       $user_order_translist.="  where user_id='".'12'."'";
        ...
        // }
            ...
            $selectfields=" id,payment_for,charge_token,payment_description,payment_status,
                ...
                $user_order_translist = DB::table('user_order as uo');
                // $user_order_translist = $user_order_translist->join('location_country as lc', 'uo.currency', '=', 'lc.currency_code');

                $user_order_translist=$user_order_translist->select(DB::raw('uo.id,uo.payment_for,uo.charge_token,uo.payment_description,uo.payment_status,uo.total_price,uo.payment_scheme,uo.debitorcredit,uo.gigmaster_id,uo.invoice_num,uo.user_id,uo.create_date,IF(uo.gigmaster_id >0, (select gm.giguniqueid from gig_master as gm where gm.id=uo.gigmaster_id),"----") as giguniqueid,refund_status'));
