...
class AdminbannerController extends Controller
{
    ...
    public function savebanner(Request $request)
    {
           ...
           if($chkvalid===true)
           {
                ...
                $chkimgresp=Imageuploadlib::imageupload($request,$filecontrolname="banner_image",$allowedFileExtAr,$allowedFileExtSizeAr,$allowedFileResolAr,$func,$addeditid=0) ;
    ...
    public function checkbannerform($request,$id=0)
         ...
         public function fileisinvalid($request,$addeditid=0)
       {
                ...
                $chkimgresp=Imageuploadlib::imageupload($request,$filecontrolname="banner_image",$allowedFileExtAr,$allowedFileExtSizeAr,$allowedFileResolAr,$func,$addeditid) ;
