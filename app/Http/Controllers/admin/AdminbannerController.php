...
class AdminbannerController extends Controller
{
    ...
    public function savebanner(Request $request)
    {
           ...
           if($chkvalid===true)
           {
                ...
                $destinationsourcePath=public_path()."/upload/banner-image/source-file/";
                ...
                $chkimgresp=Imageuploadlib::imageupload($request,$filecontrolname="banner_image",$allowedFileExtAr,$allowedFileExtSizeAr,$allowedFileResolAr,$func,$addeditid=0,$destinationsourcePath);
