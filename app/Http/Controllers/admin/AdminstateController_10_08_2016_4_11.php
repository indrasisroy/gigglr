...
class AdminstateController extends Controller
{
    ...
    public function savestate(Request $request)
    {
            ...
            $state_2_code =addslashes(strtoupper(trim( $request->input('state_2_code',''))));
            ...
            $dataInsert['state_2_code']=$state_2_code;
           ...
           if($chkvalid===true)
           {
                  ...
                  if($isInserted >= 0 )
                  {
                         ...
                         $request->session()->flash('admin_successmsgdata_sess', 'State Successfully saved.');
    ...
    public function checkstateform($request,$id=0,$country_id=0)
           {
                    ...
                    'country_id' => "required",    
                    'state_name' => "required|max:100|unique:location_state,state_name,".$id.",id,country_id,".$country_id,
                    'state_2_code' => "required|max:2|unique:location_state,state_2_code,".$id.",id,country_id,".$country_id,
                    'state_3_code' => "required|max:3|unique:location_state,state_3_code,".$id.",id,country_id,".$country_id,
                    'lat' => "required|numeric",
                     'lng' => "required|numeric",
                       ...
                       'state_2_code.required'=>'*State 2 letter code field required',
                      
                       'state_3_code.required'=>'*State 3 letter code field required',
                      
                       'state_2_code.max'=>'*Maximum 2 letter ',
        ...
        public function delstate(Request $request,$id=0)
       {
           ...
           if($ar>0)
           {
                 $request->session()->flash('admin_successmsgdata_sess', 'State data delete successfully.');  
           }
