...
@section('content')
    ...
    <?php
        $Complaint_By='';$Complaint_by_Type='';$Complaint_Against='';$Complaint_against_Type='';$Question='';$Edit_id='';
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                                ...
                                <?php echo Form::open(array('url' => ADMINSEPARATOR.'/disputereasonsave', 'method' => 'post','id'=>'disputereasonaddfrmid','class'=>"form-horizontal form-border no-margin" )); ?>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
    <?php
    $complaint_by_data = array(''=>'Select','1'=>'Booker','2'=>'Booked-artist/Group/Venue');
    $attrbar = array();
    ...
    <?php
    $complaint_by_type = array(''=>'Select','1'=>'Artist','2'=>'Group','3'=>'Venue');
    $attrib = array();
    ...
    <?php
    //$complaint_agaist_data = array(''=>'Select','1'=>'Booker','2'=>'Booked-artist/Group/Venue');
    //$attributes = array();
    //$attributes['id']='complaint_agaist';
    //$attributes['class']="form-control input-sm parsley-validated";
    //echo Form::select("complaint_agaist",$complaint_agaist_data,$Complaint_Against,$attributes );
    ?>
    <span  class="errorcustclass">{{ $Error_msg2 }}</span>                                      
                                    ...
                                    <div class="form-group" id="complaint_against_type_div" @if($Complaint_against_Type == '' || empty($Error_msg3) ) style="display:none"; @endif>
                                        ...
                                        <div class="col-lg-6">
    <?php
    $complaint_against_type = array(''=>'Select','1'=>'Artist','2'=>'Group','3'=>'Venue');
    $attributes = array();
    ...
    <span  class="errorcustclass">{{ $errors->first('question') }}</span>
        <input type="hidden" name="editId" value="{{$Edit_id}}">
                                ...
                                <div class="panel-footer ">
                                    ...
                                    <a class="btn btn-warning" href="<?php echo  url(ADMINSEPARATOR.'/disputereason'); ?>"><i class="fa fa-chevron-left"></i> Back</a>
                                </div>
