			...
			<div class="col-md-12">
				<div class="panel panel-default table-responsive">
						...
						<div class="row">
							<div class="col-md-4 col-sm-4">
								<?php echo Form::open(array('url' => ADMINSEPARATOR.'/contactus', 'method' => 'get','id'=>'contactuslistfrmid','class'=>"form-horizontal form-border no-margin" ));?>
									...
									?>
									<?php echo Form::text("srch1", $value=$srch1, $attributes = array( "id"=>"srch1","class"=>" form-control input-sm ","placeholder"=>"Search by Name or Email-ID")); ?>
					...
					<table class="table table-striped" id="responsiveTable">
						<thead>
							<tr>
								<th data-sortname="contact_name" data-sorttype="<?php echo $sorttype1; ?>" class="sorttrackclass" >Name <i  class=" <?php echo $default_srt_class1; ?>"></i></th>
								<th>Email </th>
								<th>Phone</th>
								<th>Reason</th>
								<th>Meassage</th>
						...
						<tbody>
							...
							?>
							<tr>
								<td><?php echo stripslashes($contactus_obj->contact_name); ?></td>
								<td><?php echo trim($contactus_obj->contact_email); ?></td>
								<td><?php echo $contactus_obj->contact_phone; ?></td>
								<td><?php echo stripslashes($contactus_obj->category_name); ?></td>
								<td><?php echo stripslashes($contactus_obj->contact_message); ?></td>
								<td><?php $cndt=$contactus_obj->create_date; echo date("jS F, Y H:i A", strtotime($cndt)); ?></td>
								<td>
									<a class="delcusclass" data-delid="<?php echo $contactus_obj->id; ?>" href="javascript:void(0);"><i class="fa fa-trash-o fa-lg"></i></a>
								</td>	
							</tr>
							<?php
								}	
