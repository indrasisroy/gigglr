...
<?php    
    echo Form::textarea("description", $value=$article_description, $attributes = array( "id"=>"article_description","class"=>" form-control input-sm parsley-validated ")); ?>
                ...
                {
                    filebrowserBrowseUrl :'{{ URL::asset('assets')}}/ckeditor/filemanager/browser/default/browser.html?Connector={{ URL::asset('assets')}}/ckeditor/filemanager/connectors/php/connector.php',
                    filebrowserImageBrowseUrl : '{{ URL::asset('assets')}}/ckeditor/filemanager/browser/default/browser.html?Type=Image&Connector={{ URL::asset('assets')}}/ckeditor/filemanager/connectors/php/connector.php',
                    filebrowserFlashBrowseUrl :'{{ URL::asset('assets')}}/ckeditor/filemanager/browser/default/browser.html?Type=Flash&Connector={{ URL::asset('assets')}}/ckeditor/filemanager/connectors/php/connector.php',
					filebrowserUploadUrl  :'{{ URL::asset('assets')}}/ckeditor/filemanager/connectors/php/upload.php?Type=File',
					filebrowserImageUploadUrl : '{{ URL::asset('assets')}}/ckeditor/filemanager/connectors/php/upload.php?Type=Image',
					filebrowserFlashUploadUrl : '{{ URL::asset('assets')}}/ckeditor/filemanager/connectors/php/upload.php?Type=Flash'
				});
