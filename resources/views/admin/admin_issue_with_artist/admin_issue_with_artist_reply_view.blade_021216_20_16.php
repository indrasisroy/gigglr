...
echo Form::open(array('url' => '','method' =>'post','id'=>'formdisputeid','class'=>"form-horizontal form-border no-margin" ));?>
	...
	<div class="form-group row" id="resolve_the_dispute_div" style="display:none">
		...
		<div class="form-group">
			<label class="col-lg-6 control-label">Pay to booker</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" id="pay_to_booker" data-booker="{{$complained_by}}" name="pay_to_booker" placeholder="input here...">
		...
		<div class="form-group">
			<label class="col-lg-6 control-label">Pay to artist</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" id="pay_to_artist" data-artist="{{$pagi_country->artist_id}}" name="pay_to_artist" placeholder="input here...">
				</div>
		</div>
		<div class="panel-footer">
