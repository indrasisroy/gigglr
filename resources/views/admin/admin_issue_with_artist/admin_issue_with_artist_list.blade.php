...
Issue with Artist List					
</div>
<div class="panel-body">
<div class="row">
<div class="col-md-4 col-sm-4">

<?php echo Form::open(array('url' => ADMINSEPARATOR.'/admin_issue_with_artist', 'method' => 'get','id'=>'countrylistfrmid','class'=>"form-horizontal form-border no-margin" ));?>
...
<tr>							
<td><?php echo stripslashes($countries_obj->gig_unique_id); ?></td>
<td><?php
...
<!--<td><?php //echo stripslashes($countries_obj->email); ?></td>-->
<td><?php echo stripslashes($countries_obj->artist_nickname); ?></td>
<!--<td><?php //echo stripslashes($countries_obj->artist_email); ?></td>-->
<td>
    <?php
...
<td><a href="<?php echo  url(ADMINSEPARATOR.'/view_artist/'.$id);?>"><i class="fa fa-eye" title="View Details" aria-hidden="true"></i></a></td>
							</tr>
		...
		window.location.href="<?php echo url(ADMINSEPARATOR.'/admin_issue_with_artist');?>";								
		});
