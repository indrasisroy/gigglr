...
Artist email<input type="checkbox"  value="<?php echo stripslashes($first_sql[0]->artist_id);?>" class="email" id="artist_id" name="artist_email">
<span class="custom-checkbox"></span>
</div>
</div>
...
<button type="button" id="submit" class="btn btn-success btn-sm bounceIn animation-delay5  pull-right" style="display:none;">Submit</button>
</div> 
<?php
echo Form::close();
?>
...
alert ('You didn\'t choose any of the checkboxes!');
	...
	//$('#formdisputeid').submit();
			...
			var snddata = {_token:"<?php echo csrf_token(); ?>",description:description,resolve_dispute_id:resolve_dispute_id,gig_id:gig_id,gig_unique_id:gig_unique_id,booker_id:booker_id,artist_id:artist_id,url:url	};
			console.log(snddata);
