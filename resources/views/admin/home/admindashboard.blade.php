...
<div class="col-lg-11">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3">
								<div class="panel panel-default panel-stat1 bg-success">
							<div class="panel-body">
								<div class="value"><a class="anctxtwhitecolor" href="<?php echo url(ADMINSEPARATOR.'/country')?>"><i class="fa fa-flag-o"></i> </a></div>
								<div class="title">
					...
					<div class="col-md-3 col-sm-3">
							...
							<div class="panel-body">
								<div class="value"><a class="anctxtwhitecolor" href="<?php echo url(ADMINSEPARATOR.'/contactus')?>"><i class="fa fa-phone"></i></a></div>
								<div class="title">
									<span class="m-left-xs"><a class="anctxtwhitecolor" href="<?php echo url(ADMINSEPARATOR.'/contactus')?>">Contact US</a></span>
								</div>
							</div>
						</div><!-- /panel -->
					</div><!-- /.col -->
					<!-- <div class="col-md-3 col-sm-3">
								<div class="panel panel-default panel-stat1 bg-success">
							<div class="panel-body">
								<div class="value"><a class="anctxtwhitecolor" href="<?php //echo url(ADMINSEPARATOR.'/disputereason')?>"><i class="fa fa-times"></i></a></div>
								<div class="title">
									<span class="m-left-xs"><a class="anctxtwhitecolor" href="<?php //echo url(ADMINSEPARATOR.'/disputereason')?>">Dispute Reason</a></span>
								</div>
							</div>
						</div>
					</div> --> 
					...
					<div class="col-md-3 col-sm-3">
								<div class="panel panel-default panel-stat1 bg-success">
							<div class="panel-body">
								<div class="value"><a class="anctxtwhitecolor" href="<?php echo url(ADMINSEPARATOR.'/tooltipmessages')?>"><i class="fa fa-envelope"></i></a></div>
								<div class="title">
									<span class="m-left-xs"><a class="anctxtwhitecolor" href="<?php echo url(ADMINSEPARATOR.'/tooltipmessages')?>">Tooltip Messages</a></span>
								</div>
							</div>
						</div><!-- /panel -->
					</div><!-- /.col -->
