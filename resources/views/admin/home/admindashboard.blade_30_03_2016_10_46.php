                ...
                <div class="row">
					...
					<div class="col-md-3 col-sm-3">
							...
							<div class="panel-body">
								...
								<div class="title">
									<span class="m-left-xs"><a class="anctxtwhitecolor" href="<?php echo url(ADMINSEPARATOR.'/contactus')?>">Contact-us Management</a></span>
								</div>
							</div>
						</div><!-- /panel -->
					</div><!-- /.col -->
					...
					<div class="col-md-3 col-sm-3">
							...
							<div class="panel-body">
								...
								<div class="title">
									<span class="m-left-xs"><a class="anctxtwhitecolor" href="<?php echo url(ADMINSEPARATOR.'/banner')?>">Banner Management</a></span>
								</div>
							</div>
						</div><!-- /panel -->
					</div><!-- /.col -->
