...
@section('content')
	...
	if(!empty($supportbypage))
	{
		$title=stripslashes($supportbypage->title);
		$description=stripslashes($supportbypage->description);
		$id=$supportbypage->id;
	}
	?>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<?php echo Form::open(array('url' => ADMINSEPARATOR.'/supportbypagesave', 'method' => 'post','id'=>'languageaddfrmid','class'=>"form-horizontal form-border no-margin" )); ?>
					<div class="panel-heading">
						Save support by page
					</div>
					<div class="panel-body">
						...
						<div class="form-group" >
										<label class="control-label col-lg-2">Description <br>(Maximum 5000 charecters)</label>
							<div class="col-lg-10">
					...
					<div class="panel-footer ">
						...
						<a class="btn btn-warning" href="<?php echo  url(ADMINSEPARATOR.'/supportbypage'); ?>"><i class="fa fa-chevron-left"></i> Back</a>
					</div>
