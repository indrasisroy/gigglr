			...
			<div class="panel panel-default">
			  ...
			  ?>  
                ...
                <div class="form-group">
                    <label>Email</label>
                    <?php  echo Form::text("frgt_email", $value="", $attributes = array("id"=>"frgt_email","class"=>"form-control input-sm bounceIn-REM animation-delay2-REM","placeholder"=>"Email"));
                    ?>
<!--							<span  class="errorcustclass">{{  $errors->first('frgt_email') }}</span>-->
                        ...
                        <a type="submit" name="frgtchk" class="btn btn-success btn-sm bounceIn-REM animation-delay5-REM  pull-left" href="<?php echo url(ADMINSEPARATOR."/login"); ?>" ><i class="fa fa-back"></i> Go to Login </a>
						<button type="submit" name="frgtchk" class="btn btn-success btn-sm bounceIn-REM animation-delay5-REM  pull-right" ><i class="fa fa-sign-in"></i> Submit</button>
					<?php echo Form::close();?>
				</div>
			</div>
		</div>
