					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-4 col-sm-4">
								...
								<?php echo Form::text("srch1", $value=$srch1, $attributes = array( "id"=>"srch1","class"=>" form-control input-sm ","placeholder"=>"search by state name")); ?>
					...
					<table class="table table-striped" id="responsiveTable">
						...
						?>
							<tr>
								...
								<td><?php echo stripslashes($state_obj->state_2_code); ?></td>
