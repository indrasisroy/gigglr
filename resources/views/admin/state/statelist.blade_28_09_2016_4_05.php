					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-4 col-sm-4">
								...
								<?php echo Form::text("srch1", $value=$srch1, $attributes = array( "id"=>"srch1","class"=>" form-control input-sm ","placeholder"=>"search by state name & country name")); ?>
							...
							<tr>
								...
								<th>
									<label class="label-checkbox">
										<input type="checkbox" id="chk-all">
										<span class="custom-checkbox"></span>
											<a type="button" id="deleteBtn" class="btn btn-xs btn-success" href="javascript:void(0)" >Multiple Delete</a>
									</label>
