					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-4 col-sm-4">
								...
								<?php echo Form::text("srch1", $value=$srch1, $attributes = array( "id"=>"srch1","class"=>" form-control input-sm ","placeholder"=>"Search by Genre / Parent Category")); ?>
					...
					<table class="table table-striped" id="responsiveTable">
						<thead>
							<tr>
								...
								<th data-sortname="name" data-sorttype="<?php echo $sorttype1; ?>" class="sorttrackclass" >Genre <i  class=" <?php echo $default_srt_class1; ?>"></i></th>
