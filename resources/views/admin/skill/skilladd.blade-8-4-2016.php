...
@section('content')
   ...
   ?>
	...
	<span  class="errorcustclass">{{ $errors->first('name') }}</span>
									...
									<div class="form-group">
										<label class="control-label col-lg-4">*Association <br> ( Choose maximum 3 associations ) </label>
										<div class="col-lg-6">
											
											<?php
											
											$association_id='';
											$association_id_data=array();
											
											$association_id_data['']="select Association";
											$association_id_data['1']="Live Performer";
											$association_id_data['2']="Theatre";
											$association_id_data['3']="Film & TV";
											$association_id_data['4']="Recording Studio";
											$association_id_data['5']="Technical";
											
   echo Form::select('association_id',$association_id_data , $association_id,$attributes = array( "id"=>"association_id","class"=>"form-control input-sm parsley-validated","multiple"=>true));
   ?>
