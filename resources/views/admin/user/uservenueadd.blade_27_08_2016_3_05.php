...
@section('content')
	...
	$techspecs ='';
	$opening_time=''; $closing_time='00:30';$securityamount ='';$hourlyrate ='';
	$availforuser='';
	$bookingsfrom='';
	$setuptime_arrdata=array(); $packuptime_arrdata=array();
	$closingtimedata = '';$openingtimedata='';
...
if($user_status_chk == 0 || $user_status_chk > 0)
{
	...
	?>
			...
			<div class="panel panel-default">
					...
					<div class="panel-body">
						<?php echo Form::open(array('url' => ADMINSEPARATOR.'/uservenuesave','files' => true, 'method' => 'post','id'=>'uservenueaddfrmid','class'=>"form-horizontal form-border no-margin" )); ?>
						...
						<!-- Basic information content	starts	 -->
							...
							<div class="tab-pane fade" id="wizardContent2">
														...
														<input type="hidden" name="uid" value="<?php echo $uid; ?>" id="vnuID" >
														<input type="hidden" name="ucreaterid" value="<?php echo $ucreaterid; ?>" id="vnucreatrID">
					...
					<!-- profile content	starts	 -->
							...
							<div class="tab-pane fade" id="wizardContent3">
														...
														<?php    
														echo Form::select('skill_id',$skill_id_data,$skill_id,$attributes=array( "id"=>"skill_id","class"=>"form-control input-sm parsley-validated","placeholder"=>"Select category"));
														?>
														...
														<div class="col-lg-4">
																		...
																		?>
																				...
																				<?php echo ((in_array($amenitiesID, $select_amenity))? 'checked' : '');?>
														...
														<span  class="errorcustclass"><?php echo $errors->first('venue_menu') ?> </span>
														</div><!-- /.col -->
														<div class="col-lg-4">
														<!--  <a href="" class="fa fa-download">Download Press kit</a> -->
														...
														echo link_to($uservenue_data_user, $title = 'Download menu', $attributes = array("class"=>"fa fa-download","target"=>"_blank"), $secure = null);
														}
   ...
   ?>
									...
									<div class="form-group">
										...
										<?php   
 echo Form::text("opening_time", $value=$opening_time, $attributes = array("id"=>"opening_time","class"=>"form-control input-sm parsley-validated "));
   ?>
									...
									<div class="form-group">
										...
										<?php 	echo Form::text("closing_time", $value=$closing_time, $attributes = array("id"=>"closing_time","class"=>"form-control input-sm parsley-validated ")); ?>
											<span class="input-group-addon">
											<span class="glyphicon glyphicon-time"></span>
											</span>
											</div>
	...
	var venueexistflag = '<?php echo $venueexistsflag?>';
