...
@section('content')
	...
	$techspecs ='';
	$packuptime=''; $setuptime='';$securityamount ='';$hourlyrate ='';
	$availforuser='';
	$bookingsfrom='';
...
// 	}
			...
			<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<!-- Basic information content	starts	 -->
							...
							<div class="tab-pane fade" id="wizardContent2">
														...
														<input type="hidden" name="uid" value="<?php echo $uid; ?>"  id="groupID">
														<input type="hidden" name="ucreaterid" value="<?php echo $ucreaterid; ?>" id="grupcreatrID">
					...
					<!-- profile content	starts	 -->
							...
							<div class="tab-pane fade" id="wizardContent3">
														...
														<?php    
														echo Form::select('skill_id',$skill_id_data,$skill_id,$attributes=array( "id"=>"skill_id_group","class"=>"form-control input-sm parsley-validated","placeholder"=>"Select category"));
														?>
   ...
   ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-4">	
											...
											<?php  
   echo Form::select('bookingsfrom', array(''=>'Choose option', '1'=>'Worldwide', '2'=>'My country', '3'=>'My city'), $bookingsfrom,$attributes = array("id"=>"bookingsfrom","class"=>"form-control input-sm parsley-validated"));
   ?>
   ...
   ?>
	...
	var groupexistsflag = '<?php echo $groupexistsflag?>';
