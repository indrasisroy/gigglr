					...
					<div class="panel-body">
						<div class="row">
							...
							<?php
								...
								<?php echo Form::text("srch1", $value=$srch1, $attributes = array( "id"=>"srch1","class"=>" form-control input-sm ","placeholder"=>"Search by Nickname")); ?>
						...
						?>
							...
							<tr>
								...
								<td>
									...
									?>
											<a href="<?php echo "javascript:void(0);"// echo url(ADMINSEPARATOR.'/useradd/groupadd/'.$users_obj->id);?>">Edit Group</a>
									<?php
										}
										else{
									?>
											<a href="<?php echo "javascript:void(0);"// echo url(ADMINSEPARATOR.'/useradd/groupadd/'.$users_obj->id);?>">Add Group</a>
									<?php
										}
									?>
								</td>
								...
								//	echo $venueinfo;
									...
									<?php
											...
											if($status!=1)
											{?>
												<a href="#simpleModal" data-toggle="modal">Venue</a>
											<?php 
										    }else if($status==1){
  			...
  			<div class="modal-dialog modal-sm">
    			<div class="modal-content">
				    ...
				    <div class="modal-body">
				        <p>This user account is already deactivated. Therefore venue can not be created.</p>
				    </div>
