...
@section('content')
	<?php
	$first_name='';$last_name='';$username='';$email='';$uid='';$gen='';
	if(!empty($userrow))
	{
	...
	<span  class="errorcustclass">{{ $errors->first('email') }}</span>										
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<?php    
   echo Form::select('gender', array(''=>'Choose gender', '1' => 'Male', '2' => 'Female'), $gen,$attributes = array("id"=>"gender","class"=>"form-control input-sm parsley-validated"));
   ?>
