...
@section('content')
	...
	$date='';$pagemeta='';$userprskt_data='';$user_status = '';$techspecs =''; $packuptime=''; $setuptime='';$securityamount ='';$hourlyrate ='';
	$availforuser='';
	$bookingsfrom='';
    ...
    <input type="password" name="newpass" class="form-control input-sm parsley-validated" id="newpass" value="<?php echo $passval; ?>">
							...
							<div class="tab-pane fade" id="wizardContent3">
								<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<?php    
   echo Form::select('skill_id',$skill_id_data,$skill_id,$attributes=array( "id"=>"skill_id_usr","class"=>"form-control input-sm parsley-validated","placeholder"=>"Select category"));
   ?>
                       ...
                       ?>
							...
							<div class="tab-pane fade" id="wizardContent4">
									...
									<div class="form-group">
										...
										<input type="hidden" name="uid" value="<?php echo $uid; ?>" id="userID">
...
<!-- for booking options starts-->
							<div class="tab-pane fade" id="wizardContent5">
									<div class="form-group">
										...
										<div class="col-lg-4">										
											<?php    
   echo Form::select('availforuser', array(''=>'Choose option', '3'=>'All', '1'=>'Public', '2'=>'Private'), $availforuser,$attributes = array("id"=>"availforuser","class"=>"form-control input-sm parsley-validated"));
   ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-4">	
											...
											<?php  
   echo Form::select('bookingsfrom', array(''=>'Choose option', '1'=>'Worldwide', '2'=>'My country', '3'=>'My city'), $bookingsfrom,$attributes = array("id"=>"availforuser","class"=>"form-control input-sm parsley-validated"));
   ?>
										...
										<div class="col-lg-4">										
											<?php
											 ...
											 echo Form::text("hourlyrate", $value=$hourlyrate, $attributes = array("id"=>"hourlyrate","class"=>"form-control input-sm parsley-validated ")); ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-4">										
											...
											echo Form::text("securityamount", $value=$securityamount, $attributes = array("id"=>"securityamount","class"=>"form-control input-sm parsley-validated ")); ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-4">	
											...
											<?php   
   echo Form::select('setuptime', $setuptime_arrdata, $setuptime,$attributes = array("id"=>"setuptime","class"=>"form-control input-sm parsley-validated","placeholder"=>"select Set-up time"));
   ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-4">			
											...
											<?php   
   echo Form::select('packuptime', $packuptime_arrdata, $packuptime,$attributes = array("id"=>"packuptime","class"=>"form-control input-sm parsley-validated","placeholder"=>"select Pack-up time"));
   ?>
									...
									<div class="form-group">
										<label class="control-label col-lg-4">Tech Specs</label>
										<div class="col-lg-4">										
											<?php 
											
											echo Form::textarea("techspecs", $value=$techspecs, $attributes = array("id"=>"techspecs","class"=>"form-control input-sm parsley-validated ")); ?>
	...
	var user_ststus_chk = '<?php echo $user_status;?>';

	var ststus_chk = '<?php echo $user_status;?>';

//console.log("user_ststus_chk"+user_ststus_chk);
if(user_ststus_chk)
{
