...
@section('content')
   ...
   <span  class="errorcustclass">{{ $errors->first('gender') }}</span>	
    ...
    echo Form::text("datepicker2", $value=$date, $attributes = array( "id"=>"datepicker2","class"=>"form-control input-sm parsley-validated"));
   ?>
	<span  class="errorcustclass">{{ $errors->first('datepicker2') }}</span>
   ...
   ?>
	...
	<script>
		$(document).ready( function() {
							 ...
							 // {
							 // //	$("#country_id").change();
							 // 	//$('select[name="state_id"]').val(78787878);
