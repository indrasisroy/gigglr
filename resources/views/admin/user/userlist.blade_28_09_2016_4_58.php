						...
						?>
							...
							<tr>
								...
								<td>
									...
									<a href="javascript:void(0);" ><i id="stat_<?php echo $users_obj->id; ?>" href="javascript:void(0);" data-userid="<?php echo $users_obj->id; ?>"  data-groupinfo="<?php echo $groupinfo;?>" data-venueinfo="<?php echo $venueinfo;?>" data-statuschange="<?php echo $status_change_to; ?>" class="statustrkclass <?php echo $status_icon_class; ?>"></i></a>
