			...
			<div class="padding-md">
				<div class="row">
					...
					<div class="panel-heading">
						Package List
						<span class="pull-right"><a type="button" class="btn btn-xs btn-success" href="<?php echo  url(ADMINSEPARATOR.'/packageadd'); ?>" >ADD</a></span>
					</div>
						...
						<div class="row">
							<div class="col-md-4 col-sm-4">
								...
								<a class="btn btn-default btn-sm">Apply</a>-->
								 ...
								 <?php echo Form::open(array('url' => ADMINSEPARATOR.'/package', 'method' => 'get','id'=>'packagelistfrmid','class'=>"form-horizontal form-border no-margin" ));?>
								...
								<?php echo Form::text("srch1", $value=$srch1, $attributes = array( "id"=>"srch1","class"=>" form-control input-sm ","placeholder"=>"search by price")); ?>
					...
					<table class="table table-striped" id="responsiveTable">
						<thead>
							<tr>
								...
								<th data-sortname="package_price" data-sorttype="<?php echo $sorttype1; ?>" class="sorttrackclass" >Package Price <i  class=" <?php echo $default_srt_class1; ?>"></i></th>
						...
						if(!empty($pagi_package) && ( $pagi_package->count()>0 ) )
						{
						
								foreach($pagi_package as $package_obj)
								{
						...
						?>
							<tr>
								...
								<td>$<?php echo stripslashes($package_obj->package_price); ?></td>
								<td><?php echo ucwords(stripslashes($package_obj->package_categname)); ?></td>
								<td><?php echo ucwords(stripslashes($package_obj->package_typename)); ?></td>
								<td>
								<a href="<?php echo  url(ADMINSEPARATOR.'/packageadd/'.$package_obj->id); ?>"><i class="fa fa-edit fa-lg"></i></a>
								<a href="javascript:void(0);" ><i id="stat_<?php echo $package_obj->id; ?>" href="javascript:void(0);" data-packageid="<?php echo $package_obj->id; ?>" data-statuschange="<?php echo $status_change_to; ?>" class="statustrkclass <?php echo $status_icon_class; ?>"></i></a>
								<a class="delcusclass" data-delid="<?php echo $package_obj->id; ?>" href="javascript:void(0);"><i class="fa fa-trash-o fa-lg"></i></a>
								</td>
					...
					<div class="panel-footer clearfix">
						...
						<?php echo $pagi_package->appends($useinPagiAr)->render(); ?>
				...
				jQuery(".sorttrackclass").click(function(){
						...
						jQuery('#packagelistfrmid').submit();
				});
				...
				jQuery(".delcusclass").click(function(){
						...
						var redurl="<?php echo url(ADMINSEPARATOR.'/packagedel');?>"+"/"+delid;
				...
				var packageid_data=jQuery(this).data('packageid');
				
				if (chkconfstatus==true)
				{
				
								var snddata = {_token:"<?php echo csrf_token(); ?>",statuschange: statuschange_data,packageid:packageid_data};
								...
								jQuery.ajax({
												type: "POST",
												data:snddata,
												url: "<?php echo url(ADMINSEPARATOR.'/packagestatus');?>",
												dataType:"json",
					...
					if (srch1data=='')
					{
								...
								window.location.href="<?php echo url(ADMINSEPARATOR.'/package');?>";
					}
					else
					{
								jQuery("#packagelistfrmid").submit();
