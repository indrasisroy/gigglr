...
<?php
	...
	if(!empty($homesearchrow))
	{
		...
		$imgurldata = asset('upload/homesearch-image/thumb-medium/'.$homesearchrow->image_name);
...
<script>
	...
	function showIMageFancy(imagename)
	{
		if(imagename!='')
		{
			$.fancybox.open("<?php echo URL::asset('upload/homesearch-image/source-file');?>"+"/"+imagename);
