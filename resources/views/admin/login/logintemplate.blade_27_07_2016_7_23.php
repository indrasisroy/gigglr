	...
	<div class="login-wrapper">
		<div class="text-center">
			<h2 class="fadeInUp animation-delay8" style="font-weight:bold">
				<span class="text-success">Prosessional</span> <span style="color:#ccc; text-shadow:0 1px #fff">Admin</span>
			</h2>
		</div>
			  ...
			  ?>
                ...
                <div class="form-group">
                    ...
                    ?>
						...
						<div class="form-group">
							Forgot your password?<br/>
							Click <a href="<?php echo url(ADMINSEPARATOR.'/forgotpwd'); ?>">here</a> to reset your password
						</div>
						<hr/>
