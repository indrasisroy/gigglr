			...
			<div class="padding-md">
				<div class="row">
					...
					<div class="panel-heading">
						Banner List
						<span class="pull-right"><a type="button" class="btn btn-xs btn-success" href="<?php echo  url(ADMINSEPARATOR.'/banneradd'); ?>" >ADD</a></span>
					</div>
						...
						<div class="row">
							<div class="col-md-4 col-sm-4">
								...
								<a class="btn btn-default btn-sm">Apply</a>-->
								 ...
								 <?php echo Form::open(array('url' => ADMINSEPARATOR.'/banner', 'method' => 'get','id'=>'bannerlistfrmid','class'=>"form-horizontal form-border no-margin" ));?>
					...
					<table class="table table-striped" id="responsiveTable">
						...
						if(!empty($pagi_banner) && ( $pagi_banner->count()>0 ) )
						{
						
								foreach($pagi_banner as $banner_obj)
								{
						...
						?>
							<tr>
								...
								<td><?php echo stripslashes($banner_obj->title); ?></td>
								<td><?php
								// $imgurldata = asset('public/upload/banner-image/thumb-medium/'.$banner_obj->banner_image);
								$imgurldata = BASEURLPUBLICCUSTOM.'upload/banner-image/thumb-medium/'.$banner_obj->banner_image;
								...
								<td>
								<a href="<?php echo  url(ADMINSEPARATOR.'/banneradd/'.$banner_obj->id); ?>"><i class="fa fa-edit fa-lg"></i></a>
								<a href="javascript:void(0);" ><i id="stat_<?php echo $banner_obj->id; ?>" href="javascript:void(0);" data-bannerid="<?php echo $banner_obj->id; ?>" data-statuschange="<?php echo $status_change_to; ?>" class="statustrkclass <?php echo $status_icon_class; ?>"></i></a>
								<a class="delcusclass" data-delid="<?php echo $banner_obj->id; ?>" href="javascript:void(0);"><i class="fa fa-trash-o fa-lg"></i></a>
								</td>
					...
					<div class="panel-footer clearfix">
						...
						<?php echo $pagi_banner->appends($useinPagiAr)->render(); ?>
	...
	<script>
		...
		jQuery(document).ready(function(){				
			jQuery("#clearsearch").click(function(){						
					window.location.href="<?php echo url(ADMINSEPARATOR.'/banner');?>";								
					});					
			...
			jQuery(".delcusclass").click(function(){
				...
				var redurl="<?php echo url(ADMINSEPARATOR.'/bannerdel');?>"+"/"+delid;
			...
			jQuery(".statustrkclass").click(function(){
				...
				var bannerid_data=jQuery(this).data('bannerid');
				...
				if (chkconfstatus==true)
				{
					...
					var snddata = {_token:"<?php echo csrf_token(); ?>",statuschange: statuschange_data,bannerid:bannerid_data};
		  
					jQuery.ajax({
					
						type: "POST",
						data:snddata,
						url: "<?php echo url(ADMINSEPARATOR.'/bannerstatus');?>",
						dataType:"json",
