...
<script type="text/javascript" src="{{ URL::asset('public/commonassets')}}/fancybox/source/jquery.fancybox.js?v=2.1.5"></script>
<link rel="stylesheet" type="text/css" href="{{ URL::asset('public/commonassets')}}/fancybox/source/jquery.fancybox.css?v=2.1.5" media="screen" />
<!-- Add fancyBox main JS and CSS files ends -->
			...
			function showIMageFancy(imagename)
			{
				...
				if(imagename!='')
				{
					$.fancybox.open("<?php echo URL::asset('public/upload/banner-image/thumb-big');?>"+"/"+imagename);
