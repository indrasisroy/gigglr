                ...
                if(!empty($settings_data))
                {
                    ...
                    ?> 
								   ...
								   <!--Facebook link-->
									...
									<!-- default radius -->
									 <div class="form-group">
                                        <label for="exampleInputPassword1">Default Radius</label>
                                       <?php
								...
								<!--You tube Link-->
									 <div class="form-group">
                                       ...
                                       <?php
                                         echo Form::text("client_id", $value=stripslashes($client_id), $attributes = array("id"=>"client_id","class"=>"form-control input-sm","placeholder"=>"Client ID"));
                                        ?>
								...
								<!--You tube Link-->
									 <div class="form-group">
                                       ...
                                       <?php
                                         echo Form::text("client_secret_key", $value=stripslashes($client_secret_key), $attributes = array("id"=>"client_secret_key","class"=>"form-control input-sm","placeholder"=>"Client Secret Key"));
                                        ?>
                                        {{ $errors->first('client_secret_key') }}
                                    </div><!-- /form-group -->
