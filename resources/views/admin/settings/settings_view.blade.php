...
<div class="col-lg-11">
                ...
                if(!empty($settings_data))
                {
                            ...
                            $companyname_show = $settings_data->company_name; //******** getting company name 
                            ...
                            $support_welcome_text=$settings_data->support_welcome_text;
                            $help_welcome_text=$settings_data->help_welcome_text;
                            ...
                            $facebook_api=$settings_data->facebook_api;
                    ...
                    ?> 
                                     <div class="form-group">
                                        ...
                                        <?php
                                         echo Form::text("company_name", $value=stripslashes($companyname_show), $attributes = array("id"=>"company_name","class"=>"form-control input-sm","placeholder"=>"Company name"));
                                        ?>
                                     <span  class="errorcustclass">   {{ $errors->first('company_name') }}</span>
								...
								<!--You tube Link-->
                                     ...
                                     <div class="form-group">
                                        <label for="exampleInputPassword1">Facebook APP ID</label>
                                       <?php
                                         echo Form::text("facebook_api", $value=stripslashes($facebook_api), $attributes = array("id"=>"facebook_api","class"=>"form-control input-sm","placeholder"=>"Facebook APP ID"));
                                        ?>
                                     <span  class="errorcustclass">    {{ $errors->first('facebook_api') }} </span>
                                    </div><!-- /form-group -->
		...
		?>
                             ...
                             <div class="form-group">
                                       ...
                                       <?php
                                         echo Form::text("service_charge", $value=stripslashes($service_charge), $attributes = array("id"=>"service_charge","class"=>"form-control input-sm","placeholder"=>"Credit Card %"));
                                        ?>
                             ...
                             <div class="form-group">
								...
								<div class="form-group">
										<label class="form-group">*Logo in Home Page Banner (Minimum Width : 445px) (Minimum Height : 82px)
	...
	<span  class="errorcustclass"><?php echo $errors->first('site_logo_image');  ?></span>
		...
		<br><p><?php if(!empty($bfloginimgurldata)){ ?><img src="<?php echo $bfloginimgurldata; ?>" onclick="javascript:showIMageFancy('<?php echo $site_logo_image; ?>');"> <?php } ?></p>
								...
								<div class="form-group">
										<label class="form-group">*Icon in Header (Minimum Width : 66px) (Minimum Height : 49px)
										<br>Allowed File Extention : .png
										</label>
											<br>
	...
	<span  class="errorcustclass"><?php echo $errors->first('afterlogin_logo_image');  ?></span>
		...
		<br><p><?php if(!empty($afterloginimgurldata)){ ?><img src="<?php echo $afterloginimgurldata; ?>" onclick="javascript:showIMageFancy('<?php echo $afterlogin_logo_image; ?>');"> <?php } ?></p>
								...
								<div class="form-group">
										<label class="form-group">*Footer Logo Image (Minimum Width : 254px ) (Minimum Height : 45px )
										<br>Allowed File Extention : .png
										</label>
											<br>
	...
	<span  class="errorcustclass"><?php echo $errors->first('footer_logo_image');  ?></span>
		...
		<br><p><?php if(!empty($footerimgurldata)){ ?><img src="<?php echo $footerimgurldata; ?>" onclick="javascript:showIMageFancy('<?php echo $footer_logo_image; ?>');"> <?php } ?></p>
								...
								<div class="form-group">
										<label class="form-group">*Email Template Logo Image (Minimum Width : 254px) (Minimum Height : 45px)
										<br>Allowed File Extention : .png
										</label>
											<br>
