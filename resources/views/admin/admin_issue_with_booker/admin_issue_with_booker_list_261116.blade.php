...
<?php echo Form::text("srch1", $value=$srch1, $attributes = array( "id"=>"srch1","class"=>" form-control input-sm ","placeholder"=>"Search by Booker nick-name")); ?>
...
<td><?php echo stripslashes($user_master[0]->nickname); ?></td>
    <td><?php echo stripslashes($user_master[0]->email); ?></td>
