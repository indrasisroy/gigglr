...
$gigid=''; $gigunique=''; $gigtype=''; $bookerorartist=''; $bookerid=''; $bookername=''; $artistid=''; $artistname=''; $categoryid=''; $categoryname=''; $genreid=''; $genrename=''; $cancelfee=''; $securityfee=''; $totalfee=''; $reqexpdt=''; $bkaccdt=''; $bookstat=''; $typo=''; $typoname=''; $evntstdt=''; $evntstdt_frmt=''; $bookreqdt=''; $bookreqdt_frmt=''; $licls=''; $bookerorartistlabel=''; $nestdivid=''; $ggbid='';
...
<?php
    ...
    {        
		...
		$ggbid=trim(stripslashes($daily_data->ggbid));
...
<?php
	...
	$event_start_date_time = date('F Y', strtotime(trim(stripslashes($daily_data->event_start_date_time))));
                        
    if ( $show_date_format != $event_start_date_time )
	{
        $show_date_format = $event_start_date_time;

?>
        <h2 class="rrostr"><?php echo $show_date_format; ?></h2>
...
?>			
			...
			<a href="javascript:void(0)" class="gig_request" data-id="<?php echo $gigunique;?>" data-gigtype="<?php echo $gigtype;?>" data-bkrorart="<?php echo $bookerorartist;?>" data-gigid="<?php echo $gigid;?>" data-typo="<?php echo $typo;?>" >
