		...
		foreach($maingig_qry_data_result as $data_result){
			...
			if (in_array("REDCLOCK", $picArray))
			{
				if (in_array("PURPLE", $picArray))
				{
						...
						$textmsg = "Booking Request ".$fromortoval.' '.$bookername. " <br> ".$evntsttm_frmt." on ".$evntstdt_frmt."<br> ".$genrename."  - ".$categoryname." in ".$eventtown;
				}
			...
			// Your posted Gig has been booked on
			$textmsg = "Your confirmed booking is on <br>".$evntstdt_frmt." - ".$evntsttm_frmt."<br> ".$genrename." - ".$categoryname." in ".$eventtown;
