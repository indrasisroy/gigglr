			...
			<div class="month-chart clearfix">
				...
				<div class="right_chart clearfix">
					...
					<div class="input-group input-daterange">
						<input style="width:150px!important;" id='frmdtpick' type="text" class="datepicker form-control" value="2012-04-05">
						<span class="input-group-addon">to</span>
						<input style="width:150px!important;" id='todtpick' type="text" class="datepicker form-control" value="2012-04-19">
						<input type="button" class="btn" value="Export" id="expoertEvents" style="float:left;margin-left: 10px;" />
					</div>
				</div>
			</div>
		</div>
