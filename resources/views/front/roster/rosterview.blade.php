...
<section class="profile_outer event_back">		
			...
			<div class="month-chart clearfix">
				...
				<div class="right_chart clearfix ">
                    ...
                    <div class="input-group input-daterange right_daterng_cust_wdth">
						<input type="button" data-toggle="modal" data-target="#exportICS" value="Export Events" class="btn export-data-button exportevents">
					</div>
				...
				<div class="event_left_row">
					...
					<ul class="visitor_cols event_btn_group">
				       ...
				       <?php */?>	
                        ...
                        <li>
							<a class="commnevttypecls" data-evnttypeshowflag="PROFILEEVENTSHIDE" data-evntshowstatus="0" href="javascript:void(0);" style="background: #2BB6A3;" >
								<span class="evnttxtcls" >Hide profile events </span>
								<span class="commonaddminus add_icon"> </span>
							</a>
						</li>
											...
											<div class="col-md-12 margintop20">
											  <!-- <div class="inline artist_list">-->
												  <div class="input-group input-daterange">
													 <input id='frmdtpick' type="text" class="datepicker form-control export-date-text" placeholder="Start Date">
													 <span class="input-group-addon">to</span>
													 <input id='todtpick' type="text" class="datepicker form-control export-date-text" placeholder="End Date">
		...
		<script>
                ...
                //evnttypeshowflagAr.push("PROFILEEVENTSHIDE");
