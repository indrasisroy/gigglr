<?php
   ...
   if(!empty($errormsgdata))
   {
	...
	$eventfanmsg='Show profiles I like'; //'Show Events I am a fan'
	$eventgenremsg='Show events of My Profile genres';
	$eventtownmsg='Show events in my city';
	...
	if(!empty($front_id_sess))
	{
		...
		$eventfanmsg='Hide profiles I like'; //'Hide Events I am a fan'
		$eventgenremsg='Hide events of My Profile genres';
		$eventtownmsg='Hide events in my city';
	}
				...
				if(!empty($gigtopsliderdata))
				{
					...
					foreach($gigtopsliderdata as $gigtopsliderdataobj)
					{
						...
						// $image_with_pth = asset("front/otherfiles/progimages/"."noimagefound208X201.jpg");
						 $image_with_pth = BASEURLPUBLICCUSTOM."front/otherfiles/progimages/"."noimagefound208X201.png";
						...
						$profilelinkurl=url('/');
						 if($type_flag==1)
						 {
							  $profilelinkurl.="/a/".$gigtopsliderdataobj->seo_name;
						  }
						 elseif($type_flag==2)
						 {
								$profilelinkurl.="/g/".$gigtopsliderdataobj->seo_name;
						 }
						  elseif($type_flag==3)
						 {
							 $profilelinkurl.="/v/".$gigtopsliderdataobj->seo_name;
						 }
