			...
			<div class="event_left sam_height mCustomScrollbar">
				<div class="event_left_row">
					...
					<ul class="visitor_cols event_btn_group">
						<li>
							<a data-showevntflag="1" class="mycustevntcls" data-filterevtype="EVENTFAN" href="javascript:void(0);" style="background: #ff635c;">								
								<span class="evntxtdtacls"  >Show Events i am a fan</span>
								<span class="add_icon"> </span>
							</a>
						</li>
						<li>
							<a data-showevntflag="1" class="mycustevntcls" data-filterevtype="EVENTGENRE" href="javascript:void(0);" style="background: #f1c40f;" >
						...
						<li>
							<a data-showevntflag="0"  class="mycustevntcls" data-filterevtype="EVENTTOWN" href="javascript:void(0);" style="background: #64d0e4;">
								<span class="evntxtdtacls" >Hide events in my town</span>
								<span class="add_icon"> </span>
							</a>
						</li>
					</ul>
