<div class="demoSec">
		...
		<?php
			...
			$imgurldata=''; $imgtit=''; $tit=''; $loc=''; $desc=''; $sklid=''; $sklnm='';
...
-->
                        ...
                        <div class="search-now">
                            <button class="btn btn-primary homesearchbyskillid" data-skillid="<?php echo $sklid;?>"  data-skillnm="<?php echo $sklnm;?>"  type="button">Search NOW!</button>
