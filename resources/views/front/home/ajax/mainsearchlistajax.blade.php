...
// echo "<pre>"; print_r($mainserch_qry_data);  echo "</pre>";
 if(!empty($mainserch_qry_data))
 {
      foreach($mainserch_qry_data as $mainserch_data)
	  {
					 ...
					 $profile_name=stripslashes($mainserch_data->profile_name);
					...
					// $image_with_pth = asset("front/otherfiles/progimages/"."noimagefound208X201.jpg");
                     $image_with_pth = BASEURLPUBLICCUSTOM."front/otherfiles/progimages/"."noimagefoundsearch537X507.png";
					...
					$profilelinkurl=url('/');
					 if($type_flag==1)
					 {
						  $profilelinkurl.="/a/".$mainserch_data->seo_name;
				     }
					 elseif($type_flag==2)
					 {
					      $profilelinkurl.="/g/".$mainserch_data->seo_name;
					 }
					  elseif($type_flag==3)
					 {
						 $profilelinkurl.="/v/".$mainserch_data->seo_name;
					 }
