...
$loggedinuserid='';
if(!empty($frontloginuserid))
{
	$loggedinuserid=$frontloginuserid;
}

if(!empty($usrmdata))
{
	$loggedinuseridemail=$usrmdata['usrmemail'];
	$loggedinuserfname=$usrmdata['usrmfname'];
	$loggedinuserlname=$usrmdata['usrmlname'];
}
else{
	$loggedinuseridemail='';
	$loggedinuserfname='';
...
@section('content')
	...
	<section class="profile_outer text-center profile_outerA">
			...
			<div class="row">
				<div class="col-sm-offset-2 col-sm-8">
					<div class="row faq_cols_outer faq_cols_outerCustom">
                        <div class="col-sm-4 col-xs-4 mynewcustancclass" id="disputeurl">
                            <span class="faq_cols faq_col3">
							<a href="javascript:void(0);"  > &nbsp; REPORT &nbsp; A DISPUTE</a>
                            </span>
						</div>
						<div class="col-sm-4 col-xs-4 mynewcustancclass" id="contact_support">
                            <span class="faq_cols">
                                <a href="javascript:void(0);"  >CONTACT SUPPORT</a>
                            </span>
						</div>
						<div class="col-sm-4 col-xs-4 mynewcustancclass" id="helpurl">
                            <span class="faq_cols faq_col2">
                                <a href="javascript:void(0);" >Site Help</a>
                            </span>
						</div>
					</div>					
				</div>
            ...
            <div class="row">
				...
				<?php echo Form::open(array('files' => true, 'method' => 'post','id'=>'contactsupportfrmid','class'=>"" )); ?>
                    <div class="custom-formIn xe-class">
						...
						<div class="inputForum clearfix" id="eventselect">
							...
							<div class="from-control-custom">
								...
								if(!empty($gigeventarr)){
									foreach($gigeventarr as $eventarr){
										$fetchgigeventArData[$eventarr['element']]=$eventarr['content'];
									}
								}
								else{
									$fetchgigeventArData['']='No event is available';
								}
                             ...
                             <div class="inputForum clearfix">
                                <label>First Name *</label>
								 ...
								 <?php
									...
									{
								 ?>
                                     <input type="text" class="form-control" name="confname" id="confname" value="{{$loggedinuserfname}}" readonly="readonly">
									 <?php
									}
									else{
									?>
                                ...
                                <label>Last Name</label>
                                 <div class="from-control-custom">
								  <?php
									...
									{
								 ?>
                                     <input type="text" class="form-control" name="conlname" id="conlname" value="{{$loggedinuserlname}}" readonly="readonly">
									 <?php
									}
									else{
									?>
                         ...
                         <div class="inputForum clearfix">
                                <label>E-Mail Address *</label>
								 ...
								 <?php
									...
									{
								 ?>
                                     <input type="text" class="form-control" name="conemail" id="conemail" value="{{$loggedinuseridemail}}"  readonly="readonly">
									 <?php
									}
									else{
									?>
        ...
        <h2 class="watch_heading watch_heading-custom-2" id="disputeid">Report a dispute</h2>
            <div class="row">
			<div class="col-sm-offset-2 col-sm-8">
                <div class="resolve-innar" id="resolve-sec">
					<div id="accordion" class="panel-group row text-left">
							<div class="panel panel-default">				
						        <a data-toggle="collapse" class="accordian_nav collapsed" data-parent="#accordion" href="#collapse13">1. Report an issue with an artist</a>					
                                   ...
                                   <?php echo Form::open(array('files' => true, 'method' => 'post','id'=>'againstartistfrmid','class'=>"" )); ?>
                                    <div class="panel-body">					
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
														...
														<?php $yes=''; echo Form::radio('arrive', '1', $yes, $attributes = array("id"=>"arriveId","class"=>"")); ?>
                                                        <span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="arrive" />-->
                                                        <?php $no=''; echo Form::radio('arrive', '2', $no, $attributes = array("id"=>"arriveId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row panel-bodyA">
                                            ...
                                            <div class="col-sm-3">
                                                <div class='input-group date' id='datetimepicker3'>
                                                    <input type='text' id="arrivaltime" name="arrivaltime" class="form-control clck_outr timepicker" placeholder="12.00 am"/>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('specification', '1', $yes, $attributes = array("id"=>"specificationId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="specification" />-->
                                                        <?php $no=''; echo Form::radio('specification', '2', $no, $attributes = array("id"=>"specificationId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
														...
														<?php $yes=''; echo Form::radio('performance', '1', $yes, $attributes = array("id"=>"performanceId","class"=>"")); ?>
                                                        <span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="performance" />-->
														<?php $no=''; echo Form::radio('performance', '2', $no, $attributes = array("id"=>"performanceId","class"=>"")); ?>
                                                        <span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
														...
														<?php $yes=''; echo Form::radio('technical', '1', $yes, $attributes = array("id"=>"technicalId","class"=>"")); ?>
                                                        <span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="technical" />-->
                                                        <?php $no=''; echo Form::radio('technical', '2', $no, $attributes = array("id"=>"technicalId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('rider', '1', $yes, $attributes = array("id"=>"riderId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="rider" checked="checked">-->
                                                        <?php $no=''; echo Form::radio('rider', '2', $no, $attributes = array("id"=>"riderId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('leave', '1', $yes, $attributes = array("id"=>"leaveId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="leave" />-->
														<?php $no=''; echo Form::radio('leave', '2', $no, $attributes = array("id"=>"leaveId","class"=>"")); ?>
                                                        <span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row panel-bodyA">
                                            ...
                                            <div class="col-sm-3">
                                                <div class='input-group date' id='datetimepicker3'>
                                                    <input type='text' id="leavetime" name="leavetime" class="form-control clck_outr timepicker" placeholder="12.00 am"/>
                                                    <span class="input-group-addon clck">
                                                        <span class="glyphicon glyphicon-time"></span>
                                                    </span>
                                                </div>
										...
										<div class="row panel-bodyA" id="againstartistlist">
                                            <div class="col-sm-9">
								...
								if(!empty($against_artist)){
									...
									$fetchagainstartistArData['']='No event is available';
								}
						    ...
						    <div class="panel panel-default">				
						        <a data-toggle="collapse" class="accordian_nav collapsed" data-parent="#accordion" href="#collapse14">2. Report an issue with a group</a>					
						        <div id="collapse14" class="panel-collapse collapse">					
                                    ...
                                    <div class="panel-body">					
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
														...
														<?php $yes=''; echo Form::radio('grouparrive', '1', $yes, $attributes = array("id"=>"grouparriveId","class"=>"")); ?>
                                                        <span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="gArrive" />-->
														<?php $no=''; echo Form::radio('grouparrive', '2', $no, $attributes = array("id"=>"grouparriveId","class"=>"")); ?>
                                                        <span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row panel-bodyA">
                                            ...
                                            <div class="col-sm-3">
                                                <div class='input-group date' id='datetimepicker3'>
                                                    <input type='text' id="grouparrivaltime" name="grouparrivaltime" class="form-control clck_outr timepicker" placeholder="12.00 am"/>
                                                    <span class="input-group-addon clck">
                                                        <span class="glyphicon glyphicon-time"></span>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('groupspecification', '1', $yes, $attributes = array("id"=>"groupspecificationId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="gSpecification" />-->
                                                        <?php $no=''; echo Form::radio('groupspecification', '2', $no, $attributes = array("id"=>"groupspecificationId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('groupperformance', '1', $yes, $attributes = array("id"=>"groupperformanceId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="gPerformance" />-->
                                                        <?php $no=''; echo Form::radio('groupperformance', '2', $no, $attributes = array("id"=>"groupperformanceId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('grouptechnical', '1', $yes, $attributes = array("id"=>"grouptechnicalId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="gTechnical" />-->
                                                        <?php $no=''; echo Form::radio('grouptechnical', '2', $no, $attributes = array("id"=>"grouptechnicalId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
														...
														<?php $yes=''; echo Form::radio('grouprider', '1', $yes, $attributes = array("id"=>"groupriderId","class"=>"")); ?>
                                                        <span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="gRider" />-->
														<?php $no=''; echo Form::radio('grouprider', '2', $no, $attributes = array("id"=>"groupriderId","class"=>"")); ?>
                                                        <span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
														...
														<?php $yes=''; echo Form::radio('groupleave', '1', $yes, $attributes = array("id"=>"groupleaveId","class"=>"")); ?>
                                                        <span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="gLeave" />-->
														<?php $no=''; echo Form::radio('groupleave', '2', $no, $attributes = array("id"=>"groupleaveId","class"=>"")); ?>
                                                        <span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row panel-bodyA">
                                            ...
                                            <div class="col-sm-3">
                                                <div class='input-group date' id='datetimepicker3'>
                                                    <input type='text' id="groupleavetime" name="groupleavetime" class="form-control clck_outr timepicker" placeholder="12.00 am"/>
                                                    <span class="input-group-addon clck">
                                                        <span class="glyphicon glyphicon-time"></span>
                                                    </span>
                                                </div>
										...
										<div class="row panel-bodyA" id="againstgrouplist">
                                            <div class="col-sm-9">
								...
								if(!empty($against_group)){
									...
									$fetchagainstgroupArData['']='No event is available';
								}
								...
								?>
                                        ...
                                        <div class="issue-zone">
                                            <div class="issue-text">
                                               <textarea class="form-control" id="groupsummary" name="groupsummary" placeholder="In your own words (500 characters max). Please describe the issue."></textarea>
                                            </div>
                                        </div>
						    ...
						    <div class="panel panel-default">				
						        <a data-toggle="collapse" class="accordian_nav collapsed" data-parent="#accordion" href="#collapse15">3. Report an issue with a venue</a>					
						        <div id="collapse15" class="panel-collapse collapse">					
                                    ...
                                    <div class="panel-body">					
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('venuearrive', '1', $yes, $attributes = array("id"=>"venuearriveId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="startTime" checked="checked" />-->
                                                        <?php $no=''; echo Form::radio('venuearrive', '2', $no, $attributes = array("id"=>"venuearriveId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row panel-bodyA">
                                            ...
                                            <div class="col-sm-3">
                                                <div class='input-group date' id='datetimepicker3'>
                                                    <input type='text' id="venuearrivaltime" name="venuearrivaltime" class="form-control clck_outr timepicker" placeholder="12.00 am"/>
                                                    <span class="input-group-addon clck">
                                                        <span class="glyphicon glyphicon-time"></span>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('venuepresentation', '1', $yes, $attributes = array("id"=>"venuepresentationId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="venueViewed" />-->
                                                        <?php $no=''; echo Form::radio('venuepresentation', '2', $no, $attributes = array("id"=>"venuepresentationId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('venuespecification', '1', $yes, $attributes = array("id"=>"venuespecificationId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="amenities" />-->
                                                        <?php $no=''; echo Form::radio('venuespecification', '2', $no, $attributes = array("id"=>"venuespecificationId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('venuetechnical', '1', $yes, $attributes = array("id"=>"venuetechnicalId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="technicalDifficulties" />-->
                                                        <?php $no=''; echo Form::radio('venuetechnical', '2', $no, $attributes = array("id"=>"venuetechnicalId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('venueleave', '1', $yes, $attributes = array("id"=>"venueleaveId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="vacate" />-->
                                                        <?php $no=''; echo Form::radio('venueleave', '2', $no, $attributes = array("id"=>"venueleaveId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row panel-bodyA">
                                            ...
                                            <div class="col-sm-3">
                                                <div class='input-group date' id='datetimepicker3'>
                                                    <input type='text' id="venueleavetime" name="venueleavetime" class="form-control clck_outr timepicker" placeholder="12.00 am"/>
                                                    <span class="input-group-addon clck">
                                                        <span class="glyphicon glyphicon-time"></span>
                                                    </span>
                                                </div>
										...
										<div class="row panel-bodyA" id="againstvenuelist">
                                            <div class="col-sm-9">
								...
								if(!empty($against_venue)){
									...
									$fetchagainstvenueArData['']='No event is available';
								}
								...
								?>
                                        ...
                                        <div class="issue-zone">
                                            <div class="issue-text">
                                               <textarea class="form-control" id="venuesummary" name="venuesummary" placeholder="In your own words (500 characters max). Please describe the issue."></textarea>
                                            </div>
                                        </div>
                            ...
                            <div class="panel panel-default">				
						        <a data-toggle="collapse" class="accordian_nav collapsed" data-parent="#accordion" href="#collapse16">4. Report an issue with a booker</a>					
								...
								<?php echo Form::open(array('files' => true, 'method' => 'post','id'=>'againstbookerfrmid','class'=>"" )); ?>
						            <div class="panel-body">					
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('getgig', '1', $yes, $attributes = array("id"=>"getgigId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="ac" checked="checked">-->
                                                        <?php $no=''; echo Form::radio('getgig', '2', $no, $attributes = array("id"=>"getgigId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row panel-bodyA">
											...
											<div class="col-sm-3">
                                                <div class='input-group date' id='datetimepicker3'>
                                                    <input type='text' id="bookerarrivaltime" name="bookerarrivaltime" class="form-control clck_outr timepicker" placeholder="12.00 am"/>
                                                    <span class="input-group-addon clck">
                                                        <span class="glyphicon glyphicon-time"></span>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('commencegig', '1', $yes, $attributes = array("id"=>"commencegigId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="ad" checked="checked">-->
                                                        <?php $no=''; echo Form::radio('commencegig', '2', $no, $attributes = array("id"=>"commencegigId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('bookertechnical', '1', $yes, $attributes = array("id"=>"bookertechnicalId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="ae" checked="checked">-->
                                                        <?php $no=''; echo Form::radio('bookertechnical', '2', $no, $attributes = array("id"=>"bookertechnicalId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('bookerspecification', '1', $yes, $attributes = array("id"=>"bookerspecificationId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="af" checked="checked">-->
                                                        <?php $no=''; echo Form::radio('bookerspecification', '2', $no, $attributes = array("id"=>"bookerspecificationId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('bookerrider', '1', $yes, $attributes = array("id"=>"bookerriderId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="ag" checked="checked">-->
                                                        <?php $no=''; echo Form::radio('bookerrider', '2', $no, $attributes = array("id"=>"bookerriderId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="inlineWrap extra-margin">
                                                    <div class="inline">
                                                        ...
                                                        <?php $yes=''; echo Form::radio('bookerleave', '1', $yes, $attributes = array("id"=>"bookerleaveId","class"=>"")); ?>
														<span></span>Yes</label>
                                                    </div>
                                                    <div class="inline">
                                                        <label class="radio-check">
														<!--<input type="radio" name="ah" checked="checked">-->
                                                        <?php $no=''; echo Form::radio('bookerleave', '2', $no, $attributes = array("id"=>"bookerleaveId","class"=>"")); ?>
														<span></span>No</label>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row panel-bodyA" id="againstbookerlist">
                                            <div class="col-sm-9">
								...
								if(!empty($against_booker)){
									...
									$fetchagainstbookerArData['']='No event is available';
								}
								...
								?>
                                            ...
                                            <div class="issue-zone">
                                                <div class="issue-text">
                                                   <textarea class="form-control" id="bookersummary" name="bookersummary" placeholder="In your own words (500 characters max).Please describethe issue"></textarea>
                                                </div>
                                            </div>
                                        <div class="clearfix book-support-col"> 
                                            <div class="leftI">
