							...
							<div class="from-control-custom">
                             ...
                             <div class="inputForum clearfix">
                                <label>First Name *</label>
                                 <div class="from-control-custom">
                                     <input type="text" class="form-control" name="confname" id="confname" value="{{$loggedinuserfname}}">
                                 </div>
                            </div>
                         <div class="inputForum clearfix">
                                <label>Last Name</label>
                                 <div class="from-control-custom">
                                     <input type="text" class="form-control" name="conlname" id="conlname" value="{{$loggedinuserlname}}">
                                 </div>
                            </div>
                         <div class="inputForum clearfix">
                                <label>E-Mail Address *</label>
                                 <div class="from-control-custom">
                                     <input type="text" class="form-control" name="conemail" id="conemail" value="{{$loggedinuseridemail}}">
                                 </div>
                            </div>
                         <div class="inputForum clearfix">
