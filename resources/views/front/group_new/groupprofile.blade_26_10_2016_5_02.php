...
<!--                     <a href="#" class="book_btn openbkgrpcls openmodal" data-toggle="modal" data-target="#myModal5">book group</a>-->
			   ...
			   ?>
			   <a href="javascript:void(0)" class="book_btn openbkgrpcls openmodal a" data-toggle="modal">book group</a>
			   <?php
			   }else if($front_id_sess==''){
			   ?>
			   <a href="javascript:void(0)" class="book_btn openbkgrpcls deactive openmodal b" data-toggle="modal">book group</a>
			   <?php
			   }
			   else{
			   ?>
         ...
         <div class="modal-body popup-body">
            ...
            <div class="artist_form_outr clearfix">
               ...
               <div class="row">
                  ...
                  <div class="col-md-12">
                     <div class="inline artist_list" id="tech_speech_div" style="display:none">
                        <!--                      <span>Tech Specs</span>-->
<!--                        <div class="form-group inpt nb">{{stripslashes($tech_speech)}}
                        </div>-->
												                      <?php
					  
					  echo Form::textarea("gig_description", $value=stripslashes($tech_speech), [ "id"=>"gig_description", "placeholder"=>"Gig Description","class"=>"form-group inpt nb form-control" ]);
                  ...
                  <div class="col-md-12">
                     <button class="btn btn-warning artist_btn reqst_btn" id="cancelbtn" data-dismiss="modal">cancel</button>
                                          <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm" type="button" id="venuebookingsubmit">agree to terms </button>
