 ...
 $filterevtype=''; $filterevtypeAr=array();
  ...
  }else
  {
   ...
   $cal_privateeventshowflag = $fetchuserdata->cal_privateeventshowflag;
    ...
    $user_description=stripslashes($fetchuserdata->group_description);
         ...
         <div class="modal-body popup-body">
            ...
            <div class="artist_form_outr clearfix">
               ...
               <div class="row">
                      ...
                      <div class="inline artist_list">
                        <span>Duration:</span>
                          <div class="form-group inpt input-customm clearfix newTimeWrap">
                            ...
                            <button type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $duration_heading;?> "><i class="fa fa-question-circle" aria-hidden="true"></i>
                              </button>
                ...
                <button type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $reqespiredatetime_heading;?> "><i class="fa fa-question-circle" aria-hidden="true"></i>
                </button>
                <?php } ?>
                  ...
                  <div class="col-md-12">
                     <div class="inline artist_list" id="tech_speech_div">
					  ...
					  echo Form::textarea("gig_description", $value=stripslashes($tech_spec_group), [ "id"=>"gig_description",  "disabled","placeholder"=>" ","maxlength"=>"500","class"=>"form-group inpt nb form-control" ]);
