...
//***************** fetching data for tooltip mesages ends here
 ...
 //*** for facbook starts *****                 
                ...
                {
                     $og_imgurl = BASEURLPUBLICCUSTOM.'upload/groupimage/thumb-big/'.$fetchimgData[0]->image_name;
                }
      ...
      <div class="row dj_row">
            ...
            <div class="profile_slider groupprofilesliderouterdv">
                ...
                if(!empty($fetchimgData))
                {
                    foreach($fetchimgData as $fetchimgDataobj)
                    {
					   ...
					   $imgurl = BASEURLPUBLICCUSTOM.'upload/groupimage/thumb-big/'.$fetchimgDataobj->image_name;
         ...
         <div class="col-sm-7">
            ...
            <div class="like_box">
			   ...
			   ?>
						<a href="javascript:void(0)" class="like_link red-tooltip goTo myfavorite deactive <?php echo $myfavoriteClass;?>" data-userId="<?php echo $fetchuserdata->id?>" data-go-to="Favorite_section" data-usertype="2" data-toggle="tooltip" title="Favourite"><img src="{{ FRONTCSSPATH}}/images/heart_icon.png" alt="" /></a>
				<?php
				}
				else
				{
				?>
				<a href="javascript:void(0)" class="like_link red-tooltip goTo myfavorite <?php echo $myfavoriteClass;?>" data-userId="<?php echo $fetchuserdata->id?>" data-go-to="Favorite_section" data-usertype="2" data-toggle="tooltip" title="Favourite"><img src="{{ FRONTCSSPATH}}/images/heart_icon.png" alt="" /></a>
			<?php	}
				?>
            ...
            //   $fetchcountryArData[]="Select country";
               ...
               ?>
                  ...
                  <input id="zip" class="form-control form-control-B" placeholder="Post Code" name="zip" type="text" value="" tabindex="13">
                    ...
                    <div class="col-sm-12">
                    <div class="btn_Adj">
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="revertbacktofive" type="button" data-toggle="modal" tabindex="14" > &#60; Previous Page </button>
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="continuetoseven" type="button" data-toggle="modal" tabindex="15" >Next Page > </button>
                    </div>
                   </div> 
                </div>
           <!--  </form> -->
                     ...
                     <div class="inline artist_list" id="tech_speech_div">
                        ...
                        <!--</div>-->
                         <span>Enter details or specifics here :
                          ...
                          <textarea id="gig_description" tabindex="18" placeholder="Please assist artist(s) by describing any event specifics such as:
...
Also specify any additional requests here to be included in this event" maxlength="1000" class="form-group inpt nb form-control" name="gig_description" cols="50" rows="10">{{$tech_speech}}</textarea>                        <!--                       <p> 5 lines, 50 characters maximum per line</p>-->
              ...
              <input type="hidden" id="fieldtocountbookingartist" value="1000">
               <p  id="CharCountLabelartistbooking" ></p>
                    ...
                    <div class="col-sm-12">
                    <div class="btn_Adj">
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="revertbacktosix" type="button" data-toggle="modal" tabindex="19" > &#60; Previous Page </button>
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="continuetoeight" type="button" data-toggle="modal" tabindex="20" >Last Page > </button>
                    </div>
                   </div> 
                </div>
            <!-- </form> -->
            ...
            <?php
              ...
              ?>
                ...
                <div id="bookingcanimg_div" data-bookingcanimgflag="0"></div>
                     ...
                     <div class="timer_absolute timer_absoluteB timer_absoluteBA">
                      <div class="inline artist_list ">
                        ...
                        <div class="form-group inpt input-customm input-customm-color hasInfo mydisplaynone">
                           <div class='input-group date'>
                            ...
                            <a href="javascript:void(0)" type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Request expire date time text message "><i class="fa fa-question-circle" aria-hidden="true"></i>
                                </a>
                        ...
                        <div class="form-group inpt input-customm input-customm-color hasInfo artist_listB">
                            <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr clck_outr fadeY" placeholder="DD" id="requexpire_day" name="requexpire_day" tabindex="24" />
                              </div>
                              <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr clck_outr fadeY" placeholder="HH" id="reqexpire_hour" name="reqexpire_hour" tabindex="25" /></div>
                            <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr clck_outr fadeY" placeholder="MM" id="reqexpire_minute" name="reqexpire_minute" tabindex="26" /></div>
                      ...
                      <div class="inline artist_list">
                        ...
                        <div class="radio_Check radio_CheckC">
                            ...
                            <div class="adj-baje">
                            <label class="radio-check radio_check_show_input">
                                <input type="radio" name="i_agree" value="za" tabindex="27"  id="readiodefaultcheckerror">
                              <span></span>Yes</label>
                            <label class="radio-check radio_check_show_input">
                                <input type="radio" name="i_agree" value="zb" tabindex="28" checked="checked">
                              <span></span>No</label>
                              </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                    <div class="btn_Adj">
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="revertbacktoseven" type="button" data-toggle="modal" tabindex="29" > &#60; Previous Page </button>
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg send_Booking" id="continue_tosubmit" type="button" data-toggle="modal" tabindex="30">Send Request</button>
	...
	//  });
         ...
         //********** After 5 microseconds page gets loaded image slider  starts ************************
            setTimeout(function(){
                ...
                $(".groupprofilesliderouterdv").html(image_prof_struct);
                
              
                 //get carousel instance data and store it in variable owl
                var owl = $(".groupprofilesliderouterdv").data('owlCarousel');     
                ...
                $('.groupprofilesliderouterdv').owlCarousel(newOptions);              
