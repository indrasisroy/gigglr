					...
					<div class="profile_slider edit_profile" id="profsldroutrdivid">
						...
						//print_r($group_master_img_db);die;
							...
							foreach($group_master_img_db as $user_master_dta)
							{
							  ...
							  //$imgurldata = "{{ URL::asset('public/front')}}/images/close2.png";
...
<!--			</div>
  ...
  <div class="modal-dialog popup-dialog" role="document">
	...
	<!--for ajax file upload starts-->
		...
		<script type="text/javascript" src="{{ URL::asset('public/front')}}/otherfiles/progjs/jqueryfileupload1/groupimageupload.js"></script>
		<script type="text/javascript" src="{{ URL::asset('public/front')}}/otherfiles/progjs/jqueryfileupload1/grouppresskitupload.js"></script>
	<!--for ajax file upload ends-->	
	<script type="text/javascript" src="{{ URL::asset('public/front')}}/otherfiles/progjs/frontendeditgroup.js"></script>
		    @endsection