                   ...
                   <div class="container">
                        <div class="clearfix myAccnt-custom">
							...
							<?php echo Form::open(array('files' => true, 'method' => 'post','id'=>'myaccountfrmid','class'=>"" )); ?>
								...
								<p>
								<strong>Note: </strong>The personal details you provide on this page will not be displayed to the public.<br>
Your ‘City’ is used, but not displayed, to include your profile page in local search results.
								</p>
                                     <div class="inputForum clearfix">
