                ...
                <div class="artist_divsn">
                  <div class="inline artist_list">
                      <span>Available for</span>
                        <select class="selectpicker artist_txt" id="typeEvent">
                ...
                <div class="artist_divsn">
                  <div class="inline artist_list">
                      <span>Bookings from</span>
                        <select class="selectpicker artist_txt" id="bookingfrom">
                            <!--<option value="0">depends on fee</option>-->
                            <option value="1">Worldwide</option>
                            <option value="2">My country</option>
                            <option value="3">My city</option>
                        </select>
                    </div>
                </div>
                  </div>
                ...
                <div class="artist_divsn">
                  <div class="inline artist_list">
                      <span>Hourly Rate</span>
                        <div class="textField inline srchtxtfield artist_txt epf"><input type="text" class="form-control inpt" placeholder="" id="hourly_rate" name="hourly_rate" />
                    </div>
                    </div>
                </div>
                  </div>
                ...
                <div class="artist_divsn">
                  <div class="inline artist_list">
                      <span>Security Deposit</span>
                        <div class="textField inline srchtxtfield artist_txt epf"><input type="text" class="form-control inpt" placeholder="" id="security_deposit" name="security_deposit" />
                    </div>
                    </div>
                </div>  
                  </div>
                  ...
                  <div class="col-md-12">
                   <div class="inline artist_list">
                      <span>Tech Specs</span>
                       <textarea class="artist_txtaria" id="tech_spec"></textarea>
