...
<?php
   ...
   $metadescriptiondata = $fetchuserdata->user_meta_data;
    ...
    }else
    {
	  ...
	  $user_description=htmlentities($fetchuserdata->user_description, ENT_QUOTES, "UTF-8");
	  if($user_description=='')
	  {
      ...
      <div class="modal-content popup-content artist_popup">
         <div class="modal-body popup-body">
            ...
            <div class="artist_form_outr clearfix">
               ...
               <!--<form>-->
              <!--  <form method="POST" action="http://52.10.11.14/betaprosessional" accept-charset="UTF-8" id="bookingform1" class="" autocomplete="off"> -->
