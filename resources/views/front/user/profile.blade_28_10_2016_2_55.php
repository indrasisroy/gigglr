...
?>
               ...
               <div class="col-sm-6 visitor_cols">
                  ...
                  if($atrist_sessionID == '')
                  {
                   ...
                   ?>
                     <a href="javascript:void(0)" class="book_btn openbkgrpcls deactive" onclick="booking_modalnotopen(1);">book artist</a>
              ...
              <div class="inline artist_list request_list">
                ...
                ?>
                  ...
                  <div class="col-md-12">
                     ...
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="continue" type="button">agree to terms </button>
                  </div>
               </div>
               <!--</form>-->
               <?php
