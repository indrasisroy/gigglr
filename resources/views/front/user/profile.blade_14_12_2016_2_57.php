                        ...
                        <div class="form-group inpt input-customm">
                           <div class='input-group date'>
                              <?php    
                                 ...
                                 "class"=>"form-control datepicker  fadeYlw",
                        ...
                        <div class="form-group inpt input-customm">
                           ...
                           <span class="dollar">$</span>
                              ...
                              <span class="glyphicon lck"><div id="securityimg_div" data-securityimgflag='0'></div></span>
                               ...
                               <button type="button" class="helpIcon bookingfrommarginleft" aria-label="Help" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Password must be at least 8 characters and should contain atleast one uppercase, one lowercase, one digit and one special character "><i class="fa fa-question-circle" aria-hidden="true"></i>
                                </button>
                           </div>
                        </div>
                     </div>
