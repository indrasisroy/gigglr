			...
			<div class="row dj_row">
				...
				<div class="col-sm-7">
                         ...
                         <div class="inputbox input_selectout clearfix" >
	                         <div class="select_outer singl_arow">
	                           <select class="selectpicker" multiple>
                                 ...
                                 <option>Tap Dancer</option>
                                 <option>Exotic Dancer</option>
                                 <option>Line Dancer</option>
	                           </select>
	                         </div>
	                      </div>
					...
					<div class="name_holder">
						<div class="mainCategory">DJ:</div>  
						<div class="gener">HipHop, <span>&times;</span></div><div class="gener">Belly Dancer, <span>&times;</span></div><div class="gener">Exotic Dancer, <span>&times;</span></div><div class="gener">Tap Dancer,<span>&times;</span></div>
					</div>
					<!-- <div class="name_holder">
						<div class="mainCategory">Dance:</div>  
						<div class="gener">HipHop, <span>&times;</span></div><div class="gener">Gener 2, <span>&times;</span></div><div class="gener">Gener 3, <span>&times;</span></div><div class="gener">Gener 4,<span>&times;</span></div>
					</div> -->
