         ...
         <div class="event_left_row">
            ...
            <ul class="visitor_cols event_btn_group">
              <!-- <li>
			   ...
			   <li>
				  <a href="javascript:void(0);" style="background: #ff635c;" class="pendbkpblshowflcls" data-typeflag="1" data-artistgrpvenueseo="<?php echo $seo_name;?>" data-pendbkpblshowfl="cal_pendingbkshowflag" data-pendingbkshowflag="1">								
				  <span class="pendbkpblshowflmsgcls">Pending Bookings</span>
				  <span class="pendbkpblshowflicocls add_icon"> </span>
				  </a>
			   </li>
			   <li>
				  <a href="javascript:void(0);" style="background: #f1c40f;" class="pendbkpblshowflcls" data-typeflag="1" data-artistgrpvenueid="<?php echo session('front_id_sess');?>" data-pendbkpblshowfl="cal_publiceventshowflag" data-pendingbkshowflag="1" >
