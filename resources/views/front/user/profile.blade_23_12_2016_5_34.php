...
<?php
   ...
   $metadescriptiondata = $fetchuserdata->user_meta_data;
    ...
    }else
    {
	  ...
	  $user_description=stripslashes($fetchuserdata->user_description);
	  if($user_description=='')
	  {
...
//***************** fetching data for tooltip mesages starts here
                ...
                $inar=array('Security-deposit','Total-payment','Cancellation-fee','Duration','Request-expire-datetime');
      ...
      <div class="modal-content popup-content artist_popup">
         <div class="modal-body popup-body">
            ...
            <div class="artist_form_outr clearfix">
                <h2><span>When </span>is your event: 1/4</h2>
               <!--<form>-->
               <form method="POST" action="http://52.10.11.14/betaprosessional" accept-charset="UTF-8" id="bookingform1" class="" autocomplete="off"><input name="_token" type="hidden" value="Rz922kkUIZfODxVcACrBb0PERxH4JPqXTjUGKYTY">               <div class="alert error" style="display: none;">Your booking failed</div>
                    ...
                    <div class="timer_absolute">
                     <div class="inline artist_list">
                             <span>Start Time:</span>
                              ...
                              <a href="javascript:void(0)" type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-placement="top" title="" data-original-title="Start Time"><i class="fa fa-question-circle" aria-hidden="true"></i>
                                </a>
                     ...
                     <div class="inline artist_list">
                        ...
                        <?php
                          ...
                          {
                               ?>
                          <a href="javasript:void(0)" type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Duration text message "><i class="fa fa-question-circle" aria-hidden="true"></i>
                                </a>
                                  <?php
  ...
  <div class="modal-dialog popup-dialog" role="document">
    <div class="modal-content popup-content artist_popup">
      ...
      <div class="artist_hedr request booking_request">
        ...
        <div class="artist_form_outr clearfix">
            <h2><span>Where </span>is your event: 2/4</h2>
                ...
                <input id="booking_location_second" class="form-control form-control-B" placeholder="Address2" name="booking_location_second" type="text" value="">                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="radio_Check">
                            <span>Publish this event in Gig Guide?  </span> &nbsp;
  ...
  <div class="modal-dialog popup-dialog" role="document">
    <div class="modal-content popup-content artist_popup">
      ...
      <div class="artist_hedr request booking_request">
        ...
        <div class="artist_form_outr clearfix">
            <h2><span>What </span>is your event: 3/4</h2>
              ...
              <input type="hidden" id="fieldtocountbookingartist" value="500">
               <p  id="CharCountLabelartistbooking" ></p>
                    ...
                    <div class="btn_Adj">
                     ...
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="continuetoeight" type="button" data-toggle="modal" >Next Page > </button>
                    </div>
                   </div> 
                </div>
            <!-- </form> -->
  ...
  <div class="modal-dialog popup-dialog" role="document">
    <div class="modal-content popup-content artist_popup">
      ...
      <div class="artist_hedr request booking_request">
        ...
        <div class="artist_form_outr clearfix">
            <h2><span>Your </span>event budget: 4/4</h2>
            <form method="POST" action="http://52.10.11.14/betaprosessional" accept-charset="UTF-8" id="bookingform4" class="" autocomplete="off">
                ...
                <div id="bookingcanimg_div" data-bookingcanimgflag="0"></div>
                    ...
                    <div class="btn_Adj">
                     ...
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg send_Booking" id="continue_tosubmit" type="button" data-toggle="modal">Send booking</button>
                    </div>
                   </div> 
                </div>
            </form>
