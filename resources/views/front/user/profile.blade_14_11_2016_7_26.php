                        ...
                        <div class="form-group inpt input-customm input-customm-2">
                          ...
                          <!--  <input type='text' class="form-control clck_outr timepicker" placeholder="3.15 pm" id="end_time" name="end_time"/>
                              ...
                              <span class="glyphicon glyphicon-time"></span>
                                ...
                                <input type='text' class="form-control" style="width:25% !important; margin-right: 5px !important;" placeholder="Hour" id="end_time_hr" name="end_time_hr" />
                                <span id="end_time_hr_error" class="authError" style="display:none;">You have entered a previous hour or minute</span>
                                <input type='text' class="form-control" style="width:30% !important; margin-right: 5px !important;" placeholder="Minute" id="end_time_mnt" name="end_time_mnt" />
                                <!-- <input type='text' class="" style="width:30%" placeholder="am pm" id="start_time_ampm" name="start_time" /> -->
