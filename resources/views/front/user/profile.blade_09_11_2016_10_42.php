 ...
 <?php
    if($available_for == '3')
         ...
         ?>
            ...
            <input type='text'  class="form-control" style="width:25% !important;margin-right: 5px !important;" placeholder="Hour" id="start_time_hr" name="start_time" />
            <input type='text'  class="form-control" style="width:30% !important; margin-right: 5px !important;" placeholder="Minute" id="start_time_mnt" name="start_time" />
            <!-- <input type='text' class="" style="width:30%" placeholder="am pm" id="start_time_ampm" name="start_time" /> -->

            <select id="ddlViewBy"  class="form-control" style="width:40% !important; ">
                        ...
                        <div class="form-group inpt input-customm input-customm-2">
                          ...
                          <!--  <input type='text' class="form-control clck_outr timepicker" placeholder="3.15 pm" id="end_time" name="end_time"/>
                              ...
                              <span class="glyphicon glyphicon-time"></span>
                                ...
                                <input type='text' class="form-control" style="width:25% !important; margin-right: 5px !important;" placeholder="Hour" id="end_time_hr" name="start_time" />
                                <input type='text' class="form-control" style="width:30% !important; margin-right: 5px !important;" placeholder="Minute" id="end_time_mnt" name="start_time" />
                                <!-- <input type='text' class="" style="width:30%" placeholder="am pm" id="start_time_ampm" name="start_time" /> -->

                                <select id="ddlViewend" class="form-control" style="width:40% !important; ">
                                <option value="">Format</option>
                                <option value="1">AM</option>
                                <option value="2">PM</option>
                                </select>
