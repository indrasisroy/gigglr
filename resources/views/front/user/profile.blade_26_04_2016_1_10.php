...
$roundofpresentation=0;
   ...
   if(!empty($user_testi))
     {
        $tottesti = count($user_testi);
         foreach($user_testi as $counttotal)
         {
            $puntuality = $puntuality+$counttotal->puntuality;
            $performence = $performence+$counttotal->performence;
            $presentation = $presentation+$counttotal->presentation;
         }
              $roundofpuntulity = $puntuality/$tottesti;
              $roundofpuntulity = round($roundofpuntulity);
              $roundofperformence = $performence/$tottesti;
              $roundofperformence = round($roundofperformence);
              $roundofpresentation = $presentation/$tottesti;
              $roundofpresentation = round($roundofpresentation);
    }
...
<section class="profile_outer" id="review_section">
   <div class="container">
     ...
     {
          $ratingreview = $userreview->puntuality+$userreview->performence+$userreview->presentation;
         ...
         <div class="modal-body popup-body">
            ...
            <div class="artist_form_outr clearfix">
               ...
               <div class="row">
                  ...
                  <div class="new-location clearfix" style="display:none;">
                      <div class="col-md-12">
                        <div class="artist_divsn reqst_dvsn">
