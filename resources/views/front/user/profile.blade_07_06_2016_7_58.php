         ...
         <div class="modal-body popup-body">
            ...
            <div class="artist_form_outr clearfix">
               ...
               <div class="row">
                  ...
                  <div class="col-md-12">
                     <button class="btn btn-warning artist_btn reqst_btn" id="cancelbtn">cancel</button>
                     <button class="btn btn-warning artist_btn rqst_trm_btn" id="cancelbtn2">agree to terms </button>
                  </div>
               </div>
               <!--</form>-->
               <?php
...
<script>
   ...
   //**** bind profile page starts
   	...
   	var pj = callforbooking("publicprofile");
   	if (pj == 2) {
          // alert('hello success');
   		$('#myModal5').modal('hide');
   		return false;
	...
	//*********
   			...
   			//alert(booking_date);
   				...
   				//{
   				//	booking_date = $('#booking_date').data('date'); //*********getting date from start date control
   				//	$('#requestexpireddate').data("DateTimePicker").maxDate(booking_date); //********* set max date for end date
   				...
   				//{
   				//	booking_time = $('#start_time').data('date');
   				//	requestexpireddate = $('#requestexpireddate').data('date');
   				//	
   				//});
   				//*********************start time control************************
   ...
   //					if(requestexpireddate == booking_date)
   //					{
   //						alert('same');
   //                        booking_time = $('#start_time').data('date');
   //						//alert(booking_time);
   //						$('#requestexpiredtime').data("DateTimePicker").maxDate(booking_time);
   //					}
   //					else
   //					{
   //						alert('not same');
   //						$('#requestexpiredtime').data("DateTimePicker").maxDate();
   //					
   //					}
   //					//******checking ends here
   //					//booking_time = $('#start_time').data('date');
   //					
   				...
   				$("#start_time").on("dp.change", function(e)
   				{
   					 ...
   					 //datecur3 = new Time("10:20 AM");
   					 //console.log(datecur3);
   					 var mmdata1=e.date;
   					 console.log(e.date);
				...
				$("#requestexpireddate").on("dp.change", function(e)
   				{
					...
					else
					{
						...
						$("#requestexpiredtime").datetimepicker({maxDate: '00:50 AM'});
						
						//$('#requestexpiredtime').val('').timepicker('update');
					  // $("#requestexpiredtime").datetimepicker( "option", "maxDate", null)
					}
					//$('#requestexpireddate').data("DateTimePicker").maxDate(setdate);
					//console.log("booking time=============>"+ bookingTime);
					//
   ...
   <script type="text/javascript" src="{{ URL::asset('public/front')}}/otherfiles/progjs/frontendpublicprofile.js"></script>
