								...
								<div class="custom-formIn exclass" <?php echo $css_style; ?>>
                                     <div class="inputForum clearfix">
                                        <label>Referrer E-mail</label>
                                         <div class="from-control-custom hasInfo">
											 ...
											 ?>
											  ...
											  <button type="button" class="helpIcon bookingfrommarginleft" data-trigger="click" aria-label="Help" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $referreremaildata; ?>"><i class="fa fa-question-circle" aria-hidden="true"></i>
                    							</button>
                    							<?php 
