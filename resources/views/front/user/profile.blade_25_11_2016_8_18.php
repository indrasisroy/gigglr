                ...
                ?>
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="inline artist_list">
                            ...
                            <div class="form-group inpt input-customm clearfix newTimeWrap">
                              <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr" placeholder="hh" id="requexpire_time_hr" name="requexpire_time_hr" />
                              </div>
                              <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr" placeholder="mm" id="reqexpire_time_mnt" name="reqexpire_time_mnt" /></div>
                              <div class="ampm">
