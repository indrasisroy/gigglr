      ...
      <div class="row dj_row">
         ...
         <div class="col-sm-7">
            ...
            <div class="like_box">
						...
						<a href="#" class="like_link red-tooltip goTo" data-go-to="Favorite_section"  data-toggle="tooltip" title="Favorite"><img src="{{ FRONTCSSPATH}}/images/heart_icon.png" alt="" /></a>
            ...
            <div class="row row_visitor">
               ...
               <div class="col-sm-6 visitor_cols">
                  ...
                  { 
                    ...
                    { ?>
                    <a href="#" class="book_btn openbkgrpcls" onclick="booking_modalnotopen(2);">book artist</a>
                    <?php 
                  }
                  else if($submitBtbFlag == 0)
                  {?>
                        <a href="#" class="book_btn openbkgrpcls"  onclick="booking_modal_norate();">book artist</a>
                  <?php
                  }
                  else
                  {
...
<!--                     <a href="#" class="book_btn press_btn">press kit</a>-->
                      ...
                      }else
                      {
                          ...
                          ?>
                           <a href="#" class="book_btn press_btn" onclick="no_presskit()">press kit</a>
               <?php
                      }
							?>
                  </div>
         ...
         <div class="event_left_row">
            ...
            <ul class="visitor_cols event_btn_group">
              <!-- <li>
			   ...
			   <li>
				  <a href="javascript:void(0);" style="background: #f1c40f;" class="allprofileeventcls" data-evtype="YELLOWSTART" data-evtypeflag="<?php echo $cal_publiceventshowflag;?>" data-typeflag="1" data-artistgrpvenueid="<?php echo session('front_id_sess');?>" data-pendbkpblshowfl="cal_publiceventshowflag" data-pendingbkshowflag="1" >
				  <span class="pendbkpblshowflmsgcls">Public Events</span>
				  <span class="pendbkpblshowflicocls add_icon"> </span>
				  </a>
			   </li>
			   <li>
				  <a href="javascript:void(0);" style="background: #525252;" class="allprofileeventcls" data-evtype="BLACKSTART" data-evtypeflag="<?php echo $cal_privateeventshowflag;?>" data-typeflag="1" data-artistgrpvenueid="<?php echo session('front_id_sess');?>" data-pendbkpblshowfl="cal_privateeventshowflag" data-pendingbkshowflag="1" >
                        ...
                        <div class="form-group inpt input-customm">
                           <div class='input-group date'>
                              ...
                              <?php
                                 ...
                                 ?>
                              <span class="input-group-addon clck">
                              <span class="glyphicon lck"><img src="{{ FRONTCSSPATH}}/images/lock2.png" alt=""/></span>
                              </span>
                           </div>
                        </div>
                     </div>
...
$(window).load(function() {
      // $('window').fadeIn('slow');
       ...
       showmycustomloader(1,'2500','1000',"Loading please wait ...",imfpth);
});
