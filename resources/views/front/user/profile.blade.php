...
//***************** fetching data for tooltip mesages ends here
 ...
 $imgurldata = BASEURLPUBLICCUSTOM."front/otherfiles/progimages/"."noimagefound537X507.png";
               // $fetchimgDat2a = array();
                ...
                {
                     $og_imgurl = BASEURLPUBLICCUSTOM.'upload/userimage/thumb-big/'.$fetchimgData[0]->image_name;
                }



$og_description='';
$og_description=($user_description == 'No description available')?'':$user_description;
...
<section class="profile_outer">
   <div class="container">
      <div class="row dj_row">
               ...
               //************* manipulate profile slider code  starts ************** 
                ...
                if(!empty($fetchimgData))
                {
                    foreach($fetchimgData as $fetchimgDataobj)
                    {
					   ...
					   $imgurl = BASEURLPUBLICCUSTOM.'upload/userimage/thumb-big/'.$fetchimgDataobj->image_name;
         ...
         <div class="col-sm-7">
            <h2 class="prifile_heading text-right profcustmyclass"  ><?php echo stripslashes($first_name);?></h2>
            ...
            <div class="like_box">
                  ...
                  if($atrist_sessionID == $artist_own_id)
                  {
                   ...
                   ?>
						<a href="javascript:void(0)" class="like_link red-tooltip goTo myfavorite deactive <?php echo $myfavoriteClass;?>" data-userId="<?php echo $fetchuserdata->id?>" data-go-to="Favorite_section" data-usertype="1" data-toggle="tooltip" data-trigger="hover" title="Favourite"><img src="{{ FRONTCSSPATH}}/images/heart_icon.png" alt="" /></a>
							<?php
							}
							else
							{
							?>
							<a href="javascript:void(0)" class="like_link red-tooltip goTo myfavorite <?php echo $myfavoriteClass;?>" data-userId="<?php echo $fetchuserdata->id?>" data-go-to="Favorite_section" data-usertype="1" data-toggle="tooltip" data-trigger="hover" title="Favourite"><img src="{{ FRONTCSSPATH}}/images/heart_icon.png" alt="" /></a>
...
<!--
             <div class="fb-share-button" data-href="<?php // echo $currnt_url_data; ?>" data-layout="button" data-size="small" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse">Share</a></div>
        ...
        <div class="artist_form_outr clearfix">
           ...
           <!--  <form method="POST" action="http://52.10.11.14/betaprosessional" accept-charset="UTF-8" id="bookingform2" class="" autocomplete="off"> -->
              ...
              ?>
                ...
                <input id="booking_location" class="form-control form-control-B" placeholder="Address1" name="booking_location" type="text" value="" tabindex="8">         <!--<input type="text" class="form-control form-control-B" placeholder="Address2"/>-->
                <input id="booking_location_second" class="form-control form-control-B" placeholder="Address2" name="booking_location_second" type="text" value="" tabindex="9">                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="artist_divsn">
                          <div class="inline artist_list request_list">
                          <input id="town" class="form-control form-control-B" placeholder="City" name="town" type="text" value="" tabindex="12">
                            </div>
                        </div>
                  </div>
                    <div class="col-md-6">
                        <div class="artist_divsn">
                          <div class="inline artist_list request_list">
                            <input id="zip" class="form-control form-control-B" placeholder="Post Code" name="zip" type="text" value="" tabindex="13">
                            </div>
                        </div>
                  </div>
                    <div class="col-sm-12">
                       ...
                       <?php if($available_for == '3') {?>
                            ...
                            <!-- <input type="radio" name="gen" value="za" tabindex="14"> -->
                             <?php 
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="inline artist_list ">
                        ...
                        <div class="form-group inpt input-customm input-customm-color hasInfo artist_listB">
                            <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr clck_outr fadeY" placeholder="DD" id="requexpire_day" name="requexpire_day" tabindex="26"/>
                              </div>
                              <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr clck_outr fadeY" placeholder="HH" id="reqexpire_hour" name="reqexpire_hour" tabindex="27" /></div>
                            <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr clck_outr fadeY" placeholder="MM" id="reqexpire_minute" name="reqexpire_minute" tabindex="28"/></div>
   	...
   	$(document).ready(function()
   	{
         //********** After 5 microseconds page gets loaded image slider  starts ************************
            setTimeout(function(){
                ...
                $(".profilesliderouterdv").html(image_prof_struct);
                
              
                 //get carousel instance data and store it in variable owl
                var owl = $(".profilesliderouterdv").data('owlCarousel');     
                ...
                $('.profilesliderouterdv').owlCarousel(newOptions);              
