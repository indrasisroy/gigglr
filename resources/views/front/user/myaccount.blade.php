...
if(!empty($faqpage))
{
	...
	//************** Tooltip messages starts here
									

				$fetchtype='single'; $tablename="tooltip_message";
                $fieldnames="tooltip_message";
                $wherear=array();
                $wherear['tooltip_label']='Referrer-email';
                $orderbyfield="id"; $orderbytype="asc";
                $limitstart=0;$limitend=0; 
                $pin_secret_key='';$pin_publishable_key='';$pin_liveortest='';$service_charge=0;
                $fetchfrontreferreremaildata=getdatafromtable($fetchtype,$tablename,$fieldnames,$wherear,$orderbyfield='',$orderbytype,$limitstart,$limitend);
                
                $referreremaildata='';
                if(!empty($fetchfrontreferreremaildata))
                {
                	$referreremaildata = stripslashes($fetchfrontreferreremaildata->tooltip_message);
                }


    //************** Tooltip messages ends here
                        ...
                        <div class="clearfix myAccnt-custom">
                            <div class="custom-col-3">
								...
								<?php
									...
									$imgurldata = BASEURLPUBLICCUSTOM."front/otherfiles/progimages/"."noimagefound208X201.png";
                                ...
                                <div class="account-holder-about">
									...
									echo substr(stripslashes($userdetails->nickname),0,7)."...";
									}else{
									...
									?></h2>
										...
										$seoName = stripslashes($userdetails->seo_name);
										}else{
										//$seoName = "123";
										}?>
                                    <?php if(!empty($seoName)) {  ?><button class="btn profile-btmn viewmyprofile"  data-location = "<?php echo url('a')."/".$seoName; ?>" >
							...
							<?php echo Form::open(array('files' => true, 'method' => 'post','id'=>'myaccountfrmid','class'=>"" )); ?>
                                     ...
                                     <div class="inputForum clearfix">
                                        ...
                                        <span class="hasInfo">
                                        	...
                                        	<?php 
											  ...
											  if($referreremaildata!=''){
											  ?>

											  <button type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $referreremaildata; ?>"><i class="fa fa-question-circle" aria-hidden="true"></i>
                    							</button>
                    							<?php 
                                ...
                                <div class="custom-formIn myaccpaddingtopcls">
								
								<p class="mrgnbtm_myaccnote">
								<strong>Note: </strong>The personal details you provide on this page will not be displayed to the public. However,<br>
we do use the location of your city to determine the distance of inclusion in local search results.
								<br>
								Read our <a class="fntBold sttccolr"  target="_blank"  href="<?php echo url('privacy-policy');?>" >Privacy Policy</a> for more.
								</p>
									...
									?>
                                     ...
                                     <div class="col-custom-xs-4">
                                        <div class="inputForum clearfix right">
                                              <label style="padding-right: 2px !important;">State * </label>
												<div class="from-control-custom">
                                                <?php
                                    ...
                                    <div class="inputForum clearfix right">
                                        <label style="padding-right: 2px !important;" >Post Code * </label>
                                       <div class="from-control-custom">
