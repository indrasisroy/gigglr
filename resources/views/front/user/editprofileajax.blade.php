...
{
    $residentadvisor_url="https://www.mixcloud.com/";
}
					...
					<div class="row row_visitor">
						<ul class="col-sm-6 visitor_cols">
							...
							<li class="link_edit">								
								...
								<span data-myurldata="residentadvisordefurl" data-residentadvisordefurl="https://www.mixcloud.com/" class="outPut"><?php echo $residentadvisor_url; ?></span>
...
UPLOAD PDF KIT
								...
								<li class="btn_row pg_mta pagemetatagcustcls nowseourlcommnlicls" style="text-transform: lowercase !important;">
									<span class="outPut"><?php if($pageseourldata!=''){ echo $artisturl.$pageseourldata; } else{ echo $artisturl; }?></span>
                					<input type="text" id="pagemetatagcust_artist" class="editInput nowseourltxtcommncls" value="" />
								</li>		
							</ul>							
			...
			<div class="month-chart clearfix">
				 <div class="left_chart">
					...
					<div class="setting_icon">
						...
						<a href="javascript:void(0);" class="calendarPopBtn"><img src="{{ FRONTCSSPATH}}/images/setting_icon.png" alt="" /></a> <!-- Calendar Settings --><span class="cal_setting_txtcls"> Calendar Settings</span>
                   ...
                   <div class="inline artist_list">
                      <span>Tech Specs</span>
					   ...
					   <?php 
								...
								$attributes = array( "id"=>"tech_spec", "class"=>"artist_txtaria", "cols"=>"50", "rows"=>"10", "maxlength"=>"500" ));
						?>
						</div>
						<input type="hidden" id="fieldtocount" value="500">
