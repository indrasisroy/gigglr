              ...
              <?php // echo Form::open(array('files' => true, 'method' => 'post','id'=>'myaccountfrmid','class'=>"" )); ?>
                   <div class="container">
                        <div class="clearfix myAccnt-custom">
                            <div class="custom-col-3">
                                ...
                                <div class="account-holder-about">
									...
									?></h2>
                                    <button class="btn profile-btmn"><a href="<?php echo url('profile'); ?>">View Profile</a></button>
                                </div>
                            </div>
						...
						<div id="dobdivmyaccount"></div>
                                   <!--<div class="selectWrap adj-width-custom date-pickerWidth">
                                    ...
                                    <div class="selectWrap adj-width-custom month-pickerWidth">
                                        <select class="selectpicker ">
                                    ...
                                    <div class="selectWrap adj-width-custom year-pickerWidth">
                                        <select class="selectpicker">
      ...
      <div class="modal-body">
       ...
       <div class="password-form">
		...
		?>
		  ...
		  <div class="validationpass mydisplayblock myerrorcolor myitalicclass" style="display:none""></div>
       </div>
