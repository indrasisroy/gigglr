...
$pendingmsgdata=''; $publiceventshowmsgdata=''; $privateeventshowmsgdata='';
$venueownID = 0;
if(!empty($fetchuserdata))
{
	$pageseourldata=stripslashes($fetchuserdata->seo_name);
	$venueownID = $fetchuserdata->id;
...
if($fetchuserdata->closing_time!="00:00:00")
...
if ($cal_pendingbkshowflag==0)
		{
                 ...
                 $pendingmsgdataImageClass = "add_icon";
		}
		else
		{
				$pendingmsgdata="Hide Pending Booking";
                $pendingmsgdataImageClass = "remove_icon";
		}
		...
		if ($cal_publiceventshowflag==0)
		{
                 ...
                 $publiceventshowmsgdataImageClass ="add_icon";
		}
		else
		{
				$publiceventshowmsgdata="Hide my public events";
                $publiceventshowmsgdataImageClass="remove_icon";
		}
        
		if($cal_privateeventshowflag==0)
		{
			$privateeventshowmsgdata="Show my private events ";
            $privateeventshowmsgdataImageClass = "add_icon";
		}
		else
		{
				$privateeventshowmsgdata="Hide my private events";
                $privateeventshowmsgdataImageClass = "remove_icon";
		}
...
{
	$residentadvisor_url="https://www.zomato.com/";//"https://www.residentadvisor.net/";
}
			...
			<div class="row dj_row">
					...
					<div class="profile_slider edit_profile" id="profsldroutrdivid">
						...
						if(!empty($user_master_img_db))
						{
							...
							foreach($user_master_img_db as $user_master_dta)
							{
                              ...
                              $imgurldata = BASEURLPUBLICCUSTOM.'upload/venueimage/thumb-big/'.$user_master_dta->image_name;
				...
				<div class="col-sm-7">
					<h2 class="prifile_heading esEditor">
						<div class="userName">
	                		<span class="outPut"><?php echo stripslashes($nickname); ?></span>
					...
					<div id="skillidouterdiv">
							...
							<div class="name_holder skillparentclss"  data-skillparent='<?php echo $skill_parent_data; ?>' >
								...
								{		
								$countdaataskillsub = count($skill_sub_data_Ar);
					...
					<div class="row row_visitor">
						<ul class="col-sm-6 visitor_cols">
							...
							<li class="link_edit">								
								...
								<span data-myurldata="residentadvisordefurl" data-residentadvisordefurl="https://www.zomato.com/" class="outPut"><?php echo $residentadvisor_url; ?></span>
...
<!--                					<input type="text" id="ridercust" class="editInput" value="" />-->
									<a href="javascript:void(0);" class="menuupld"> 

									<?php $chkmenu =  ($menuflagcheck > 0 ? 'CHANGE' : 'UPLOAD'); ?>

                					<?php echo $chkmenu; ?> MENU

                                    </a>
								</li>
								<li class="btn_row abn abncustcls labelSpclWrap">
									<div class="labelSpcl">Abn :</div>
									<span class="outPut"><?php if($abncustdata!=''){ echo $abncustdata; } else{ echo ""; }?></span>
                					<input type="text" id="abncust" class="editInput" value="" maxlength="11"/>
								</li>	
								<li class="btn_row gst gstcustcls labelSpclWrap">
								<div class="labelSpcl">tfn :</div>
										<a href="javascript:void(0);"><span class="outPut"><?php if($gstcustdata!=''){ echo $gstcustdata; } else{ echo ""; }?></span></a>
										<input type="text" id="gstcust" class="editInput" value="" maxlength="9"/>
								...
								<li class="btn_row pg_mta pagemetatagcustcls nowseourlcommnlicls" style="text-transform: lowercase !important;">
									<span class="outPut"><?php if($pageseourldata!=''){ echo $venueurl.$pageseourldata; } else{ echo $venueurl; }?></span>
                					<input type="text" id="pagemetatagcust_venue" class="editInput nowseourltxtcommncls" value="" />
								</li>
			...
			<div class="dj_row esEditor para_edit">
                <h2 class="edt_img edt_txt ">Enter profile text here  </h2><a href="javascript:void(0);" class="editBtn descchngancclass"></a>
                
                <div class="textWrap">
                	<p class="outPut"><?php echo html_entity_decode($user_description); ?></p>      
                     ...
                     <div class="inline artist_list">
                        ...
                        <div class="form-group inpt input-customm">
                           <div class='input-group date'>
                              ...
                              <span class="glyphicon lck"><img src="{{ FRONTCSSPATH}}/images/lock.png" alt=""/></span>
                              </span>-->
                           </div>
                        </div>
                     </div>
			...
			if(!empty($user_venue_amenities))
			{
								...
								foreach($user_venue_amenities as $venue_amenities)
								{
									...
									$amenitiesdata=stripslashes(ucfirst($venue_amenities->amenity_name));
                                     ...
                                     $imgurldata = BASEURLPUBLICCUSTOM.'upload/amenities-image/source-file/'.$venue_amenities->amenity_img;
									?>
...
<a href="javascript:void(0);" data-calviewshowflag="0" data-typeflag="3" data-artistgrpvenueid="<?php echo $venueownID;?>" class="calviewshowflagcls hideCalendar <?php if($cal_viewshowflag==0){ echo 'active';} ?>  ">Hide Calendar</a>

<!-- <a href="javascript:void(0);" data-calviewshowflag="0" data-typeflag="3" data-artistgrpvenueid="<?php echo $venueownID;?>" class="calviewshowflagcls hideCalendar">Hide Calendar</a> -->
<!-- <a href="javascript:void(0);" data-calviewshowflag="1" data-typeflag="3" data-artistgrpvenueid="<?php echo $venueownID;?>" class="calviewshowflagcls showCalendar active">Show Calendar</a> -->

<a href="javascript:void(0);" data-calviewshowflag="1" data-typeflag="3" data-artistgrpvenueid="<?php echo $venueownID;?>" class="calviewshowflagcls showCalendar <?php if($cal_viewshowflag==1){ echo 'active';} ?>">Show Calendar</a>
		...
		<div class="container calsettingsdvcls">
			<div class="event_left calendarHeight">
				<div class="event_left_row">
					...
					<ul class="visitor_cols event_btn_group">
						...
						<li>
							<a href="javascript:void(0);" style="background: #ff635c;" class="pendbkpblshowflcls" data-typeflag="3" data-artistgrpvenueid="<?php echo $venueownID;?>" data-pendbkpblshowfl="cal_pendingbkshowflag" data-pendingbkshowflag="<?php echo ($cal_pendingbkshowflag==1)?0:1; ?>">								
								<span class="pendbkpblshowflmsgcls"><?php echo $pendingmsgdata; ?></span>
								<span class="pendbkpblshowflicocls pendingmsg <?php echo $pendingmsgdataImageClass?>"> </span>
							</a>
						</li>
						<li>
							<a href="javascript:void(0);" style="background: #f1c40f;" class="pendbkpblshowflcls" data-typeflag="3" data-artistgrpvenueid="<?php echo $venueownID;?>" data-pendbkpblshowfl="cal_publiceventshowflag" data-pendingbkshowflag="<?php echo ($cal_publiceventshowflag==1)?0:1; ?>" >
								<span class="pendbkpblshowflmsgcls"><?php echo $publiceventshowmsgdata; ?></span>
								<span class="pendbkpblshowflicocls publicevent <?php echo $publiceventshowmsgdataImageClass?>"> </span>
							</a>
						</li>

						<li>
							<a href="javascript:void(0);" style="background: #525252;" class="pendbkpblshowflcls" data-typeflag="3" data-artistgrpvenueid="<?php echo $venueownID;?>" data-pendbkpblshowfl="cal_privateeventshowflag" data-pendingbkshowflag="<?php echo ($cal_privateeventshowflag==1)?0:1; ?>" >
								<span class="pendbkpblshowflmsgcls"><?php echo $privateeventshowmsgdata; ?></span>
								<span class="pendbkpblshowflicocls privateevent <?php echo $privateeventshowmsgdataImageClass?>"> </span>
							</a>
						</li>
			...
			<div class="event_right calendarHeight calendarChange" id="calendardivid">
		...
		<div class="container">
			<div class="clearfix revEdit">
				...
				<div class="radioCheckWrap">
					...
					<!-- <input type="hidden" value="<?php echo $venueownID;?>" id="venuehiddenid">
...
<script>
		...
		var venuehiddenid = "<?php echo $venueownID;?>";
		var venuehiddenval = "<?php echo $fetchuserdata->review_show_flag;?>";
</script>
	...
	<!--for ajax file upload starts-->
		...
		<script type="text/javascript" src="{{ FRONTCSSPATH}}/otherfiles/progjs/jqueryfileupload1/venueimageupload.js"></script>
		<script type="text/javascript" src="{{ FRONTCSSPATH}}/otherfiles/progjs/jqueryfileupload1/venuepresskitupload.js"></script>
		<script type="text/javascript" src="{{ FRONTCSSPATH}}/otherfiles/progjs/jqueryfileupload1/venuemenuupload.js"></script>
	<!--for ajax file upload ends-->
	
	<script type="text/javascript" src="{{ FRONTCSSPATH}}/otherfiles/progjs/frontendeditvenue.js"></script>
