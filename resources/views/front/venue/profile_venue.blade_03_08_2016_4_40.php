                  ...
                  ?>
					...
					<div class="row row_visitor">
						...
						<div class="col-sm-6 visitor_cols">
						    ...
						    {?>
						    	<a href="#" class="book_btn bk_venue openbkgrpcls" onclick="no_hourlyrate()">book venue</a>
						   <?php 
						    }
						    else
							{
					...
					<?php
                      ...
                      }else
                     {
                          ...
                          ?>
                          <a href="#" class="book_btn press_btn" onclick="showno_presskit()">press kit</a>
                     	 ...
                     	 <?php 
							...
							<div class="btn_row">
									...
									//echo link_to('#', $title = 'menu', $attributes = array("class"=>"book_btn rider_btn mnu_venuebook_btn press_btn"), $secure = null); showno_menu 
										?>
									<a href="#" class="book_btn rider_btn mnu_venuebook_btn press_btn" onclick="showno_menu()">menu</a>
									<?php 
								}
									?>
