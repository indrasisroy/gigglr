...
$instagram_url='';	$youtube_url='';	$residentadvisor_url='';
 ...
 $ridercustdata=''; $abncustdata=''; $gstcustdata=''; $pagemetatagcustdata='';
...
if(!empty($fetchuserdata))
{
  ...
  $first_name="Indrasis";
	 $nickname=$fetchuserdata->venue_name;
...
<!--                					<input type="text" id="ridercust" class="editInput" value="" />-->
									<a href="javascript:void(0);" class="presskitupld">UPLOAD MENU
                                    </a>
								</li>
...
<div class="containerchkbox">
	...
	<div class="amenitiesCheckWrap">
						<label class="radio-check amenitiesCheck"><input type="checkbox" />
                    		<span></span>Amenities <img src="{{ URL::asset('public/front')}}/images/car-sm.png" alt="" />
                    	</label>
                    	<label class="radio-check amenitiesCheck"><input type="checkbox" checked="checked" />
                        	<span></span>Keep me signed in <img src="{{ URL::asset('public/front')}}/images/couple-sm.png" alt="" />
                        </label>
                    	<label class="radio-check amenitiesCheck"><input type="checkbox" checked="checked" />
                    		<span></span>Keep me signed in <img src="{{ URL::asset('public/front')}}/images/fork-sm.png" alt="" />
                		</label>
                		<label class="radio-check amenitiesCheck"><input type="checkbox" />
                    		<span></span>Amenities <img src="{{ URL::asset('public/front')}}/images/glass-sm.png" alt="" />
                    	</label>
                    	<label class="radio-check amenitiesCheck"><input type="checkbox" checked="checked" />
                        	<span></span>Keep me signed in <img src="{{ URL::asset('public/front')}}/images/man-sm.png" alt="" />
                        </label>
                    	<label class="radio-check amenitiesCheck"><input type="checkbox" checked="checked" />
                    		<span></span>Keep me signed in <img src="{{ URL::asset('public/front')}}/images/vip-sm.png" alt="" />
                		</label>
							<label class="radio-check amenitiesCheck"><input type="checkbox" />
                    		<span></span>Amenities <img src="{{ URL::asset('public/front')}}/images/car-sm.png" alt="" />
                    	</label>
                    	...
                    	<label class="radio-check amenitiesCheck"><input type="checkbox" checked="checked" />
                    		<span></span>Keep me signed in <img src="{{ URL::asset('public/front')}}/images/vip-sm.png" alt="" />
                		</label><label class="radio-check amenitiesCheck"><input type="checkbox" />
                    		<span></span>Amenities <img src="{{ URL::asset('public/front')}}/images/car-sm.png" alt="" />
                    	</label>
                    	<label class="radio-check amenitiesCheck"><input type="checkbox" checked="checked" />
                        	<span></span>Keep me signed in <img src="{{ URL::asset('public/front')}}/images/couple-sm.png" alt="" />
		...
		<div class="col-sm-12">
			...
			<button data-dismiss="modal" id="cancelbtn" class="btn btn-warning artist_btn reqst_btn">Submit</button>
			</div>
		</div>
  </div>
