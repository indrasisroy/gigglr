 ...
 -->
		...
		if($available_for == '3')
         ...
         else
         {
            ...
            <input type='text'  class="form-control" style="width:25% !important;margin-right: 5px !important;" placeholder="Hour" id="start_time_hr" name="start_time_hr" />


            <span id="start_time_hr_error" class="authError" style="display:none;">You have entered a previous hour or minute</span>

            <input type='text'  class="form-control" style="width:30% !important; margin-right: 5px !important;" placeholder="Minute" id="start_time_mnt" name="start_time_mnt" />
            <!-- <input type='text' class="" style="width:30%" placeholder="am pm" id="start_time_ampm" name="start_time" /> -->

            <select id="ddlViewBy"  class="form-control" style="width:40% !important; " name="ddlViewBy">
                        ...
                        <div class="form-group inpt input-customm input-customm-2">
                           <div class='input-group date' id='datetimepicker4'>
                              <!--<input type='text' class="form-control clck_outr timepicker" placeholder="4.20 pm"/>-->
                                ...
                                <input type='text' class="form-control" style="width: 45% !important;margin-right: 6px !important;" placeholder="Hour" id="end_time_hr" name="end_time_hr" />
                                <span id="end_time_hr_error" class="authError" style="display:none;">You have entered a previous hour or minute</span>
                                <input type='text' class="form-control" style="width: 51% !important;margin-right: 0px !important;margin-left: 2px;" placeholder="Minute" id="end_time_mnt" name="end_time_mnt" />
                                <!-- <input type='text' class="" style="width:30%" placeholder="am pm" id="start_time_ampm" name="start_time" /> -->

                                <!-- <select id="ddlViewend" class="form-control" style="width:40% !important; " name="ddlViewend">
                                <option value="1">AM</option>
                                <option value="2">PM</option>
                                </select>
 -->
                        ...
                        <div class="form-group inpt input-customm input-customm-color">
                           <div class='input-group date' id='datetimepicker5'>
                              <?php    
                                ...
                                <input type='text' class="form-control" style="width:25% !important; margin-right: 5px !important;" placeholder="Hour" id="requexpire_time_hr" name="requexpire_time_hr" />
                    <span id="requexpire_time_hr_error" class="authError" style="display:none;">You have entered a wrong hour or minute</span>
                                 

                                <input type='text' class="form-control" style="width:30% !important;margin-right: 5px !important;" placeholder="Minute" id="reqexpire_time_mnt" name="reqexpire_time_mnt" />
                                <!-- <input type='text' class="" style="width:30%" placeholder="am pm" id="start_time_ampm" name="start_time" /> -->
                                 

                                <select id="ddlViewrequestexpire" class="form-control" style="width:40% !important; " name="ddlViewrequestexpire">
                                <option value="1">AM</option>
                                <option value="2">PM</option>
                                </select>
