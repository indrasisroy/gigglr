 		...
 		<div class="inline artist_list">
                  ...
                  <div class="col-md-12">
                     <div class="inline artist_list" id="tech_speech_div">
					  ...
					  echo Form::textarea("gig_description", $value=stripslashes($tech_spec_venue), [ "id"=>"gig_description","disabled", "placeholder"=>"Gig Description","maxlength"=>"500","class"=>"form-group inpt nb form-control" ]);
