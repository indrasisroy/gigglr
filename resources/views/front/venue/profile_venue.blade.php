...
//********* social networking check ends here
	...
	$venue_descp = html_entity_decode($fetchuserdata->venue_description);
 ...
 $puntualityardata_artist=0;
  ...
  $presentationardata_artist=0;
   ...
   //***************** fetching data for tooltip mesages starts here
                ...
                $inar=array('Security-deposit','Total-payment','Cancellation-fee','Duration','Request-expire-datetime','start-time','Is this a private event','Tech Spec');
                ...
                if(!empty($frontwelcomedata_tooltip))
                {
                  ...
                  $privateorpubliccheck=stripslashes($frontwelcomedata_tooltip[6]->tooltip_message);
                   ...
                   $techspecheading = stripslashes($frontwelcomedata_tooltip[7]->tooltip_message);
                }
...
$imgurldata = BASEURLPUBLICCUSTOM."front/otherfiles/progimages/"."noimagefound537X507.png";
               // $fetchimgDat2a = array();
$user_description=$venue_descp;
$first_name=$venue_name;
 //*** for facbook starts *****                 
                $og_imgurl='';
                if(!empty($fetchimgData))
                {
                     $og_imgurl = BASEURLPUBLICCUSTOM.'upload/venueimage/thumb-big/'.$fetchimgData[0]->image_name;
                }

$og_description='';
$og_description=($user_description == 'Content Not Available')?'':$user_description;
$og_description=filter_var($og_description, FILTER_SANITIZE_STRING);

$fcbkogdata=array(); $currnt_url_data=url()->current();
$fcbkogdata['og_url']=$currnt_url_data;
$fcbkogdata['og_title']=stripslashes($first_name);
$fcbkogdata['og_description']=$og_description;
$fcbkogdata['og_image']= $og_imgurl;

//*** for facbook ends *****  



//************   for google api starts here *************
	$settingsgoogleapival='';
	if($settingsgoogleapi!="")
	{
		$settingsgoogleapival = $settingsgoogleapi;
	}
		

//************   for google api ends here ***************

?>

@extends('layouts.front.frontendmaster',['successmsg' => $successmsg,'errormsg'=>$errormsg,'metadescriptiondata'=>$metadescriptiondata,'fcbkogdata'=>$fcbkogdata])
@section('content')
			...
			<div class="row dj_row">
				<div class="col-sm-5">
					<div class="profile_slider myvenuesliderouterdv">
                     ...
                     //************* manipulate profile slider code  starts ************** 
                    $imgurldata = BASEURLPUBLICCUSTOM."front/otherfiles/progimages/"."noimagefoundsearch537X507.png";
                        

                    $profslider_new_div=""; $tot_prof_img=0;

                    if(!empty($fetchimgData))
                    {
                        
                        
                        foreach($fetchimgData as $fetchimgDataobj)
                        {
                           
                            
                            $tot_prof_img=$tot_prof_img+1;

                           $imgurl = BASEURLPUBLICCUSTOM.'upload/venueimage/thumb-big/'.$fetchimgDataobj->image_name;
                            $profslider_new_div.="<div class='item' style='background-image: url(".$imgurl.");'></div>";  
                    ...
                    else
                    {
                        ...
                        $profslider_new_div="<div class='item' style='background-image: url(".$imgurldata.");'></div>";  

                    }
                    //************* manipulate profile slider code  ends ************** 
				...
				<div class="col-sm-7">
					<h2 class="prifile_heading text-right">{{stripslashes($venue_name)}}</h2>
                    ...
                    <!-- for facebook like share structure starts-->
             <div class="fb-share-button mycustfcbklikeclass" data-href="<?php echo $currnt_url_data; ?>" data-layout="button" data-size="small" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse">Share</a></div>
           
             <!-- for facebook like share structure ends-->
					...
					<div class="like_box">
                      ...
                      <?php  
                        if($sessn_ID == $venue_creatr_id)
								{ ?>
						<a href="javascript:void(0)" class="like_link red-tooltip goTo myfavorite deactive <?php echo $myfavoriteClass;?>" data-usertype="3" data-userId="<?php echo $fetchuserdata->id?>" data-go-to="Favorite_section"  data-toggle="tooltip" title="Favourite"><img src="{{ FRONTCSSPATH}}/images/heart_icon.png" alt="" /></a>
                            <?php
                            }else
                            {
                            ?>
                            	<a href="javascript:void(0)" class="like_link red-tooltip goTo myfavorite <?php echo $myfavoriteClass;?>" data-usertype="3" data-userId="<?php echo $fetchuserdata->id?>" data-go-to="Favorite_section"  data-toggle="tooltip" title="Favourite"><img src="{{ FRONTCSSPATH}}/images/heart_icon.png" alt="" /></a>
                         <?php   }
                            ?>
            ...
            <div class="row">
             <div class="col-md-5">
                <!-- <h3 class="prf_venue">Teddington, Middlesex</h3> -->
                 <div class="pf-venue">
                <p class="prf_venue_lst"> <?php echo $venue_descp; ?> </p>
                     </div>
             </div>
	...
	<div class="container">
			<div class="month-chart clearfix">
                ...
                <ul class="week_cell clearfix">
                    <li>
                                 <a href="javascript:void(0)"  id="monthlink" >MONTH</a>
                    </li>
                    <li>
                                 <a href="javascript:void(0)" id="weeklink">WEEK</a>
                    </li>
                    <li>
                                 <a href="javascript:void(0)" class="activepanecolorforrosterleftclass" id="daylink">DAY</a>
                    </li>
                </ul>
				</div>
              ...
              ?>
                    ...
                    <div class="inline artist_list">
                        ...
                        <div class="form-group inpt input-customm">
                           <div class='input-group date'>
                              <input id="booking_date" class="form-control datetimepicker" name="booking_date" type="text" value="" tabindex="1"><span class="input-group-addon dt">
               ...
               <!--  </div>
                    ...
                    <div class="timer_absolute">
                     <div class="inline artist_list">
                        ...
                        <div class="form-group inpt input-customm clearfix newTimeWrap">
                           <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr " placeholder="hh" id="start_time_hr" name="start_time_hr" tabindex="2"/>
                           </div>
                           <div class="timeField">
                           <input type='text' maxlength="2" class="form-control date_outr " placeholder="mm" id="start_time_mnt" name="start_time_mnt" tabindex="3"/></div>
                           <div class="ampm">
                            <select class="selectpicker artist_txt" id="ddlViewBy" name="ddlViewBy" tabindex="4">
                     ...
                     <div class="inline artist_list">
                        ...
                        <span>Duration</span> 
                          <div class="form-group inpt input-customm clearfix newTimeWrap ">
                            <div class="timeField"> 
                              <input type='text' class="form-control date_outr" maxlength="2"  placeholder="hh" id="end_time_hr" name="end_time_hr" tabindex="5" />
                            </div>
                            <div class="timeField hasInfo">
                             <input type='text' class="form-control date_outr" maxlength="2" placeholder="mm" id="end_time_mnt" name="end_time_mnt" tabindex="6" />
                        ...
                        <?php
                          ...
                          {
                               ?>
                          <a href="javascript:void(0)" type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title=" <?php echo stripslashes($duration_heading); ?> "><i class="fa fa-question-circle" aria-hidden="true"></i>
                                </a>
                                  <?php
                  ...
                  <div class="col-md-12">
                     ...
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="continuetosix" type="button" data-toggle="modal" tabindex="7">Next Page > </button>
                    </div>
                  </div>
               </div>
               <!--</form>-->
        ...
        <div class="artist_form_outr clearfix">
           ...
           <!--  <form method="POST" action="http://52.10.11.14/betaprosessional" accept-charset="UTF-8" id="bookingform2" class="" autocomplete="off"> -->
              ...
              ?>
                ...
                <input id="booking_location" class="form-control form-control-B" placeholder="Address1" name="booking_location" type="text" tabindex="8" value="<?php echo $venueaddress1; ?>" disabled>         <!--<input type="text" class="form-control form-control-B" placeholder="Address2"/>-->
                <input id="booking_location_second" tabindex="9" class="form-control form-control-B" placeholder="Address2" name="booking_location_second" type="text" value="<?php echo $venueaddress2; ?>" disabled>                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            //    echo Form::select('country', $fetchcountryArData, $country,$control_attrAr);          
               ...
               ?>
                    ...
                    <div class="col-md-6">
                        <div class="artist_divsn">
                          <div class="inline artist_list request_list">
                                <input id="town" class="form-control form-control-B" tabindex="12" placeholder="City" name="town" type="text" value="<?php echo $venuecity;?>" disabled>
                            </div>
                        </div>
                  </div>
                    <div class="col-md-6">
                        <div class="artist_divsn">
                          <div class="inline artist_list request_list">
                               <input id="zip" class="form-control form-control-B" tabindex="13" placeholder="Post Code" name="zip" type="text" value="<?php echo $venuezip;?>" disabled>
                            </div>
                        </div>
                  </div>
                    <div class="col-sm-12">
                       ...
                       <?php if($available_for == '3') {?>
                            ...
                            <label class="radio-check radio_check_show_input">

                            <!-- <input type="radio" name="gender" value="za"> -->
                             <?php 
                              echo Form::radio('radio_entry_type', '2', false,$attributes = array("id"=>"radio1","tabindex"=>"14"));
                              ?>
                            ...
                            <!-- <input type="radio" name="gender" value="za"> -->
                              <?php 
                        echo Form::radio('radio_entry_type', '1', true,$attributes = array("id"=>"radio2","tabindex"=>"14"));
                        ?>
                              ...
                              {
                               ?>
                               <a href="javascript:void(0)" type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title=" <?php echo stripslashes($privateorpubliccheck) ?>"><i class="fa fa-question-circle" aria-hidden="true"></i>
                                </a>
                                <?php 
                    ...
                    <div class="btn_Adj">
                     ...
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="revertbacktofive" type="button" data-toggle="modal" tabindex="16"> &#60; Previous Page </button>
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="continuetoseven" type="button" data-toggle="modal" tabindex="17">Next Page > </button>
                    </div>
                   </div> 
                </div>
           <!--  </form> -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="inline artist_list" id="tech_speech_div">
                        ...
                        <!--</div>-->
                          <span>Enter details or specifics here :
                          ...
                          <a href="javascript:void(0)" class="techspecclass" aria-label="Help" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title=" <?php echo stripslashes($techspecheading) ?> ">example
                                </a>
                          ...
                          <textarea id="gig_description" tabindex="20" placeholder="Please assist artist(s) by describing any event specifics such as:
parking areas, access times or areas, set up times, back stage areas, stage size, on-site contact person details. Lift access or any other technical requirements or concerns in this area here.

Also specify any additional requests here to be included in this event" maxlength="1000" class="form-group inpt nb form-control" name="gig_description" cols="50" rows="10">{{$tech_speech}}</textarea>                        <!--                       <p> 5 lines, 50 characters maximum per line</p>-->
                    </div>
              <input type="hidden" id="fieldtocountbookingartist" value="1000">
               <p  id="CharCountLabelartistbooking" ></p>
                    ...
                    <div class="col-sm-12">
                    <div class="btn_Adj">
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="revertbacktosix" type="button" data-toggle="modal" tabindex="21" > &#60; Previous Page </button>
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="continuetoeight" type="button" data-toggle="modal" tabindex="22" >Last Page > </button>
                    </div>
                   </div> 
                </div>
            <!-- </form> -->
            ...
            <?php
              ...
              ?>
                ...
                <div id="bookingcanimg_div" data-bookingcanimgflag="0"></div>
                    ...
                    <div class="timer_absolute timer_absoluteB timer_absoluteBA">
                      <div class="inline artist_list ">
                        ...
                        <div class="form-group inpt input-customm input-customm-color hasInfo mydisplaynone">
                           ...
                           {
                           ?>
                            <a href="javascript:void(0)" type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title=" <?php echo stripslashes($reqespiredatetime_heading); ?> "><i class="fa fa-question-circle" aria-hidden="true"></i>
                                </a>
                                <?php 
                        ...
                        <div class="form-group inpt input-customm input-customm-color hasInfo artist_listB">
                            <div class="timeField">
                              <input type='text' maxlength="2" tabindex="26" class="form-control date_outr clck_outr fadeY" placeholder="DD" id="requexpire_day" name="requexpire_day" />
                              </div>
                              <div class="timeField">
                              <input type='text' maxlength="2" tabindex="27" class="form-control date_outr clck_outr fadeY" placeholder="HH" id="reqexpire_hour" name="reqexpire_hour" /></div>
                            <div class="timeField">
                              <input type='text' maxlength="2" tabindex="28" class="form-control date_outr clck_outr fadeY" placeholder="MM" id="reqexpire_minute" name="reqexpire_minute" /></div>
                      ...
                      <div class="inline artist_list">
                        ...
                        <div class="radio_Check radio_CheckC">
                            <span>Do you agree with site <a href="<?php echo url('terms-and-conditions');?>" target="_blank">Terms & Conditions </a></span>

                             <div class="adj-baje">
                            <label class="radio-check radio_check_show_input"><input type="radio" tabindex="29" name="i_agree" value="za" id="readiodefaultcheckerror">
                              <span></span>Yes</label>
                            <label class="radio-check radio_check_show_input"><input type="radio" tabindex="29" name="i_agree" value="zb" checked="checked">
                              <span></span>No</label>
                              </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                    <div class="btn_Adj">
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg" id="revertbacktoseven" type="button" data-toggle="modal" tabindex="30" > &#60; Previous Page </button>
                     <button class="btn btn-warning artist_btn rqst_trm_btn agretoterm buttonpercentg send_Booking" id="continue_tosubmit" type="button" data-toggle="modal" tabindex="31">Send Request</button>
                    ...
                    <div class="paymnt_procc_clsreng mydisplaynone ccp_process_cls" id="processcls_negoall" style="left: 350px !important;">
                                            Processing ...
                    </div>
...
<script>
     ...
     var image_prof_struct="<?php echo  $profslider_new_div; ?>";
     var tot_prof_pic="<?php echo $tot_prof_img;  ?>";
    
	var flgBkGrp = "<?php echo $flagBkGrp;?>";
   	$(document).ready(function()
   	{
	
         //********** After 5 microseconds page gets loaded image slider  starts ************************
            setTimeout(function(){
                
                $(".myvenuesliderouterdv").html(image_prof_struct);
                
              
                 //get carousel instance data and store it in variable owl
                var owl = $(".myvenuesliderouterdv").data('owlCarousel');     
                ...
                $('.myvenuesliderouterdv').owlCarousel(newOptions);              
             ...
             //****** for binding with  user image slider on change of slider starts 
                    ...
                    var totalItems = parseInt(tot_prof_pic);// $('.item').length;
          ...
          //********** After 5 microseconds page gets loaded image slider  ends ************************
          //********** First time after page gets loaded image slider  starts ************************
            ...
            var totalItems = parseInt(tot_prof_pic);//$(".profilesliderouterdv").find(".item").length;
            ...
            //console.log( "=tot_prof_pic=>"+parseInt(tot_prof_pic));
           ...
           //********** First time after page gets loaded image slider  ends ************************
        
        	//***************  venue category preload starts here 10-03-2017 ************

        	$("#bookingcat_subvenue").change();


        	//***************  venue category preload ends here 10-03-2017**************
...
//console.log("hidnlt"+hidnlt);
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo $settingsgoogleapival;?>"></script>
