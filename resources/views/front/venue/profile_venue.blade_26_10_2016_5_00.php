...
?>
						...
						<div class="col-sm-6 visitor_cols">
							...
							{ ?>
								...
								<a href="javascript:void(0)" class="book_btn bk_venue openbkgrpcls deactive" onclick="checkvenuebookingavailability(1);">book venue</a>
							<?php 
						    }
						    ...
						    else
							{
								...
								{ ?>
									<a href="javascript:void(0)" class="book_btn bk_venue openbkgrpcls" onclick="checkvenuebookingavailability(2);">book venue</a>
							<?php	}
								else
								{
									if($venue_status == 1){
