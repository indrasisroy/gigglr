		...
		<div class="container">
			<div class="row dj_row">
				<div class="col-sm-5">
					...
					<?php
					$imgurldata1 =	asset("front/images/profile_venue.jpg");
					  $imgurldata2 = asset("front/images/slider_img.png");
						
					?>
					 
						<div class="item" style="background-image: url({{ $imgurldata1}});"> </div>
						<div class="item" style="background-image: url({{ $imgurldata2}});"> </div>
					</div>
				</div>
				<div class="col-sm-7">
					<h2 class="prifile_heading">The Lensbury</h2>
					<div class="like_box">
            ...
            <div class="row">
             <div class="col-md-5">
                <h3 class="prf_venue">Teddington, Middlesex</h3>
                 <div class="pf-venue">
                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, veritatis et quasi architecto beatae vitae.Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae.</p>
                 <p>iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae. totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae.</p>
                 <p>iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae.</p>
                 <p>beatae vitae.Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae.
                 iste natus error sit voluptatem accusantium doloremque laudantium, eaque ipsa quae ab illo inventore .</p>
                     </div>
             </div>
...
<!--					<div class="event_number">16</div>-->
					<img src="{{ URL::asset('public/front')}}/images/venue_slid1.png" alt="" />
<!--					<div class="event_name" style="background: rgba(255, 99, 92, 1);" >Andy Hart</div>-->
				</a>
                </div>
                <div class="item pf_venue">
				<a class="pf_venu_sldr" href="#">
<!--					<div class="event_number">10</div>-->
					<img src="{{ URL::asset('public/front')}}/images/venue_slid2.png" alt="" />
<!--					<div class="event_name" style="background: rgba(43, 182, 163, 1);">pritty</div>-->
				</a>
                </div>
                <div class="item pf_venue">
				<a class="pf_venu_sldr" href="#">
<!--					<div class="event_number">20</div>-->
					<img src="{{ URL::asset('public/front')}}/images/venue_slid3.png" alt="" />
<!--					<div class="event_name" style="background: rgba(183, 58, 251, 1);">Andy Hart</div>-->
				</a>
                </div>
                <div class="item pf_venue">
				<a class="pf_venu_sldr" href="#">
<!--					<div class="event_number">22</div>-->
					<img src="{{ URL::asset('public/front')}}/images/venue_slid4.png" alt="" />
<!--					<div class="event_name" style="background: rgba(43, 182, 163, 1);">Andy Hart</div>-->
				</a>
                </div>
                <div class="item pf_venue">
				<a class="pf_venu_sldr" href="#">
<!--					<div class="event_number">25</div>-->
					<img src="{{ URL::asset('public/front')}}/images/venue_slid5.png" alt="" />
<!--					<div class="event_name" style="background: rgba(250, 54, 55, 1);">pritty</div>-->
				</a>
                </div>
                <div class="item pf_venue">
				<a class="pf_venu_sldr" href="#">
<!--					<div class="event_number">23</div>-->
					<img src="{{ URL::asset('public/front')}}/images/venue_slid6.png" alt="" />
<!--					<div class="event_name" style="background: rgba(183, 58, 251, 1);">Andy Hart</div>-->
				</a>
                </div>
                <div class="item pf_venue">
...
<!--					<div class="event_name" style="background: rgba(251, 170, 55, 1);">Andy Hart</div>-->
            ...
            <p class="prf_venue_lst">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim quam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, quam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam,ncidunt ut Nemo enim quam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa.</p>
<!--
			<div class="dj_row">
                <h2 class="edt_img edt_txt ">edit description </h2>
                <a href="javascript:void(0);" class="editBtn"></a>
				<p>
					Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consec.
				</p>
				<p>
