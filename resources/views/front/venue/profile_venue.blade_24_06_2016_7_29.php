...
<!--book artist modal ends here-->
   ...
   <script>
    ...
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDMtfReOBcDyXEUBByLlLgjOkwMKKJw86M&callback=initMap">
	  ...
	  <script>
 //var image = base_url_data+'/otherfiles/progjs/fb_icon.png';
     ...
     //   var image = base_url_data+'http://i.stack.imgur.com/cdiAE.png';
  ...
  <!--<script async defer  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDMtfReOBcDyXEUBByLlLgjOkwMKKJw86M&callback=initMap">    </script>-->
