					...
					<div class="row row_visitor">
						...
						<div class="col-sm-6 visitor_cols">
							...
							{ ?>
								...
								<a href="javascript:void(0)" class="book_btn bk_venue openbkgrpcls" onclick="checkvenuebookingavailability(1);">book venue</a>
							<?php 
						    }
						    else if($hourlyrateflag == '0.00')
						    {?>
						    	<a href="javascript:void(0)" class="book_btn bk_venue openbkgrpcls" onclick="no_hourlyrate()">book venue</a>
						   <?php 
						    }
						    else
							{
