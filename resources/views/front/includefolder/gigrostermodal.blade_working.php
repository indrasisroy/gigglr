                    ...
                    <div class="timer_absolute timer_absoluteB" style="opacity:0;">
                      <div class="inline artist_list">
                       ...
                       <div class="radio_Check radio_CheckC">
                        <span>Do you agree with the<br><a href="<?php echo url('terms-and-conditions');?>">Terms &amp; Conditions </a></span>
                       <div class="adj-baje">
...
}else
{
 console.log("Gig bid table value "+gig_bidrequest_id);  
      ...
      var negotiation_id = "<?php echo '0' ;?>";   //"<?php // echo $negotiation_id;?>";
