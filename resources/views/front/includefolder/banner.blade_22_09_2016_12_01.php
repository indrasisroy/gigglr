				...
				?>
					...
					<div class="midle mydisplaynone" id="bannermddleid">
						<form action="search-result.html" method="post">
					        ...
					        <?php    
							echo Form::text("bookdate", $value='', $attributes = array( "id"=>"bookdate","class"=>" form-control clck_outr datetimepicker  ","placeholder"=>""));
							?> 
							...
							<?php    
							echo Form::text("booktime", $value='', $attributes = array( "id"=>"booktime","class"=>" form-control clck_outr timepicker  ","placeholder"=>""));
							?>
