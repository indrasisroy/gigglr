	...
	if(!empty($front_id_sess))
	{
		...
		if(!empty($fetchheaderurldata))
		{
		 ...
		 //**** fetch  user deafult image starts
				...
				$image_with_pth=BASEURLPUBLICCUSTOM."front/otherfiles/progimages/"."noimagefound52X52.png";
       ...
       //**** fetch  user_master starts
				...
				if(!empty($fetchusernickname))
				{
                    ...
                    if (fmod($wallet_amount, 1) == 0) 
                        {
                             //echo "no decimal";
                            $wallet_amount=intval($wallet_amount);
	        ...
	        <div class="navbar-header pull-right">
	          ...
	          <div class="headerBtn <?php echo $headBtnCls;?>">
				...
				<?php if(empty($front_id_sess)) { ?>
	          	<button class="btn" data-toggle="modal" onclick="openloginmodal()"><img src="{{ URL::asset('public/front')}}/images/login.png" alt="" /> Log In</button>
	          	<button class="btn btnSign" data-toggle="modal" onclick="opensignupmodal()">Sign Up</button>
...
<!--						<li><a href="<?php // echo url('showdisputerecords'); ?>" id="">Resolve Dispute</a></li>-->
	          			<li><a id="walletlinkancid" href="javascript:void(0);"  >Wallet</a></li>
	          			<li><a id="ccid1" href="javascript:void(0);">Log out</a></li>
	          		</ul>
	          	</div>
	        ...
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav menu_cstm">
				...
				<?php
                            ...
                            if(!empty($ProfileName))
                            {
                                ...
                                if(!empty($seonamedata))
                                {
                                    ...
                                    $plink = url('a')."/".$ProfileName[0]->seo_name;
                                }
				...
				?>
                <li class="dropdown <?php echo $myaccount_dact_cls.$plinkClass;?>"><a class="dropdown-toggle" id="profileseo" href="<?php echo $plink;?>">My Profile</a>
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo url('editprofile'); ?>">Edit Profile</a></li>
                           ...
                           <!-- Checking user have group start-->
                            ...
                            if(!empty($GroupName)){
                            ?>
                            <li><a id="groupprofileseo" href="<?php echo url('editgroup')."/".$GroupName[0]->seo_name; ?>">Edit Group</a></li>
                            <?php
                            }else{
                           ?>
                           <li><a href="<?php echo url('editgroup'); ?>">Create Group</a></li>
                           <?php
                            }
                            ?>
                        ...
                        ?>
                           <li><a href="<?php echo url('venue-edit')."/".$VenueName[0]->seo_name; ?>" id="venueprofileseo">Edit Venue</a></li>
                            <?php
				...
				?>
				 ...
				 <a class="dropdown-toggle" href="<?php echo url("gigguide"); ?>">Gig Guide</a>
					...
					?>
                    <ul class="dropdown-menu">
                         <!-- just comment when post a gig is required ---->
                        <li><a href="javascript:void(0);" id="myModalPostAGigTTTT">Post a Gig</a></li>
                        <!-- just uncomment when post a gig is required ---->
...
<!--                        <li><a href="javascript:void(0);" id="myModalPostAGig">Post a Gig</a></li>--> 
   ...
   <script type="text/javascript" src="{{ FRONTCSSPATH}}/otherfiles/progjs/frontendGid.js"></script>
	<script type="text/javascript" src="{{ FRONTCSSPATH}}/otherfiles/progjs/frontenddisputeform.js"></script>
	<!--<script type="text/javascript" src="{{ FRONTCSSPATH}}/otherfiles/progjs/frontendmyaccount.js"></script>-->

	<script>
		function openloginmodal()
		{
			bookingmodalcheckoption="calling from login";
			$("#myModal1").modal('show');
		}
		function opensignupmodal()
		{
			bookingmodalcheckoption="calling from signup";
			$("#myModal").modal('show');
		}
