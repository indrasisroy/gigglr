                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-offset-6 col-md-6">
						...
						<div class="col-md-12">
							<?php
							if($gig_bidrequest_details_id=="") {
							echo Form::textarea("gig_description", $value=$gig_description_gig, [ "id"=>"gig_description", "placeholder"=>"Gig Description","class"=>"form-group inpt nb form-control bappa" ]);
							}
                              
                            else{
							echo Form::textarea("gig_description", $value=$gig_description, ["readonly","id"=>"gig_description", "placeholder"=>"Gig Description","class"=>"form-group inpt nb form-control surojit" ]);
							}
							?>
						</div>
						<?php
                        ...
                        ?>
							...
							<?php
							if($gig_bidrequest_details_id=="") {
							echo Form::textarea("gig_description", $value=$gig_description_gig, [ "readonly","id"=>"gig_description", "placeholder"=>"Gig Description","class"=>"form-group inpt nb form-control bappa" ]);
							}
                            ?>
                             </div>
                            <?php
