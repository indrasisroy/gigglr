...
<?php
						...
						$fieldnames=" facebook_url,twitter_url,google_url,instagram_url,youtube_url,footer_logo_image,site_name,company_name,copyright_year";
						$wherear=array();
						$wherear['id']=1;
		...
		<div class="container">
			<div class="row">
				...
				<?php
						...
						$footerfburl=''; $footertwiturl=''; $footergoogleurl=''; $footerinstaurl=''; $footeryoutubeurl=''; $site_name=''; $copyright_year=''; $company_name='';
						...
						if(!empty($fetchfooterurldata))
						{
							 ...
							 $site_name=stripslashes($fetchfooterurldata->site_name);
                             $company_name=stripslashes($fetchfooterurldata->company_name);
				...
				?>
					...
					<div class="copy">Copyright &copy; {{$copyright_year}} {{$company_name}}</div>
				</div>
                ...
                <div class="subscribe">
					<h4>subscribe</h4>
						...
						<div class="subscribeInput"><?php echo Form::text("subscriberemail", $value='', $attributes = array("id"=>"subscriberemail", "class"=>"form-control", "placeholder"=>"your email address")); ?></div>
