                        ...
                        <div class="form-group inpt input-customm">
                           ...
                           <span class="dollar">$</span>
							  ...
							  if($gig_bidrequest_details_id!=""){
                                 ...
                                 "class"=>"form-control clck_outr lck_outr securityimg surojit",
                                 "placeholder"=>"0.00",
                                 "maxlength"=>"16",
                             ...
                             echo Form::text("security_payment_gig",
                                 ...
                                 "class"=>"form-control clck_outr lck_outr securityimg surojit1",
                                 "placeholder"=>"0.00",
                                 "maxlength"=>"16",
                                 ...
                                 $value=$artist_security_deposit_gig,
                                 $attributes = array( "id"=>"security_payment_gig",
                                 "class"=>"form-control clck_outr lck_outr securityimg dhiman",
                                 "placeholder"=>"0.00",
                                 "maxlength"=>"16",
