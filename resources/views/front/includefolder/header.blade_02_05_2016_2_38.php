	...
	<div class="navbar navbar-inverse <?php echo $beforelogincls; ?>" role="navigation">
		...
		<?php if(!empty($front_id_sess)) { ?>
			<a href="index.html" class="navbar-brand"><img src="{{ URL::asset('public/front')}}/images/fav-icon-logo.png" alt="" /></a>
		<?php } ?>		
	          ...
	          <div class="headerBtn">
				...
				<div class="prodile_img"><img src="{{ URL::asset('public/front')}}/images/profile_img.jpg" alt="" /></div>
	          	<div class="profile_name dropdown">	          		
	          		 <a data-toggle="dropdown" class="dropdown-toggle" href="#"><span>Hi , Alex Brown <br /> You have $ 130</span> <span class="drop_icon"><img src="images/arrow_select.png" alt="" /></span></a>
