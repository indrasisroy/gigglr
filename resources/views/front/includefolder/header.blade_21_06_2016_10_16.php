                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo url('editprofile'); ?>">Edit Profile</a></li>
                           ...
                           <!-- Checking user have group start-->
                            ...
                            $sqlGroupName="SELECT `group_name`,`nickname` FROM `group_master` WHERE `creater_id`='".$front_id_sess."'";
                            $GroupName= DB::select( DB::raw($sqlGroupName));
                            if(!empty($GroupName)){
                            //print_r($GroupName);
                            ?>
                            <li><a href="<?php echo url('group')."/".$GroupName[0]->nickname; ?>">Edit Group</a></li>
                            <?php
                            }else{
                           ?>
                        ...
                        <li><a href="<?php echo url('venue-edit'); ?>">My Venue</a></li>
                    </ul>
                 </li>
