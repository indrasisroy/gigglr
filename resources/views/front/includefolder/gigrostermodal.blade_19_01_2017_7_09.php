  ...
  <div class="modal-dialog popup-dialog" role="document">
    <div class="modal-content popup-content artist_popup">
      <div class="modal-body popup-body">
        ...
        <input type="checkbox" name="tag_1" id="tag_1" value="1"  <?php echo (($event_type < 2 )? 'checked' : ''); ?> disabled="disabled"> <span>Yes </span>
        <input type="checkbox" name="tag_1" id="tag_2" value="2"  <?php echo (($event_type > 1 )? 'checked' : ''); ?> disabled="disabled"><span> No </span>
              ...
              <div class="row">
                  <div class="col-md-12">
                    <div class="artist_divsn reqst_dvsn">
                        ...
                        <div class="reqField"><a href="javascript:void(0);" id="clickme" class="tBtn form-control">Location Details.</a></div>
                    </div>
                  </div>
                  <div class="new-location clearfix clickmeShow" id="opnaddresssection_gig" style="display:none">
                      <div class="col-md-12">
                        <div class="artist_divsn reqst_dvsn">
					 ...
					 <div class="inline artist_list">
                        ...
                        <div class="form-group inpt input-customm">
                           <div class='input-group date' id='datetimepicker3'>
                              ...
                              <?php
							  echo Form::text("event_start_time", $value=date('h.i A', strtotime($event_start_time)), $attributes = array( "readonly","id"=>"event_start_time","class"=>"form-control clck_outr disablecolorclass" ));
                     ...
                     <div class="inline artist_list">
                       ...
                       <!--  <div class="form-group inpt input-customm input-customm-2">
                           <div class='input-group date' id='datetimepicker4'>
                              ...
                              <?php
							  //echo Form::text("event_end_time", $value=date('h.i A', strtotime($event_end_time)), $attributes = array( "readonly","id"=>"event_end_time","class"=>"form-control clck_outr disablecolorclass" ));
                                 ?>
                              <span class="input-group-addon clck">
                              <span class="glyphicon glyphicon-time"></span>
                              </span>
                          ...
                          <div class="form-group inpt input-customm clearfix newTimeWrap">
                            <div class="timeField"> 
                            <!--   <input type='text' class="form-control date_outr disablecolorclass " maxlength="2"  placeholder="hh" id="end_time_hr" name="end_time_hr" maxlength="2"  placeholder="hh" id="end_time_hr" /> -->
                ...
                echo Form::text("end_time_hr", $value=$r1, $attributes = array( "readonly","id"=>"end_time_hr","class"=>"form-control date_outr disablecolorclass","maxlength"=>"2","placeholder"=>"hh"  ));
                            ...
                            <div class="timeField">
                            <!--  <input type='text' class="form-control date_outr disablecolorclass " maxlength="2" placeholder="mm" id="end_time_mnt" name="end_time_mnt" /> -->
                                  <?php
                     ...
                     <div class="inline artist_list">
                      <span>This Post Expires Date:</span>
                        ...
                        <div class="form-group inpt input-customm input-customm-color">
                           <div class='input-group date'>
                              <?php
							  echo Form::text("request_expire_date", $value=date('d M Y', strtotime($request_expire_date)), $attributes = array( "readonly","id"=>"request_expire_date","class"=>"form-control clck_outr disablecolorclass" )); 
                  ...
                  <div class="col-md-6">
                      ...
                      <div class="inline artist_list">
                        ...
                        <div class="form-group inpt input-customm input-customm-color">
                           <div class='input-group date' id='datetimepicker5'>
                              <?php
							  echo Form::text("request_expire_time", $value=date('h.i A', strtotime($request_expire_time)), $attributes = array( "readonly","id"=>"request_expire_time","class"=>"form-control clck_outr timepicker disablecolorclass" )); 
							  ?>
                              <span class="input-group-addon clck">
                              <span class="glyphicon glyphicon-time"></span>
                              </span>
                    ...
                    <div class="col-md-offset-6 col-md-6">
						...
						<div class="col-md-12">
                            ...
                            else if($gig_bidrequest_details_id!="")
                            {
                                if($gig_bid_status=='1')
                                {
                                    ...
                                    echo Form::textarea("gig_description", $value=$gig_description, ["readonly","id"=>"gig_description", "placeholder"=>"Gig Description","class"=>"form-group inpt nb form-control " ]);
                                }
							}
							?>
						</div>
                        ...
                        ?>
						     <div class="col-md-12">
							<?php
                                if(($gig_bidrequest_details_id=="") && ($gigpostrequestflag == 1) && ($front_sess == $booker_id_1))
                                {
                                    if($divshow =="gigmaster")
                                    {echo Form::textarea("gig_description", $value=$gig_description_gig, [ "readonly", "id"=>"gig_description", "placeholder"=>"Gig Description","class"=>"form-group inpt nb form-control" ]);}
                                }
                                else if($gig_bidrequest_details_id=="") {
                                  echo Form::textarea("gig_description", $value=$gig_description_gig, [ "id"=>"gig_description", "placeholder"=>"Gig Description","class"=>"form-group inpt nb form-control " ]);
                                }
                                ...
                                else if($front_sess == $first_accepted_by)
                                {
                                //echo $front_sess." ********* ".$first_accepted_by;
                                echo Form::textarea("gig_description", $value=$gig_description, [ "readonly", "id"=>"gig_description", "placeholder"=>"Gig Description","class"=>"form-group inpt nb form-control" ]);
                      ...
                      <div class="col-md-12">
                        ...
                        <?php
                            ...
                            ?>
                            <button class="btn btn-warning artist_btn reqst_btn_dvlr_negotiated negotiationbtn" type="button" id="negotiated_bid_reqst">negotiate</button>
                            <?php    
                                }
                                if($booker_id_1 == $front_sess){
                                ?>
                                    <button class="btn btn-warning artist_btn_acpt reqst_btn_dvlr_accept 1" type="button" id="accept_bid_reqst_booker">accept</button>
                                    <?php
                                }else
                                {
                                    if($type_flag == 1){
                                        if($first_accepted_by != $front_sess){
                                        ?>
                                        <button class="btn btn-warning artist_btn_acpt reqst_btn_dvlr_accept 2" type="button" id="accept_bid_reqst">accept </button>
                                        <?php
                                        }
                                    }else if($type_flag == 2){
                                        if($first_accepted_by != $bid_request_artist_id){
                                        ?>
                                        <button class="btn btn-warning artist_btn_acpt reqst_btn_dvlr_accept 2" type="button" id="accept_bid_reqst">accept </button>
                                        <?php
                                        }
                            ...
                            }else if($gig_bid_status==2)
                            {
                                ...
                                ?>
                            <button class="btn btn-warning artist_btn_can reqst_btn_dvlr_cancel" type="button" id="cancel_bid_reqst">cancel</button>
                            <button class="btn btn-warning artist_btn_acpt reqst_btn_dvlr_accept 3" type="button" id="accept_bid_reqst_booker">accept </button>
                                <?php
                                }else{
                                ?>
                            ...
                            <button class="btn btn-warning artist_btn reqst_btn_dvlr_negotiated negotiationbtn" type="button" id="negotiated_bid_reqst">negotiate</button>
                                ...
                                {
                                    ?>
                                    <button class="btn btn-warning artist_btn_acpt reqst_btn_dvlr_accept 4" type="button" id="accept_bid_reqst_booker">accept</button>
                                    <?php
                                }
                                else
                                {
                                    ?>
                                    <button class="btn btn-warning artist_btn_acpt reqst_btn_dvlr_accept 5" type="button" id="accept_bid_reqst">accept</button>
                                    <?php
                                }
                            }
                        ?>
