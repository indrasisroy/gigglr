...
<!--					<div class="inline artist_list">
            ...
            <input type='text'  class="form-control" style="width:25% !important;margin-right: 5px !important;" placeholder="Hour" id="start_time_hr_gig" name="start_time_hr_gig" />


            <span id="start_time_hr_gig_error" class="authError" style="display:none;">You have entered a previous hour or minute</span>

            <input type='text'  class="form-control" style="width:30% !important; margin-right: 5px !important;" placeholder="Minute" id="start_time_mnt_gig" name="start_time_mnt_gig" />
            <!-- <input type='text' class="" style="width:30%" placeholder="am pm" id="start_time_ampm" name="start_time" /> -->

            <select id="ddlViewBy_gig"  class="form-control" style="width:40% !important; " name="ddlViewBy_gig">
                           ...
                           <div class='input-group date' id='datetimepicker4'>
                              <!--<input type='text' class="form-control clck_outr timepicker" placeholder="4.20 pm"/>-->
                               ...
                               <div>
                                ...
                                <input type='text' class="form-control" style="width:25% !important; margin-right: 5px !important;" placeholder="Hour" id="end_time_hr_gig" name="end_time_hr_gig" />
                                <span id="end_time_hr_gig_error" class="authError" style="display:none;">You have entered a previous hour or minute</span>
                                <input type='text' class="form-control" style="width:30% !important; margin-right: 5px !important;" placeholder="Minute" id="end_time_mnt_gig" name="end_time_mnt_gig" />
                                <!-- <input type='text' class="" style="width:30%" placeholder="am pm" id="start_time_ampm" name="start_time" /> -->

                                <select id="ddlViewend_gig" class="form-control" style="width:40% !important; " name="ddlViewend_gig">
                                <option value="1">AM</option>
                                <option value="2">PM</option>
                                </select>
                        ...
                        <div class="form-group inpt input-customm input-customm-color">
                           <div class='input-group date' id='datetimepicker5'>
                               ...
                               <div >
                                ...
                                <input type='text' class="form-control" style="width:25% !important; margin-right: 5px !important;" placeholder="Hour" id="requexpire_time_hr_gig" name="requexpire_time_hr_gig" />
                    <span id="requexpire_time_hr_gig_error" class="authError" style="display:none;">You have entered a wrong hour or minute</span>
                                 

                                <input type='text' class="form-control" style="width:30% !important;margin-right: 5px !important;" placeholder="Minute" id="reqexpire_time_mnt_gig" name="reqexpire_time_mnt_gig" />
                                <!-- <input type='text' class="" style="width:30%" placeholder="am pm" id="start_time_ampm" name="start_time" /> -->
                                 

                                <select id="ddlViewrequestexpire_gig" class="form-control" style="width:40% !important; " name="ddlViewrequestexpire_gig">
                                <option value="1">AM</option>
                                <option value="2">PM</option>
                                </select>
