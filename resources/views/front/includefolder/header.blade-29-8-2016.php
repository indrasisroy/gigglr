	...
	if(empty($front_id_sess))
	{
       ...
       //**** fetch  user_master starts
                ...
                $fieldnames="nickname,wallet_amount";
                $wherear=array();
                $wherear['id']=$user_id;
				//$wherear['default_status']=1;
	          ...
	          <div class="headerBtn">
				...
				<div class="prodile_img" id="myprodileimgicon"><img src="<?php echo $image_with_pth; ?>" alt="" /></div>
	          	<div class="profile_name dropdown">	          		
                     ...
                     <span><br /> <span id="wallet_amount_id"> You have $<?php echo $wallet_amount; ?></span> <span class="drop_icon"><img src="{{ URL::asset('public/front')}}/images/arrow_select.png" alt="" /></span></a>
