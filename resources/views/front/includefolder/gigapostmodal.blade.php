...
<!--					<div class="inline artist_list">
                    ...
                    <div class="inline artist_list">
                        ...
                        <div class="form-group inpt input-customm clearfix newTimeWrap">
                           <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr" placeholder="hh" id="start_time_hr_gig" name="start_time_hr_gig" />
                           </div>
                           <div class="timeField">
                           <input type='text' maxlength="2" class="form-control date_outr" placeholder="mm" id="start_time_mnt_gig" name="start_time_mnt_gig" /></div>
                           <div class="ampm bbbbb">
                            <select class="selectpicker artist_txt" id="ddlViewBy_gig" name="ddlViewBy_gig">
                    ...
                    <!--  <div class="inline artist_list">
                      ...
                      <div class="inline artist_list">
                        <span>Duration:</span>
                          <div class="form-group inpt input-customm clearfix newTimeWrap">
                            <div class="timeField"> 
                              <input type='text' class="form-control date_outr" maxlength="2"  placeholder="hh" id="end_time_hr_gig" name="end_time_hr_gig" />
                            </div>
                            <div class="timeField">
                             <input type='text' class="form-control date_outr" maxlength="2" placeholder="mm" id="end_time_mnt_gig" name="end_time_mnt_gig" />
                            </div>
                          </div>
                     </div>
...
<!--                      <div class="form-group inpt input-customm">
                     ...
                     <!--  <div class="inline artist_list">
                        ...
                        <div class="inline artist_list">
                            ...
                            <div class="form-group inpt input-customm clearfix newTimeWrap">
                              <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr clck_outr fadeRed" placeholder="hh" id="requexpire_time_hr_gig" name="requexpire_time_hr_gig" />
                              </div>
                              <div class="timeField">
                              <input type='text' maxlength="2" class="form-control date_outr clck_outr fadeRed" placeholder="mm" id="reqexpire_time_mnt_gig" name="reqexpire_time_mnt_gig" /></div>
                              <div class="ampm aaaaa">
                              <select class="selectpicker artist_txt" id="ddlViewrequestexpire_gig" name="ddlViewrequestexpire_gig">
...
<!--                      <span>Tech Specs</span>-->
					  ...
					  echo Form::textarea("gigdescription", $value="", [ "id"=>"gigdescription","maxlength"=>"500", "placeholder"=>"Gig Description","class"=>"form-group inpt nb form-control" ]);
					  
					  ?>
                        
<!--                       <p> 5 lines, 50 characters maximum per line</p>-->
                      </div>
                      <!-- added for characters limitation starts-->
                        <input type="hidden" id="fieldtocountpostsgig" value="500">
                        <p style="margin-left: 16px !important;" id="CharCountLabelpostagig" ></p>
                      <!-- added for character limitation ends -->
                  <div class="col-md-12">
...
<script src="{{ FRONTCSSPATH}}/js/bootstrap-select.js"></script>
	<script type="text/javascript" src="{{ URL::asset('public/front')}}/otherfiles/progjs/frontendedgidmodal.js"></script>
       ...
       <!-- <script type="text/javascript" src="{{ FRONTCSSPATH}}/otherfiles/progjs/bookingdatetimevalidationvenue.js"></script> -->
          <script type="text/javascript" src="{{ FRONTCSSPATH}}/otherfiles/progjs/bookingdatetimevalidation_posta_gig.js"></script>
   ...
   $('.timeField input').keyup(function(e) {
	...
	//*********
        ...
        // $('#start_time_gig').prop("disabled", true);  
        // $('#end_time_gig').prop("disabled", true);  
