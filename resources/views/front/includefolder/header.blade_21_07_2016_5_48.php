	          ...
	          <div class="headerBtn">
				...
				<div class="prodile_img" id="myprodileimgicon"><img src="<?php echo $image_with_pth; ?>" alt="" /></div>
	          	<div class="profile_name dropdown">	          		
                     ...
                     <br /> You have $ 130</span> <span class="drop_icon"><img src="{{ URL::asset('public/front')}}/images/arrow_select.png" alt="" /></span></a>
	          		<ul role="menu" class="dropdown-menu">
	          			<!--<li><a href="edit-profile.html">MY Profile</a></li>-->
	          			<li><a href="<?php echo url('myaccount'); ?>">My Account</a></li>
	          			<li><a href="javascript:void(0);" data-toggle="modal" data-target="#myModal3">Wallet</a></li>
	          ...
	          <ul class="nav navbar-nav">
                ...
                <li class="dropdown <?php echo $myaccount_dact_cls;?>"><a class="dropdown-toggle" href="#">My Profile</a>
                    <ul class="dropdown-menu">
                        ...
                        ?>
                           <li><a href="<?php echo url('venue-edit')."/".$VenueName[0]->seo_name; ?>">My Venue</a></li>
                            <?php
                ...
                <!--<li class="<?php echo $gig_act_cls.$gig_dact_cls; ?>" ><a href="#">Gig Guide</a></li>-->
                 <li class="dropdown <?php echo $myaccount_dact_cls;?>"><a class="dropdown-toggle" href="javascript:void(0);">Gig Guide</a>
					<?php
					if($front_id_sess!='') {
					?>
                    <ul class="dropdown-menu">
   ...
   <script type="text/javascript" src="{{ URL::asset('public/front')}}/otherfiles/progjs/frontendGid.js"></script>