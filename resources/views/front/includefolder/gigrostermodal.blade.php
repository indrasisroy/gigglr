      ...
      <div class="modal-content popup-content artist_popup">
         <div class="modal-body popup-body">
            <div class="artist_hedr request booking_request">
               ...
               <h2 id="booking" class="bookingone">Booking Request</h2>
            </div>
  ...
  <div class="modal-dialog popup-dialog" role="document">
    <div class="modal-content popup-content artist_popup">
      ...
      <div class="artist_hedr request booking_request">
        ...
        <div class="artist_form_outr clearfix">
            <h2><span>Where </span>is the event</h2>
                    ...
                    <div class="col-sm-12">
                        <div class="radio_Check radio-check_B">
                            ...
                            if($event_type == 1)
                            {
                              ...
                              <label class="radio-check"><input type="radio" name="" value="" disabled="true">
                              <span></span>Yes</label>
                              <label class="radio-check"><input type="radio" name="" value="" checked="checked" disabled="true">
                              <span></span>No</label>
                           ...
                           <?php 
                            ...
                            <a href="javascript:void(0)" type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="<?php echo $privateorpubliccheck; ?>"><i class="fa fa-question-circle" aria-hidden="true"></i>
                                </a>
                             <?php 

                              }
                                ?>
                           <!--  <label class="radio-check"><input type="radio" name="gender" value="za" disabled="true">
                              <span></span>Yes</label>
                            <label class="radio-check"><input type="radio" name="gender" value="za" checked="checked" disabled="true">
                              <span></span>No</label>
 -->
  ...
  <div class="modal-dialog popup-dialog" role="document">
    <div class="modal-content popup-content artist_popup">
      ...
      <div class="artist_hedr request booking_request">
        ...
        <div class="artist_form_outr clearfix">
            <h2><span>What </span>is REQUIRED</h2>
                        ...
                        <!--</div>-->
                         <span>Enter details or specifics here :
                          ...
                          <a href="javascript:void(0)" class="techspecclass" aria-label="Help" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title=" <?php echo stripslashes($techspecheading) ?> ">example
						      ...
						      <textarea id="gig_description" maxlength="1000" class="form-group inpt nb form-control" name="gig_description" cols="50" rows="10" placeholder="Please assist artist(s) by describing any event specifics such as:
...
Also specify any additional requests here to be included in this event"><?php echo $gig_description ; ?></textarea>                                       <!-- <p> 5 lines, 50 characters maximum per line</p> ----> 
                    </div>
                ...
                echo Form::text("reqexpire_time_mnt", $value=$minselapsed, $attributes = array( "id"=>"reqexpire_time_mnt","class"=>"form-control date_outr clck_outr fadeY","maxlength"=>"2","placeholder"=>"MM"  ));
                      ...
                      <div class="inline artist_list">
                        ...
                        <div class="form-group inpt input-customm input-customm-color hasInfo">
                           <div class='input-group date'>
                            ...
                            <a href="javascript:void(0)" type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-container="body" data-placement="top" title="" data-original-title="Request expire date time text message "><i class="fa fa-question-circle" aria-hidden="true"  style="display: none;">></i>
                                </a>
                       ...
                       <div class="radio_Check radio_CheckC">
                        <span>Do you agree with site  <br><a href="<?php echo url('terms-and-conditions');?>" target="_blank">Terms &amp; Conditions </a></span>
                       <div class="adj-baje">
                        <label class="radio-check"><input type="radio" name="i_agree" id="i_agree_id" value="zb">
                          <span></span>Yes</label>
                        <label class="radio-check"><input type="radio" name="i_agree" value="za" checked="checked" id="i_agree_id_sec">
                          <span></span>No</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                     ...
                     <div class="customBtn-group customBtn-groupCU clearfix">
                      ...
                      <div class="paymnt_procc_clsreng mydisplaynone ccp_process_cls" id="processcls_negoall">
                                            Processing ...
                    </div>
...
if(gig_bidrequest_id == '')
{
 ...
 // console.log("cancellation amount lock id is "+gig_m_asd_lock_id);
  ...
  // if(whoami_text == 'BKR')
  // {
  //   $("#i_agree_id" ).prop( "checked", true );
  // }else if(whoami_text == 'AGV')
  // {
  //   $("#i_agree_id_sec" ).prop( "checked", true );
  // }
...
if(gig_bidrequest_id == '')
{
  ...
  //**********   booking form text value change strats here ******

  if(whoami_text == 'BKR')
  {
    //alert('sadsad');
      $('.bookingone').html('Booking Request');
      // $('.bookingtwo').html('Booking Request');
      // $('.bookingthree').html('Booking Request');
      // $('.bookingfour').html('Booking Request');
  }else if(whoami_text == 'AGV')
  {
    if(w_am_id_agv == 1)
    {
      $('.bookingone').html('REQUEST FOR INDIVIDUAL');
      $('.bookingone').parent().addClass('negotiationmodaltopcolor');
      // $('.bookingtwo').html('REQUEST FOR YOU');
      // $('.bookingthree').html('REQUEST FOR YOU');
      // $('.bookingfour').html('REQUEST FOR YOU'); 
    }
   else if(w_am_id_agv == 2)
    {
      $('.bookingone').html('REQUEST FOR GROUP'); 
      $('.bookingone').parent().addClass('negotiationmodaltopcolor');
      // $('.bookingtwo').html('REQUEST FOR GROUP');
      // $('.bookingthree').html('REQUEST FOR GROUP');
      // $('.bookingfour').html('REQUEST FOR GROUP'); 
    }else if(w_am_id_agv == 3)
    {
      $('.bookingone').html('REQUEST FOR VENUE');
      $('.bookingone').parent().addClass('negotiationmodaltopcolor');
      // $('.bookingtwo').html('REQUEST FOR VENUE');
      // $('.bookingthree').html('REQUEST FOR VENUE');
      // $('.bookingfour').html('REQUEST FOR VENUE');  
    }
    
  }


  //**********   booking form text value change ends here ******
...
//*************************** Confirmed booking text check starts here 07-03-2017
  

  if(bookingstatuscheck == 'accecptedfrombothend')
  {
    $(".bookingone").html('CONFIRMED BOOKING');
  }
  
//*************************** Confirmed booking text check ends here 07-03-2017
  ...
  if(bookingstatuscheck == 'notprossibletoopen' || bookingstatuscheck == 'accecptedfrombothend')
  {
        ...
        //****************************   disabled if accept from both end  starts here *************
        ...
        if(bookingstatuscheck == 'accecptedfrombothend')
        {
          ...
          $("#gig_description").attr('disabled', 'disabled');
          $("#reqexpire_time_day").attr('disabled', 'disabled');
          $("#reqexpire_time_hrs").attr('disabled', 'disabled');
          $("#reqexpire_time_mnt").attr('disabled', 'disabled');
        }

        //**************************** disabled if aceept from both end ends here *******************
  ...
  }else if(first_accepted_by > 0)
  {
    ...
    {
      $("#renegdiv").addClass('mydisplaynone');
      $("#negotiated_bid_reqst").unbind('click');
      $("#negotiated_bid_reqst").attr('disabled','disabled');

      //******************** pay now button add starts here    


      $("#accept_bid_reqst_booker_artst").prop('value', 'Save');
      $("#accept_bid_reqst_booker_artst").addClass('btn-sueee');
      $("#accept_bid_reqst_booker_artst").html('PAY NOW');
...
///************* booking open value show ends here 
  ...
  //******************* 
    ...
    $('#reqexpire_time_hrs').blur(function(key){

     var reqert =  $('#reqexpire_time_hrs').val();
      //alert(trt);
      if(parseInt(reqert) > 23 )
      {
        $('#reqexpire_time_hrs').val('');
      }
  ...
  }else
  {
    ...
    $('#reqexpire_time_mnt').blur(function(key){
     ...
     var reqert =  $('#reqexpire_time_mnt').val();
      //alert(trt);
      if(parseInt(reqert) > 59 )
      {
