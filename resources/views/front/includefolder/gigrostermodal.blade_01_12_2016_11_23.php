  ...
  <div class="modal-dialog popup-dialog" role="document">
    <div class="modal-content popup-content artist_popup">
      ...
      <input type="checkbox" name="tag_1" id="tag_1" value="1"  <?php echo (($event_type_for < 2 )? 'checked' : ''); ?> disabled="disabled"> <span>Yes </span>
            <input type="checkbox" name="tag_1" id="tag_2" value="2"  <?php echo (($event_type_for > 1 )? 'checked' : ''); ?> disabled="disabled"><span> No </span>
