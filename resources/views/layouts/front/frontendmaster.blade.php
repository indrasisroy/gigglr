...
$front_id_sess= session('front_id_sess');
 ...
 $myaccount_data_all_saved=1;
    if(session()->has('myaccount_data_all_saved')) // from middleware
    {
        $myaccount_data_all_saved=0;
    }
//echo "==myaccount_data_all_saved=>".$myaccount_data_all_saved;
...
$otherpagemetadesc='';
	...
	//**** fetch meta_description from settings - starts
                ...
                pin_publishable_key,pin_liveortest,service_charge,facebook_api";
                $wherear=array();
                $wherear['id']=1;
                ...
                if(!empty($fetchfrontwelcomedata))
                {
                     ...
                     $facebook_api= stripslashes($fetchfrontwelcomedata->facebook_api);
	...
	//**** fetch meta_description from settings - ends
     ...
     //************ if user is logged in then get addr_lat and addr_long  for center point for radius search starts*****
                ...
                //*********** if user is logged in then get addr_lat and addr_long  for center point for radius search ends *******
                   ...
                   //************fetch tooltip messages starts here********
                ...
                $inar=array('signup-confirm-password','keepme-signed-in');
                $orderbyfieldtooltip="id"; $orderbytypetooltip="asc";
                $limitstarttooltip=0;$limitendtooltip=0; 
                $confirmpassword_heading=''; 
                $keepmesignedin_heading=''; 
               ...
               //$confirmpassword_heading='';
                ...
                // echo "<pre>";
                // print_r($frontwelcomedata_tooltip);
                if(!empty($frontwelcomedata_tooltip))
                {
                  $confirmpassword_heading=stripslashes($frontwelcomedata_tooltip[0]->tooltip_message);
                  $keepmesignedin_heading = stripslashes($frontwelcomedata_tooltip[1]->tooltip_message);
                }
              //  die;


                   //************fetch tooltip messages ends here**********
...
<html lang="en">
  <head>
	...
	<meta name="csrf-token" content="{{ csrf_token() }}">
      ...
      <?php if(!empty($fcbkogdata)) { 
      
      $og_url=$fcbkogdata['og_url'];
      $og_title=$fcbkogdata['og_title'];
      $og_description=$fcbkogdata['og_description'];
      $og_image=$fcbkogdata['og_image'];
      $og_width=''; $og_height='';
        if(!empty($og_image))
        {
            ...
            list($og_width, $og_height) =getimagesize($og_image) ;
             ...
             //echo $og_width.'==WH=='.$og_height;
            //$og_image=$og_image."?v=".rand().time();
        }
    
      ?>
     <!-- for facebook profile page info share starts -->
    <?php if(!empty($facebook_api)){ ?> 
    <meta property="fb:app_id"         content="<?php echo $facebook_api; ?>" />    
    <?php } ?>  
    ...
    <div class="modal-content popup-content">
      <div class="modal-body popup-body">
         ...
         <span class="divider">Or</span> 
          <h2>SIGN UP <span>BELOW</span></h2>
          <?php echo Form::open(array('url' => 'registeruser','files' => true, 'method' => 'post','id'=>'signupfrmid','class'=>"" ,'autocomplete'=>'off' )); ?>
              ...
              <div class="alert success" style="display: none;">You are register successfully</div>
                  <div class="input-form">
					...
					<?php    
					echo Form::text("nickname", $value='', $attributes = array( "id"=>"nickname","class"=>" form-control  ","placeholder"=>"First Name","tabindex"=>"1"));
					?>
                  </div>
                  <div class="input-form ">
                      <?php    
					echo Form::text("email", $value='', $attributes = array( "id"=>"email","class"=>" form-control  ","placeholder"=>"Email","tabindex"=>"2"));
					?>
                  ...
                  <div class="input-form hasInfo">
                      <?php    
					echo Form::password("password",  $attributes = array( "id"=>"password","class"=>" form-control  ","placeholder"=>"Password" ,"tabindex"=>"3"));
					?>

            <!-- <button type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-placement="top" title="" data-original-title="Password must be at least 8 characters and should contain atleast one uppercase, one lowercase, one digit and one special character "><i class="fa fa-question-circle" aria-hidden="true"></i>
                    </button> -->
                  ...
                  <div class="input-form hasInfo">
                     <?php    
					echo Form::password("password_confirmation",  $attributes = array( "id"=>"password_confirmation","class"=>" form-control  ","placeholder"=>"Confirm password" ,"tabindex"=>"4"));
					?>

          <?php 

          if($confirmpassword_heading!=''){
          ?>
           <button type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $confirmpassword_heading; ?>"><i class="fa fa-question-circle" aria-hidden="true"></i>
                    </button>
                    <?php 
                  }
                    ?>
                ...
                <div class="form-second">
                  ...
                  <div class="inlineWrap extra-margin">
                        <div class="inline">
						   ...
						   <?php
						   echo Form::radio('gender', '1', true,$attributes = array("id"=>"gender_id1","tabindex"=>"5","onclick"=>""));
						   ...
						   ?>
                            ...
                            <div class="inline">
                                <label class="radio-check">
								 <?php
						   echo Form::radio('gender', '2', false,$attributes = array("id"=>"gender_id2","tabindex"=>"6","onclick"=>""));
						   ...
						   ?>
                            ...
                            <div class="inline">
                                <label class="radio-check">
						   <?php
						   echo Form::radio('gender', '3', false,$attributes = array("id"=>"gender_id3","tabindex"=>"7","onclick"=>"" ));
						   ?>
                                <span></span>Other</label>
                            </div>
                    </div>
                      <h5>Date of Birth &nbsp;<span style="color: #a1a0a2;">(not for public display)</span></h5>
                    <div class="clearfix">
    ...
    <div class="modal-content popup-content">
      <div class="modal-body popup-body loginPopup">
       <button type="button" class="popup-close close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <?php echo Form::open(array('url' => 'loginuser','files' => true, 'method' => 'post','id'=>'loginfrmid','class'=>"",'autocomplete'=>'off' )); ?>
              <h2>Log in</h2>
              ...
              <div class="form-second">
                  <div class="terms-condi-col ">
                        <label class="radio-check hasInfo">
          ...
          if($keepmesignedin_heading!=''){
          ?>
           <button type="button" class="helpIcon" aria-label="Help" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $keepmesignedin_heading;?> "><i class="fa fa-question-circle" aria-hidden="true"></i>
                    </button>
                    <?php 
                  }
                    ?>
...
<div class="modal fade forgotpassmodal" id="myModalFrgt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog popup-dialog" role="document">
    <div class="modal-content popup-content">
      <div class="modal-body popup-body loginPopup">
       <button type="button" class="popup-close close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <?php echo Form::open(array('url' => 'forgotpass','files' => true, 'method' => 'post','id'=>'frgtpassfrm','class'=>"",'autocomplete'=>'off' )); ?>
        ...
        <div class="modal-footer popup-footer">
             <div class="sign-up-tips">
               <span>Don't have an account?</span>
                <a id="frgtpssignupfrfree" href="#" data-dismiss="modal" aria-label="Close" onclick="opensignupfrm()">Sign up for FREE</a>
          </div>
      </div>
 ...
 <!-- <div class="modal fade" id="myModal3paymentvieww" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
   ...
   <div class="modal fade" id="myModal3paymentview" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-keyboard="false" data-backdrop="static">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content popup-content">
              <div class="modal-body popup-body wallet">
                <div class="clearfix">
                        ...
                        <div class="tab-content">
                            <div id="payone" class="tab-pane fade ">
                                <div class="card_payments">
                                    ...
                                    <form autocomplete="off" class="card_payments_content" id="bankpaymentformid">
                                        ...
                                        <div class="clearfix btnLeftRight btmGapC">
                                            
                                            <div class='paymnt_procc_cls mydisplaynone bt_process_cls'>
                                            Processing ...
                                            </div>
                                            
                                            <div class="inlineNew amount leftBtn">
                                                <button  id="bankpaymentsubmid" class="fund_btn btn" type="button">Send to my bank</button>
                                            </div>
                                            <div class="inlineNew"><span>Please Note:</span> Minimum transfer : $50<br>
                                            Maximum transfer : $5000
...
<!--                                            <Span><img src="images/c3.png" alt=""> </Span> -->
                                    ...
                                    <form autocomplete="off" class="card_payments_content pin" action='posturlpage.php' method='post'>
...
-->
                                        ...
                                        echo Form::password("cc-cvc",$control_attrAr);        
                                        ...
                                        ?>
                                           <p id="cc-cvc-error" class="common_paymnt_errcls myerrorcolor mydisplaynone"></p>          
                                            ...
                                            <div class="col-sm-7">
                                                <div class="row exp_dates exp_dates_cct">
                            ...
                            echo Form::select('cc-expiry-month', $expiry_monthAr, $expirymonthsel,$control_attrAr);	
                                    ...
                                    ?>
                                       ...
                                       <div class="card_inputs add_fund amount" data-currency="$">
                                        ...
                                        <div class="btmGap btmGapC">
                                            <div class='paymnt_procc_cls mydisplaynone ccp_process_cls'>
                                            Processing ...
                                            </div>
                                            <div class="inlineNew amount leftBtn">
                                                <button id="paymentbutid" class="fund_btn btn" type="submit">
                                                Add Funds
                                                </button>
                                            ...
                                            <p>Minimum purchase : $50 <br> Maximum purchase : $5000</p>
...
-->
 ...
 var bookingmodalcheckoption = "";   //artist-modal-open    venue-modal-open  group-modal-open
          ...
          //****** blocking back button starts **************************
          var logoutstatusdata="<?php echo session('logoutstatus'); ?>";
          var logoutprevurldata="<?php echo session('prevurldata'); ?>";          
          
            $( "body" ).ready(function() {
               if(logoutstatusdata=="yes")
                   {
                        //console.log(logoutprevurldata);                                            
                        var stateObj1 = { foo: "dammodammo1" };
                        var stateObj2 = { foo: "dammodammo2" };
                        var stateObj3 = { foo: "dammodammo3" };
                       
                       
                        history.pushState(stateObj1, "dammodammo1", base_url_data); 
                        history.pushState(stateObj2, "dammodammo2", base_url_data); 
                        history.pushState(stateObj3, "dammodammo3", base_url_data); 
  ...
  <!-- for confirm box css and js starts -->
   ...
   <script type="text/javascript" src="{{ FRONTCSSPATH}}/otherfiles/confirmboxlib/js/jquery-confirm.js"></script>
    ...
    //******* for menu drop down starts **************
		...
		// });
    //******* for menu drop down ends **************      

    //*****************  clearing modal data starts here 06-03-2017**************
    ...
    $("#login_email").parent().removeClass('errorField');
    $("#login_password").parent().removeClass('errorField');
    ...
    $("#nickname").parent().removeClass('errorField');
    $("#email").parent().removeClass('errorField');

    $("#password").parent().removeClass('errorField');
    $("#password_confirmation").parent().removeClass('errorField');

    })

    //*****************  clearing modal data ends here 06-03-2017****************
    ...
    jQuery("#registerbuttonid").unbind('click');
    jQuery("#registerbuttonid").bind('click',function(){
  ...
  //**** bind logout starts ********
     ...
     $("#ccid1").click(function(){
         ...
         setTimeout(function(){
              ...
              $.confirm({
                            ...
                            title: false,
                            content: "<p style='text-align:center;'>Are you sure you want  to logout?</p>",
                            closeIcon: true,
                               ...
                               buttonLogout: {
                                   ...
                                   btnClass: 'btn-blue mycustlogoutcls',
                                    action: function () {
                                        ...
                                        location.href=base_url_data+"/logout";
	...
	var key = e.which;
		if(key == 13)  // the enter key code
		{
			...
			$("#frgtpasswordbtnid").trigger('click');
            $('#frgtpssignupfrfree').focus();
...
@if ( session()->has('status') )
			...
			poptriggerfunc(msgtype='success',titledata='',msgdata='{{ session()->get('status') }}',sd=1000,hd=1500,tmo=5000,etmo=null,poscls='toast-top-full-width');         
			</script>	
@endif
  ...
  <!--******************* script for googleplus login ends -->
    ...
    <?php if(!empty($front_id_sess)){  ?>
	     ...
	     <!-- for payment  related js starts -->
            ...
            $("#walletlinkancid").click(function(){
                
                setTimeout(function(){
                    
                   <?php if($myaccount_data_all_saved==1){ ?> 
                    $("#myModal3paymentview").modal('show');
                    <?php } else { ?>
                    
                    toastr.remove();
                    
                    poptriggerfunc(msgtype='success',titledata='',msgdata="Please complete Account Information first, Then you can access other Sections !!!",sd=1000,hd=1500,tmo=5000,etmo=null,poscls='toast-top-full-width'); 
            ...
            <script src="{{ FRONTCSSPATH}}/otherfiles/progjs/pinpaymentmycustom.js"></script> 
        <!-- for payment  related js ends -->
   
  <?php } ?>    
      
      <!-- for timezone js starts -->
	<script src="{{ FRONTCSSPATH}}/otherfiles/timezonethirdpartylib/jstz.min.js"></script>
      <!-- for timezone js ends -->
