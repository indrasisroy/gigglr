                                    ...
                                    <form class="card_payments_content">
                                        ...
                                        <div class="minHeight">
                                            <div class="card_inputs">
                                                <input class="form-control txt_color" type="text" placeholder="Name of Account Holder" />
                                            </div>
                                            <div class="row card_inputs">
                                                <div class="col-sm-4 col-md-3 col-xs-5">
                                                    <input class="form-control txt_color" type="text" placeholder="BCB 000" />
                                                </div>
                                                <div class="col-sm-6 col-md-5 col-xs-7">
                                                    <input class="form-control txt_color" type="text" placeholder="Account Number" />
                                                </div>
                                             </div>
                                        </div>
                                        ...
                                        <div class="amount">
                                            <div class="card_inputs add_fund">
                                                <span class="fund_icon"> Amount</span>
                                                <input class="form-control txt_color" type="text" placeholder=" $0.00" />
                                            </div>
                                        </div>
                                        <div class="clearfix btnLeftRight">
                                            <div class="amount leftBtn">
                                                <button class="fund_btn" type="submit">Send to my bank</button>
                                            </div>
<!--
...
<!--                                            <Span><img src="images/c3.png" alt=""> </Span> -->
                                    ...
                                    <form class="card_payments_content">
                                       ...
                                       <div class="card_inputs add_fund amount">
                                        ...
                                        <div class="btmGap">
                                            <div class="inlineNew amount leftBtn"><button class="fund_btn" type="submit">
                                                Add Funds
                                            </button>
                                            </div>
                                            <div class="inlineNew"><span>Please Note:</span> There is a 2% non-refundable transaction fee on credit card purchases</div>
                                        </div>
                                        ...
                                        <table class="table payTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="textUpper">EVE-A123456</span>
                                                    </td>
                                                    <td>
                                                        <span class="lett-spac">$500</span>
                                                    </td>
                                                    <td>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="textUpper">GIG-A56321</span>
                                                    </td>
                                                    <td>
                                                        <span class="lett-spac">$1000</span>
                                                    </td>
                                                    <td>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="textUpper">COM-56321</span>
                                                    </td>
                                                    <td>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <span class="textUpper">EVE-G56321</span>
                                                    </td>
                                                    <td>
                                                        <span class="lett-spac">$3000</span>
                                                    </td>
                                                    <td>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="lett-spac">$144500</span>
                                                    </td>
                                                    <td>
                                                        <span class="lett-spac">$10000</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                     ...
                                                     <td>
                                                         <span>Funds Added to Wallet</span>
                                                    </td>
                                                    <td>
                                                        <span class="lett-spac">$12500</span>
                                                    </td>
                                                    <td>
                                                        <span class="lett-spac">$100</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                     ...
                                                     <td>
                                                         <span class="textUpper">EVE-V56321</span>
                                                    </td>
                                                    <td>
                                                        <span class="lett-spac">$400</span>
                                                    </td>
                                                    <td>
                                                        <span class="lett-spac"></span>
                                                    </td>
                                                </tr>
                                                <tr class="total">
                                                    <td>&nbsp;</td>
...
-->
                                        ...
                                        <div class="netFund clearfix">Wallet Balance: <span>$1467.00</span></div>
                                        </div>
                                    </div>
                                    <div class="full-info">
                                            <span>EVE - Event</span>
