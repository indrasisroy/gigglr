...
$otherpagemetadesc='';
	...
	//**** fetch meta_description from settings - starts
                ...
                $fieldnames=" welcome_text,default_radius,max_radius_limit,site_fax_no,meta_description,pin_secret_key,pin_publishable_key,pin_liveortest ";
                $wherear=array();
                $wherear['id']=1;
                ...
                $pin_secret_key='';$pin_publishable_key='';$pin_liveortest='';
