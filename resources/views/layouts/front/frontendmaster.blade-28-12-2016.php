               ...
               if(logoutstatusdata=="yes")
                   {
                        ...
                        var stateObj4 = { foo: "dammodammo4" };
                        var stateObj5 = { foo: "dammodammo5" };
                        var stateObj6 = { foo: "dammodammo6" };
                        ...
                        history.pushState(stateObj4, "dammodammo4", base_url_data); 
                        history.pushState(stateObj5, "dammodammo5", base_url_data); 
                        history.pushState(stateObj6, "dammodammo6", base_url_data); 
