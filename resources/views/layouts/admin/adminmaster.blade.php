...
<html lang="en">
  <head>
	...
	<link href="{{ ADMINCSSPATH}}/css/bootstrap-timepicker.css" rel="stylesheet">	
	...
	<link href="{{ BASEURLPUBLICCUSTOM.'commonassets/admindev'}}/css/admindeveloper.css" rel="stylesheet">
	  ...
	  <link rel="stylesheet" href="{{ ADMINCSSPATH}}/otherfiles/toastr/toastr.min.css">
	<script type="text/javascript" src="{{ ADMINCSSPATH}}/otherfiles/toastr/toastr.min.js"></script>
	<script type="text/javascript" src="{{ ADMINCSSPATH}}/otherfiles/toastr/mycustomtoastr.js"></script> 
	<!-- for popup alert starts -->

	<link href="{{ ADMINCSSPATH}}/otherfiles/progcss/mydevelopmentcustom_admin.css">
  ...
  <body class="overflow-hidden">
						  ...
						  <li class="openable <?php echo $dash_actv; ?>">
							...
							<ul class="submenu">
							  <?php					
								...
								<li class="<?php echo $dash_actv; ?>" >
									<a class="" href="<?php echo url(ADMINSEPARATOR.'/country')?>">
										<span class="menu-icon">
									<i class="fa fa-flag-o fa-lg"></i> 
								</span>
									<span class="submenu-label">Country </span>
									  </a>
								</li>
				...
				//	{$dash_actv="active"; }
					?>	  
						...
						?>  
							  <li class="openable <?php echo $dash_actv; ?>">
								...
								?> 
									<li class="<?php echo $dash_actv; ?>">
										...
										<span class="submenu-label">Help By Page </span>
										  </a>
									</li>
									  <?php					
									  $dash_actv='';
									...
									<li class="<?php echo $dash_actv; ?>">
									 ...
									 <?php					
									  ...
									  ?> 
									<li class="<?php echo $dash_actv; ?>">
										<a class="anctxtwhitecolor" href="<?php echo url(ADMINSEPARATOR.'/faq')?>">
							...
							<!--Dispute support section starts-->
							<?php					
						$dash_actv='';
						$adrouteAr=array();
						$adrouteAr[]="admin_issue_with_artist";
						$adrouteAr[]="admin_issue_with_group";
						$adrouteAr[]="admin_issue_with_venue";
						$adrouteAr[]="admin_issue_with_booker";
						if(in_array($adminroutename,$adrouteAr))
						{$dash_actv="active"; }
						?>
							  <li class="openable <?php echo $dash_actv; ?>">
								...
								?> 
									<li class="<?php echo $dash_actv; ?>">
										<a class="anctxtwhitecolor" href="<?php echo url(ADMINSEPARATOR.'/admin_issue_with_artist')?>">
										<span class="submenu-label">Issue with Artist</span>
										  </a>
									</li>
									  <?php					
									  $dash_actv='';
									  ...
									  ?> 
									<li class="<?php echo $dash_actv; ?>">
										<a class="anctxtwhitecolor" href="<?php echo url(ADMINSEPARATOR.'/admin_issue_with_group')?>">
										<span class="submenu-label">Issue with Group</span>
										  </a>
									</li>
									<?php					
									  $dash_actv='';
									...
									<li class="{{ $dash_actv }}">
										<a class="anctxtwhitecolor" href="{{ url(ADMINSEPARATOR.'/admin_issue_with_venue')}}">
									<span class="submenu-label">Issue with Venue</span>
										  </a>
									</li>
									...
									<li class="{{ $dash_actv}}">
										<a class="anctxtwhitecolor" href="{{ url(ADMINSEPARATOR.'/admin_issue_with_booker')}}">
									<span class="submenu-label">Issue with booker</span>
										  </a>
									</li>
									
								</ul>							  
							</li>
							<!--Dispute support section ends-->
						...
						<?php					
						  $dash_actv='';
						  $adrouteAr=array();
						  $adrouteAr[]="admincontactusroute";
						  if(in_array($adminroutename,$adrouteAr))
						  {$dash_actv="active"; }
						?>	  
						<li class="<?php echo $dash_actv; ?>" >
							<a href="<?php echo url(ADMINSEPARATOR.'/contactus');?>">
								<span class="menu-icon">
						...
						<?php					
						  $dash_actv='';
						  $adrouteAr=array();
						  $adrouteAr[]="admintooltipmessages";
						  $adrouteAr[]="admintooltipmessagesadd";
						  if(in_array($adminroutename,$adrouteAr))
						  {$dash_actv="active"; }
						?>	  
						<li class="<?php echo $dash_actv; ?>" >
							<a href="<?php echo url(ADMINSEPARATOR.'/tooltipmessages');?>">
								<span class="menu-icon">
                        ...
                        <?php					
						  $dash_actv='';
						  $adrouteAr=array();
						  $adrouteAr[]="admintestmailroute";
						  
						  if(in_array($adminroutename,$adrouteAr))
						  {$dash_actv="active"; }
						?>	  
						<li class="<?php echo $dash_actv; ?>" >
							<a href="<?php echo url(ADMINSEPARATOR.'/admintestmail');?>">
								<span class="menu-icon">
									<i class="fa fa-envelope"></i> 
								</span>
								<span class="text">
	...
	<script src="{{ ADMINCSSPATH}}/js/bootstrap-timepicker.min.js"></script>
