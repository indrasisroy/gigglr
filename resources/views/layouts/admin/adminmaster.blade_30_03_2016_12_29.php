...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{ URL::asset('admin')}}/bootstrap/css/bootstrap.min.css" rel="stylesheet">
	
	<!-- Font Awesome -->
	<link href="{{ URL::asset('admin')}}/css/font-awesome.min.css" rel="stylesheet">

	<!-- Pace -->
	<link href="{{ URL::asset('admin')}}/css/pace.css" rel="stylesheet">	
	
	<!-- Endless -->
	<link href="{{ URL::asset('admin')}}/css/endless.min.css" rel="stylesheet">
	<link href="{{ URL::asset('admin')}}/css/endless-skin.css" rel="stylesheet">
	<!-- Website Developer -->
	<link href="{{ URL::asset('commonassets/admindev')}}/css/admindeveloper.css" rel="stylesheet">
  </head>
  ...
  <body class="overflow-hidden">
					...
					<ul class="dropdown-menu message dropdown-1">
						...
						<li>
							<a class="clearfix" href="#">
								<img src="{{ URL::asset('admin')}}/img/user.jpg" alt="User Avatar">
								<div class="detail">
									<strong>Admin</strong>
									<p class="no-margin">
						...
						<li>
							<a class="clearfix" href="#">
								<img src="{{ URL::asset('admin')}}/img/user2.jpg" alt="User Avatar">
								<div class="detail">
									<strong>Admin</strong>
									<p class="no-margin">
										Lorem ipsum dolor sit amet...
				...
				?>
					...
					?>	  
						...
						<li class="<?php echo $dash_actv; ?>" >
						  ...
						  $adrouteAr[]="adminfaqaddroute";
						  if(in_array($adminroutename,$adrouteAr))
						  {$dash_actv="active"; }
						?>	  
						<li class="<?php echo $dash_actv; ?>" >
							<a href="<?php echo url(ADMINSEPARATOR.'/faq');?>">
								<span class="menu-icon">
						  ...
						  $adrouteAr[]="admincontactusdelroute";
						  if(in_array($adminroutename,$adrouteAr))
						  {$dash_actv="active"; }
						?>	  
						<li class="<?php echo $dash_actv; ?>" >
    ...
    <!-- Pace -->
	<script src="{{ URL::asset('admin')}}/js/pace.min.js"></script>
	
	<!-- Popup Overlay -->
	<script src="{{ URL::asset('admin')}}/js/jquery.popupoverlay.min.js"></script>
   
    <!-- Slimscroll -->
	<script src="{{ URL::asset('admin')}}/js/jquery.slimscroll.min.js"></script>
    
	<!-- Cookie -->
	<script src="{{ URL::asset('admin')}}/js/jquery.cookie.min.js"></script>

	<!-- Endless -->
	<script src="{{ URL::asset('admin')}}/js/endless/endless.js"></script>
	<script>
