...
<html lang="en">
  <head>
	...
	<!-- Pace -->
	<link href="{{ URL::asset('public/admin')}}/css/pace.css" rel="stylesheet">	
	
	<!-- Endless -->
	<link href="{{ URL::asset('public/admin')}}/css/endless.min.css" rel="stylesheet">
	<link href="{{ URL::asset('public/admin')}}/css/endless-skin.css" rel="stylesheet">
	<!-- Website Developer -->
					...
					<ul class="dropdown-menu message dropdown-1">
						...
						<li>
							<a class="clearfix" href="#">
								<img src="{{ URL::asset('public/admin')}}/img/user.jpg" alt="User Avatar">
								<div class="detail">
									<strong>Admin</strong>
									<p class="no-margin">
						...
						<li>
							<a class="clearfix" href="#">
								<img src="{{ URL::asset('public/admin')}}/img/user2.jpg" alt="User Avatar">
								<div class="detail">
									<strong>Admin</strong>
									<p class="no-margin">
										Lorem ipsum dolor sit amet...
