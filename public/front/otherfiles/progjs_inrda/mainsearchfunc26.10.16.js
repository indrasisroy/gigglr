        ...
        $.ajax({
            ...
            success:function(d){
               ...
               // var main_srch_union_lim=d.main_srch_union_lim; //alert(main_srch_union_lim);
                ...
                if(respdata=='')
                {
                    respdata="<div id=\"searchlistresponseid\" class=\"col-md-12 col-sm-12 fullbx\">Unfortunately there are no results with that criteria, please try a broader search.</div>";
                   //respdata="";
