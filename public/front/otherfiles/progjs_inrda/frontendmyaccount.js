$(document).ready(function(){
          ...
          if (my_wallet_amount != "0.00" || my_wallet_amount > 0.00) {
                    poptriggerfunc(msgtype='error',titledata='',msgdata="You con't change country , state & currency right now.",sd=6000,hd=1500,tmo=3000,etmo=4000,poscls='toast-bottom-right');
          ...
          var selected_value = $(this).val();
            toastr.remove();
            if (my_wallet_amount != "0.00" || my_wallet_amount > 0.00) {
                    poptriggerfunc(msgtype='error',titledata='',msgdata="Your con change currency right now",sd=6000,hd=1500,tmo=3000,etmo=4000,poscls='toast-bottom-right');          
                    if (my_currency != '') {
          ...
          $(document).on('blur','#emailid',function(){
                    ...
                    if (ref_email.length == 0) {
                              ...
                              $('#emailid').css('border-color', 'red');
                              $('.validation').show();
                              $('.validation').html("Please enter valid address");
                              ref_email_blurchk = false;
                    }else{
             ...
             $.ajax({
               ...
               success:function(d){
                    ...
                    if (d=='false') {
                              ...
                              $('#re_password').val("Wrong old password");
                              $('.validationpass').show();
                              $('.validationpass').html("Wrong old password");
          ...
          function myaccountfrmidsubmit(){
                    ...
                    if (chkmyaccountvalidation== true) {
                             ...
                             poptriggerfunc(msgtype='error',titledata='',msgdata="Please fill all mandatory field",sd=1000,hd=1500,tmo=null,etmo=null,poscls='toast-bottom-right'); 
                    }
          }
    ...
    var myaccountfrm_data={_token:csrf_token_data,'referemail':referemail_data,'dob':dob,'first_name':first_name,'middle_name':middle_name,'last_name':last_name,'phone':phone,'email':email,'address1':address1,'address2':address2,'select_country':select_country,'select_state':select_state,'city':city,'zip':zip,'phone':phone,'dobDays':dobDays,'dobMonths':dobMonths,'dobYears':dobYears,'genderradio':genderradio,'select_Language':select_Language,'currency':currency,'old_password':old_password,'new_password':new_password,'con_password':con_password};
          ...
          $.ajax({
               ...
               success:function(d){
                    ...
                    {
                         poptriggerfunc(msgtype='success',titledata='',msgdata="Your account updated successfully",sd=3000,hd=2000,tmo=1000,etmo=1000,poscls='toast-bottom-right');
               ...
               success:function(d){
                    ...
                    if (d.my_msg.type==0) {
                       var error_message=d.error_message;
                         ...
                         $("#subscribeloader").addClass("mydisplaynone");              
                         poptriggerfunc(msgtype='error',titledata='',msgdata=d.my_msg.text,sd=1000,hd=1500,tmo=null,etmo=null,poscls='toast-bottom-right');                
                    
                    }else{
                          poptriggerfunc(msgtype='success',titledata='',msgdata=d.my_msg.text,sd=3000,hd=2000,tmo=1000,etmo=1000,poscls='toast-bottom-right');
                         $("#subscribeform").trigger("reset");
                         $("#subscribeloader").addClass("mydisplaynone");    
                    }
                    if (d.my_msg.type_deact==0) {
                       var error_message=d.error_message;
                         ...
                         $("#subscribeloader").addClass("mydisplaynone");              
                         poptriggerfunc(msgtype='error',titledata='',msgdata=d.my_msg.text_deact,sd=1000,hd=1500,tmo=null,etmo=null,poscls='toast-bottom-right');                
                    
                    }else{
                          poptriggerfunc(msgtype='success',titledata='',msgdata=d.my_msg.text_deact,sd=3000,hd=2000,tmo=1000,etmo=1000,poscls='toast-bottom-right');
                         $("#subscribeform").trigger("reset");
                         $("#subscribeloader").addClass("mydisplaynone");    
                    }
     ...
     $("#myaccountfrmid").validate({
       ...
       errorClass: 'authError',
			...
			messages: {
                ...
                select_Language: { required: "Please select an item!" },
                old_password :{
