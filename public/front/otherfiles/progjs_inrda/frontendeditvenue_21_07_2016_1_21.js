                                             ...
                                             success: function(d)
                                             {
                                                 ...
                                                 // console.log("Booking response==========>"+d);
                                                   toastr.remove();// Immediately remove current toasts without using animation
                                                                ...
                                                                {
                                                                                poptriggerfunc(msgtype='success',titledata='',msgdata="Address and Amenities updated successfully ",sd=1000,hd=1500,tmo=3000,etmo=3000,poscls='toast-bottom-right');
                                                                }     
                                                                //***************** Check response ends      
