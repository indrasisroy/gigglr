  ...
  function initMap() {
  	...
  	var lngtude=151;
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 7,
          center: {lat: ltude, lng: lngtude} //round-of
        });

     //   var image = base_url_data+'http://i.stack.imgur.com/cdiAE.png'; if want to use customize image
        var beachMarker = new google.maps.Marker({
          position: {lat: ltude, lng: lngtude}, //without round-of
          map: map,
        //  icon: image
        });
      }
 ...
 function callforbookingvenue(posturl,csrf)
                              ...
                              if(chkbookingvalidation === true)
                              {
                                  //************ Retriving value starts here
                                   ...
                                   var address2val = $("#booking_location_secondary").val();
