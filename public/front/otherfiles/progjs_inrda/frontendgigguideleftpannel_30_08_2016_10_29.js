            ...
            dataType:"json",
                success: function(res)
                {
                    ...
                    if (res.flag == '1') {
                        ...
                        toastr.remove();
                        poptriggerfunc(msgtype='error',titledata='',msgdata=res.msg,sd=1000,hd=1500,tmo=null,etmo=null,poscls='toast-bottom-right'); 
    ...
    $( ".clickMWD" ).click(function() {
     ...
     $(".mycustevntcls").click(function(){
            ...
            else if(filterevtypedta=="EVENTGENRE")
            {
                ...
                {
                          $(this).data("showevntflag",1);
                          $(this).find(".evntxtdtacls").html("Show my profile genres only");
                ...
                {
                           $(this).data("showevntflag",0);
                           $(this).find(".evntxtdtacls").html("Hide my profile genres only");
