      ...
      if (d!=null)
      {
        ...
        //console.log("======flagdta==>"+flagdta);
         ...
         if (flagdta==1)
         {
			  ...
			  poptriggerfunc(msgtype='success',titledata='',msgdata="Group press kit uploaded successfully for group",sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-bottom-right');
