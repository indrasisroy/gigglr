                                            ...
                                            var suskillobjchk=prntsklobj.find(".mysubcustcls[data-skillsub='" + skill_sub_data + "']");
                                             ...
                                             //** check whether sub skill present in the structure or not ends 
                                                  ...
                                                  else
                                                  {
                                                       ...
                                                       poptriggerfunc(msgtype='error',titledata='',msgdata="This genre already exist",sd=1000,hd=1500,tmo=10000,etmo=2000,poscls='toast-bottom-right');
                            ...
                            $.ajax({
                                ...
                                success:function(d){
                                                ...
                                                if (d.update_flag==0)
                                                {
                                                       ...
                                                       poptriggerfunc(msgtype='error',titledata='',msgdata=d.error_message,sd=1000,hd=1500,tmo=1000,etmo=2000,poscls='toast-bottom-right');
...
function callpendbkpblshowflclssave(clkobj)
               {
                    if (viewshowflag==0)
                    {
                         ...
                         var emsgdata=" 'Show Calendar' option is not set .  ";
                          poptriggerfunc(msgtype='error',titledata='',msgdata=emsgdata,sd=1000,hd=2500,tmo=2000,etmo=1000,poscls='toast-bottom-right');
                          return false;
                    }
...
//if(ld!=1){
                                ...
                                success:function(d)
                                {
                                                ...
                                                //***************** Check response starts
                                                 ...
                                                 if (d.update_flag==0)
                                                {
                                                                poptriggerfunc(msgtype='error',titledata='',msgdata="Something went wrong",sd=1000,hd=1500,tmo=null,etmo=null,poscls='toast-bottom-right');               
                                                }
                                                else
                                                {
                                                  if(d.flag_type == 1)
                                                  {
                                                       poptriggerfunc(msgtype='success',titledata='',msgdata="Review will be displayed in your profile",sd=2000,hd=2500,tmo=1000,etmo=1000,poscls='toast-bottom-right');
                                                        $("#showreviewnt").slideDown(); 
                                                   }else if(d.flag_type == 0)
                                                   {
                                                       poptriggerfunc(msgtype='success',titledata='',msgdata="Review will not be displayed in your profile",sd=2000,hd=2500,tmo=1000,etmo=1000,poscls='toast-bottom-right');
                                                        $("#showreviewnt").slideUp(); 
                                                   }  
                                                }
