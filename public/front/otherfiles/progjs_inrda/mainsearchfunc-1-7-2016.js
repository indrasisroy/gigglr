        ...
        $.ajax({
            ...
            success:function(d){
                ...
                {           
                         ...
                         if (selectcategnmid!='' &&  selectgenrenmid=='') // only category has been found
                         {
                            populategenre(selectcategnmid);
                            $("#category").val(selectcategnmid);
                            $("#category option[value="+selectcategnmid+"]").attr('selected','selected');
                            $("#category").selectpicker('refresh');
                         }
                         else if (selectcategnmid!='' &&  selectgenrenmid!='') // both category and  genre has been found
                         {
                            console.log("selectcategnmid=>"+selectcategnmid+"==selectgenrenmid=>"+selectgenrenmid);
