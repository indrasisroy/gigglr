...
function bookingoptionstosave()
{
                ...
                var callurlwithdata={_token:csrf_token_data,'typeEvent':typeEvent,'bookingfrom':bookingfrom,'hourly_rate':hourly_rate,'security_deposit':security_deposit,'tech_spec':tech_spec};
