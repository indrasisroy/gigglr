  $(".myfavorite").on("click", (function () {
    ...
    if (logID!='') {
      ...
      if (userid==logID) {
       ...
       poptriggerfunc(msgtype='error',titledata='',msgdata=msg,sd=6000,hd=1500,tmo=3000,etmo=4000,poscls='toast-bottom-right'); 
      }else{
            ...
            $.ajax({
              ...
              if (d.flag == '1') {
                if (d.lastStatus == '1'){
                 ...
                 poptriggerfunc(msgtype='success',titledata='',msgdata=d.msg,sd=2000,hd=2500,tmo=1000,etmo=1000,poscls='toast-bottom-right');
