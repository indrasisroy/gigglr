                                                        ...
                                                        success:function(d){
                                                              ...
                                                              // alert(d.error_message);
                                                               ...
                                                               // console.log(d.error_message);
                                                                ...
                                                                if(d.return_flag == '1')
                                                                {
                                                                     poptriggerfunc(msgtype='success',titledata='',msgdata='Rider updated successfully',sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-bottom-right');
                                                                      $('#myRider').modal('hide');
                                                                      ridervalue = ridertxt;
                                                                }else if(d.return_flag == '0')
                                                                {
                                                                   // console.log(d.error_message.ridervalue);
                                                                 //   alert(d.error_message);
                                                                     poptriggerfunc(msgtype='error',titledata='',msgdata=d.error_message.ridervalue,sd=1000,hd=10000,tmo=1000,etmo=1000,poscls='toast-bottom-right');
                                                                     // $('#myRider').modal('hide');
                                                                }
