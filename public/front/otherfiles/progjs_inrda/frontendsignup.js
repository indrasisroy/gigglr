                     ...
                     //**** ajax code starts
                        ...
                        jQuery.ajax({
                            ...
                            success:function(d){
                               ...
                               {
                                   poptriggerfunc(msgtype='success',titledata='',msgdata="Registration done successfully, Please check the mail",sd=3000,hd=2000,tmo=1000,etmo=1000,poscls='toast-bottom-right');
