                                    ...
                                    jQuery.ajax({
										...
										dataType:"json",
                                             success: function(res)
                                             {
                                                  ...
                                                  if (res.flag == 1) {
                                               // $('#venueaddresslocationfrm')[0].reset();
                                               
                                                if (res.venuecretaeedit == 1) {
                                         window.location.href = base_url_data+'/'+'venue-edit/'+res.nicknmdata;
                                        //window.location.href = "profile.php";  // replace
                                      }
                var success_message_data="Address and Amenities updated successfully ";
                poptriggerfunc(msgtype='success',titledata='',msgdata=success_message_data,sd=1000,hd=5500,tmo=3000,etmo=4000,poscls='toast-bottom-right');
                                                  }
