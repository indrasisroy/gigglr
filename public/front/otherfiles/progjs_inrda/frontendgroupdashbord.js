          ...
          $.ajax({
               ...
               success:function(d){
                    ...
                    {      
                         ...
                         poptriggerfunc(msgtype='success',titledata='',msgdata="Your group created successfully",sd=3000,hd=2000,tmo=1000,etmo=1000,poscls='toast-bottom-right');
                    ...
                    {
                         poptriggerfunc(msgtype='success',titledata='',msgdata="Your group updated successfully",sd=3000,hd=2000,tmo=1000,etmo=1000,poscls='toast-bottom-right');
                         $("#subscribeform").trigger("reset");
                         $("#subscribeloader").addClass("mydisplaynone");
                         //alert(base_url_data+d.url);
                         //window.location.assign(base_url_data+"/groupedit/"+d.url);
