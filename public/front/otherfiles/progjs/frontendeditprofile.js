                                                ...
                                                else
                                                {
                                                       ...
                                                       else if (pendbkpblshowfldata=="cal_privateeventshowflag")
                                                       {
                                                            if (pendingbkshowflagdata==0)
                                                           {
                                                                  ...
                                                                  privateeventshowflag_trk=pendingbkshowflagdata;
...
{   
  //alert("==== controlname ==== "+controlname+ "==== controlnamedata ===="+controlnamedata+"==== callingurlfunc ===="+callingurlfunc+ " ==== myurldefdata ===="+myurldefdata);
                ...
                //$("#facebook_url").keydown(function(e) {
...
{                      
                ...
                {
                                cmsgdata="Your description has been saved";
                }
...
{          
                ...
                {
                                cmsgdata="Your profile heading has been saved";
                }
...
function calluserimagedelete(imagenamedata,firstimageflagdata,imageiddata,callingurlfunc)
{
                ...
                var cmsgdata="The profile image has been deleted";
...
//poptriggerfunc(msgtype='success',titledata='',msgdata=cmsgdata,sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width');
                                                                ...
                                                                var imagepthnew=base_url_data+"/public/front/otherfiles/progimages/"+"noimagefound52X52.jpg";
                                         
                                                                if (default_image_name!='')
                                                                {
                                                                                imagepthnew=base_url_data+"/public/upload/userimage/thumb-small/"+default_image_name;                                             
                                                                }
...
//    var urlatrriduu=$(".nowseourltxtcommncls").attr("id");
//    // alert(" urlatrriduu "+urlatrriduu);

// //alert("Hello "+urlatrriduu);
//                 var pagemetatagdata=$('#pagemetatagcust_artist').val();

//                 // var callingurl=base_url_data+"/savepagemetatagcust";
//                  var callingurl=base_url_data+"/savepageseotagcust";
...
//                 // var arr = '';
//                 var replacetostring = base_url_data+'artist/';
//                 var replacedstring = pagemetatagdata.replace(base_url_data, "");
//                 replacedstring = replacedstring.replace('/artist/', "");
//                 // alert("replacedstring "+replacedstring);
//                 // arr = pagemetatagdata.split('/');
//                 // var lastItem = arr.pop();

//                 var redirecttourldata = 'artist/'+replacedstring;
...
function bookingoptionstosave()
{
              ...
              /********* added date 22th november 2016 end ***********/
                ...
                errorElement: 'span',//'div',
                                ...
                                rules: {
                                                ...
                                                security_deposit: {
                                                               // required: true,
                                                                numericfield: true,
                                                              // max: function(){ return $("#hourly_rate").val();}
                ...
                if(chkbookingoptionvalidation === true)
                {
                                ...
                                var cmsgdata="Your default Booking Options have been saved";         
                                $.ajax({
                                                url:callingurl,
                                                type:'POST',
                                                dataType:'json',
...
$(".nowseourltxtcommncls").keydown(function(e) {
                ...
                //****** This section is for edit profile review section starts here
                          var previus_reviewstatus = profilehiddenval;//$("#venuehiddenval").val();
                ...
                //****** This section is for edit profile review section ends here
...
//****** document.ready ends
                                ...
                                var venueownid = profilehiddenid;//$("#venuehiddenid").val();
                                var review_url = "showreviewinprofile";
                                var callingurl_review=base_url_data+"/"+review_url;
                                var callurlwithdata={_token:csrf_token_data,'type_flag':1,'reviewyesorno':chkreviewIS_trueORnot,'venueID':venueownid};
