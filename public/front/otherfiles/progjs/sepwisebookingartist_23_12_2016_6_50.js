											...
											dataType:"json",
				                                 ...
				                                 {                                     
				                                    ...
				                                    if (d.respflag == 1)
				                                    {
				                                    	...
				                                    	checkaddrflag = 0;
				                                     	//return false;
				                                      	poptriggerfunc(msgtype='error',titledata='',msgdata="You have already booked this artist please select another date time to continue",sd=1000,hd=1500,tmo=3000,etmo=4000,poscls='toast-top-full-width');   
