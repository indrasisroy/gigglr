                            		...
                            		jQuery.ajax({
											...
											dataType:"json",
                                                ...
                                                flagform5 = 0;
				                                    	checkaddrflag = 0;
				                                     	//return false;
				                                      	poptriggerfunc(msgtype='error',titledata='',msgdata="This venue already have a confirmed event during the time of this event",sd=1000,hd=1500,tmo=3000,etmo=4000,poscls='toast-top-full-width'); 
                                        ...
                                        jQuery.ajax({
                                            ...
                                            else
                                            {
                                               ...
                                               setTimeout(function(){
                                                  ...
                                                  var success_message_data="Congratulations your request was sent";
                                                  poptriggerfunc(msgtype='success',titledata='',msgdata=success_message_data,sd=7000,hd=2500,tmo=6000,etmo=3000,poscls='toast-top-full-width');
                                                  // alert('ewrewr');
