                   ...
                   //alert("Invalid data provided");
                               ...
                               else
                               {
                                   //alert("valid data provided");
                                    poptriggerfunc(msgtype='success',titledata='',msgdata="Please check your Mail to Reset your password",sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width');
                               }
