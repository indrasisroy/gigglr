$(document).ready(function(){
          ...
          if (my_wallet_amount != "0.00" || my_wallet_amount > 0.00) {
                    poptriggerfunc(msgtype='error',titledata='',msgdata="You can't change country , state & currency right now.",sd=6000,hd=1500,tmo=3000,etmo=4000,poscls='toast-top-full-width');
