        ...
        //console.log("======flagdta==>"+flagdta);
         ...
         if (flagdta==1)
         {
             ...
             //****** for binding with  user image slider on change of slider starts 
			  ...
			  poptriggerfunc(msgtype='success',titledata='',msgdata="The menu PDF you uploaded has been saved",sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width');
