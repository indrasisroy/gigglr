      ...
      if (d!=null)
      {
        ...
        //console.log("======flagdta==>"+flagdta);
         ...
         if (flagdta==1)
         {
			  ...
			  poptriggerfunc(msgtype='success',titledata='',msgdata="The Press Kit you uploaded has been saved",sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width');
