                            		...
                            		jQuery.ajax({
											...
											dataType:"json",
                                              ...
                                              //console.log("ajax validation error flag "+flagform5);
				                                     	poptriggerfunc(msgtype='error',titledata='',msgdata="You have already booked this artist please select another date time to continue",sd=1000,hd=1500,tmo=1000,etmo=1500,poscls='toast-top-full-width');   
	...
	if(aggreeval !='' ) 
     ...
     // if(flagform8 = 1)
                ...
                }else
                {
                  ...
                  toastr.remove();
                  poptriggerfunc(msgtype='error',titledata='',msgdata="Please ensure required fields are complete before submitting your request",sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width');  
                }
