...
function openingandclosingtime(opentime,closingtime,datecur_adddatetime)
{
	...
	var momentopeningdateformat = moment(momentdopening,"MM/DD/YYYY h:mm a");

	//var closingtime = moment(closingtime,"h:mm a").format("DD/MM/YYYY h:mm a");
	//var momentclosingdateformat = moment(closingtime,"MM/DD/YYYY h:mm a");
	...
	var closingtimemoment = moment(closingtimeaddmnt,"MM/DD/YYYY h:mm a");
	var bookingdateval = moment(datecur_adddatetime,"DD/MM/YYYY h:mm a").format("DD/MM/YYYY h:mm a");
	var bookingdatevalmoment = moment(bookingdateval,"MM/DD/YYYY h:mm a");
...
function starttimecheck(opentime,closingtime)
{
	...
	var completebookingstarttimemoment = moment(completebookingstarttimeval,"MM/DD/YYYY hh:mm a");
	...
	//var currdate = moment().format("DD/MM/YYYY");
	//alert(" currdate is "+currdate);
	var venuebookingdatetimemoment = moment(completebookingstarttimeval,"MM/DD/YYYY hh:mm a");
	var databasebookingdatetimemoment = moment(closingdatetime,"MM/DD/YYYY hh:mm a");
	...
	var momentdopeningval = moment(momentdopening,"MM/DD/YYYY hh:mm a");
...
function checkendtimevalue(opentime,closingtime)
{
	...
	var closingtimemomentval = moment(closingtimeaddmnt,"MM/DD/YYYY hh:mm a");

	var addendmntmomentval = moment(addendmnt,"MM/DD/YYYY h:mm a");
