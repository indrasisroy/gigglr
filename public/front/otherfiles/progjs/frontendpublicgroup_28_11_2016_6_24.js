               ...
               success:function(d){
                                        ...
                                        if (d!=null)
                                        {
                                            $.each(d, function(idx, obj)
                                                  ...
                                                  select_state_html+="<option value='"+obj.id+"'>"+obj.state_3_code+"</option>";
                         ...
                         //********************FORM SUBMIT VALIDATION************
                              ...
                              if(chkbookingvalidation === true)
                              {
                                  ...
                                  //************ Retriving value starts here
                                   ...
                                   var start_timedata = $("#start_time").val();//starttimehr_val+ ':'+starttimemin_val;
                                   ...
                                   var end_timedata = $("#end_time").val();//endtimehr_val+':'+endtimemin_val;
                                  ...
                                  // var start_timedata = $("#start_time").val();
                                   ...
                                   var requestexpiredtimedata = $("#requestexpiredtime").val();//reqexpirehr+':'+reqexpminval;
...
//***starting                        
            ...
            //***end
                             ...
                             //   var  mndate = moment().format("DD/MM/YYYY");
                              ...
                              //  alert(mndate);
                               ...
                               //*********** This section is added on 22-07-2016 evening last moment before getting out starts here
                                             ...
                                             //   $("#booking_date1").data("DateTimePicker").minDate(getcurdttimemomadd_first);
                                               });
			 ...
			 //  $("#booking_date1").on("dp.change", function(e)
   			//	{
        ...
        //})
          ...
          //
          //
          //                                        var bookingreqdate = $("#booking_date1").val();
     ...
     if (flgBkGrp=='1') {
          ...
          $( ".openmodal" ).click(function() {
            ...
            if (creater_id == logID) {
              ...
              poptriggerfunc(msgtype='error',titledata='',msgdata="You can't booked your own group & This group's rate amount is null",sd=10000,hd=1000,tmo=1000,etmo=2000,poscls='toast-top-full-width');
            }else if (submitBtbFlag == '0') {
              $("#subscribeloader").addClass("mydisplaynone");   
              poptriggerfunc(msgtype='error',titledata='',msgdata="Ops !!!.This group's rate amount is null",sd=6000,hd=1500,tmo=3000,etmo=4000,poscls='toast-top-full-width');
            }else if (logID == '') {

               bookingmodalcheckoption = "group-modal-open"; // for group modal open in click into booking request without login
               $("#myModal1").modal('show');
              // $("#subscribeloader").addClass("mydisplaynone");   
              // poptriggerfunc(msgtype='error',titledata='',msgdata="You must be logged in to continue",sd=6000,hd=1500,tmo=3000,etmo=4000,poscls='toast-top-full-width');
