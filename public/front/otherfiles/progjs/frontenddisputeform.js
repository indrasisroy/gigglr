$(document).ready(function(){
     ...
     $(document).on('click','#consupsub',function(){
          ...
          $.validator.addMethod("checksupportemailformat", function(value, element) 
          {
