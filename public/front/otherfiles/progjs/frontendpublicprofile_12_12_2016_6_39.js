          ...
          if (submitBtbFlag == '0') {
           $('#continue').attr('disabled','disabled');
                ...
                $.validator.addMethod("numericfieldamount", function(value, element) 
                {
                 ...
                 $.validator.addMethod("blankcheckstrttime", function(value, element) 
                {
                     // var starttimeval_hr = $("#start_time_hr").val();       
                      if(value == "")
                      {
                        $("#start_time_hr_error").html('Please enter start time');
                 ...
                 $.validator.addMethod("blankcheckendtime", function(value, element) 
                {
                      //var starttimeval_hr = value;       
                      if(value == "")
                      {
                        $("#end_time_hr_error").html('Please enter start time');
...
//***starting
 ...
 //***ending              
  ...
  //                        var bk_time_val = $("#start_time").val();
                       

  //                     $('#end_time').val('').datetimepicker('update');
  //                     $("#end_time").data("DateTimePicker").date(bk_time_val);
  ...
  //           var fourhrmoment_before_date = moment(ttmoment,"DD/MM/YYYY hh:mm A").subtract(4,'hours').format("DD/MM/YYYY");
  //           var fourhrmoment_before_time = moment(ttmoment,"DD/MM/YYYY hh:mm A").subtract(4,'hours').format("hh:mm A");
  //           var fourhrmoment_before_timemom = moment(ttmoment,"MM/DD/YYYY hh:mm A").subtract(4,'hours');


  //           var fourhrmoment_before_datetimetot = fourhrmoment_before_date+' '+fourhrmoment_before_time;
  //           var fourhrmoment_before_datetimetotmoment = moment(fourhrmoment_before_datetimetot,"MM/DD/YYYY hh:mm A");
           

  //           var reqexpdt = $('#requestexpireddate').val();
  //           var reqexptm = $('#requestexpiredtime').val();

  //           var reqexpdttim = reqexpdt+' '+reqexptm;
  //           var reqexpdttimmom = moment(reqexpdttim,"MM/DD/YYYY hh:mm A");

               
  //            var getcurdttime = new Date();
  //            var getcurdttimemom = moment(getcurdttime).format("MM/DD/YYYY hh:mm A");
  //            var getcurdttime = moment(getcurdttime).format("hh:mm A");
  //            var getcurdttimemom_val = moment(getcurdttimemom,"MM/DD/YYYY hh:mm A");

  //          // console.log(" reqexpdttim "+reqexpdttim+ "reqexpdttimmom "+reqexpdttimmom+ "reqexpdttimmom "+reqexpdttimmom+ " getcurdttime"+getcurdttime);                              

  //           if(reqexpdttimmom > fourhrmoment_before_datetimetotmoment)
  //           {
  //             // console.log("Hello");
  //             $('#requestexpiredtime').val('').datetimepicker('update');
  //             $('#requestexpiredtime').data("DateTimePicker").date(fourhrmoment_before_time);
  //           }else if(reqexpdttimmom < getcurdttimemom_val)
  //           {
  //             // console.log("Hello");
  //             $('#requestexpiredtime').val('').datetimepicker('update');
  //             $('#requestexpiredtime').data("DateTimePicker").date(getcurdttime);
  //           }else
  //           {
  //               $('#requestexpiredtime').val('').datetimepicker('update');
  //               $('#requestexpiredtime').data("DateTimePicker").date(null);
