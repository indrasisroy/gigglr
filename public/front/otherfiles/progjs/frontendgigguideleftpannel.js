...
function loadGigGuideLeftPannel(){
        ...
        if (daymonth == 'day') {
            $(".clickMWD").filter('[data-mdw="day"]').addClass('activepanecolorforrosterleftclass');
        }
     ...
     $(".mycustevntcls").click(function(){
            ...
            if(filterevtypedta=="EVENTFAN")
            {
                if(showevntflag==0)
                {
                          ...
                          $(this).find(".evntxtdtacls").html("Show profiles I like"); //"Show Events I am a fan"
                ...
                else
                {
                           ...
                           $(this).find(".evntxtdtacls").html("Hide profiles I like"); //Hide Events I am a fan
            ...
            else if(filterevtypedta=="EVENTGENRE")
            {
                ...
                {
                          $(this).data("showevntflag",1);
                          $(this).find(".evntxtdtacls").html("Show events of My Profile genres");
                ...
                {
                           $(this).data("showevntflag",0);
                           $(this).find(".evntxtdtacls").html("Hide events of My Profile genres");
            ...
            else if(filterevtypedta=="EVENTTOWN")
            {
                ...
                {
                          $(this).data("showevntflag",1);
                          $(this).find(".evntxtdtacls").html("Show events in my city");
                ...
                {
                           $(this).data("showevntflag",0);
                           $(this).find(".evntxtdtacls").html("Hide events in my city");
