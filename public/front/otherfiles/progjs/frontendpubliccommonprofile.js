$('.rider_btn').click(function(){
                                                        ...
                                                        success:function(d){
                                                              ...
                                                              // alert(d.error_message);
                                                               ...
                                                               // console.log(d.error_message);
                                                                ...
                                                                if(d.return_flag == '1')
                                                                {
                                                                     poptriggerfunc(msgtype='success',titledata='',msgdata='Your Rider has been saved',sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width');
                                                                      $('#myRider').modal('hide');
                                                                      ridervalue = ridertxt;
                ...
                CharacterCountrider = function(){
                                var myField = document.getElementById('rider_txt');
                                var myLabel = document.getElementById('fieldtocountrider');
                                var myErrLabel = document.getElementById('CharCountLabelride');
                ...
                setInterval(function(){
                    CharacterCountrider('rider_txt','CharCountLabelride')},0); 