...
function addMyGenre()
{
   ...
   // alert($(this).val());
                    ...
                    var  skill_sub_data=parseInt($("#skill_sub").val());
                                            ...
                                            var suskillobjchk=prntsklobj.find(".mysubcustcls[data-skillsub='" + skill_sub_data + "']");
                                             ...
                                             //** check whether sub skill present in the structure or not ends 
                                                  ...
                                                  else
                                                  {
                                                       ...
                                                       poptriggerfunc(msgtype='error',titledata='',msgdata="You already have that genre selected",sd=1000,hd=1500,tmo=10000,etmo=2000,poscls='toast-top-full-width');
...
function callpendbkpblshowflclssave(clkobj)
    ...
    function callsaveuserurls(controlname,controlnamedata,callingurlfunc,myurldefdata)
    {
            ...
            var cmsgdata='';
               ...
               else if (controlname=="residentadvisor_url")
               {
                     ...
                     cmsgdata="Zomato URL saved sucessfully";
               }
               else if (controlname=="twitter_url")
               {
               
                    cmsgdata="Twitter URL saved sucessfully";
               }
               else if (controlname=="youtube_url")
               {
                    cmsgdata="Youtube URL saved sucessfully";
               
               }
               else if (controlname=="instagram_url")
               {
               
                    cmsgdata="Instagram URL saved sucessfully";
               }
                         ...
                         if (d.flag_id==0 && d.error_message!='')
                               ...
                               // alert(d.nicknmdata);
                                    // window.location.href = ("http://www.w3schools.com");
                                     poptriggerfunc(msgtype='success',titledata='',msgdata="Your profile title has been saved",sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width');
                                      // if (d.venuecretaeedit == 1) {
                                      //    window.location.href = base_url_data+'/'+'venue-edit/'+d.nicknmdata;
                                      //   //window.location.href = "profile.php";  // replace
                                      // }
    ...
    function callsaveskilldata(catag_type_id,skill_id,skill_sub_id,callingurlfunc)
    {
            ...
            var cmsgdata='The genre you selected has been saved';
    ...
    function  calldeletemyskill(skill_sub_id,callingurlfunc)
    {
            ...
            var cmsgdata='The genre has been removed';
                                   ...
                                   var slider_contents=d.slider_contents;
                                    ...
                                    bindimagedelclick();
                                        ...
                                        showhideprevnextimgslider(totalItems,curritemnum);
                                         ...
                                         toastr.remove();// Immediately remove current toasts without using animation
                                        poptriggerfunc(msgtype='success',titledata='',msgdata="The profile image has been deleted",sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width');
...
//**** character limit checking for tech-spec field in booking options of venue edit-profile page starts
...
//**** character limit checking for tech-spec field in booking options of venue edit-profile page ends
        ...
        //*** code to block removing static urls starts
                 $(".urlcommncustcls").keydown(function(e) {
                                ...
                                var facebook_url_deflt="https://www.facebook.com/";
                                var soundcloud_url_deflt="https://www.soundcloud.com/";
                                var residentadvisor_url_deflt="https://www.zomato.com/";//"https://www.residentadvisor.net/";
                                var twitter_url_deflt="https://www.twitter.com/";
                                var youtube_url_deflt="https://www.youtube.com/";
                                var instagram_url_deflt="https://www.instagram.com/";
...
// changereviewdisplay();
// var ld = 1;
   //   $('input:radio[name="revShow"]').change(ld);
   var previus_reviewstatus = venuehiddenval;//$("#venuehiddenval").val();
   //alert(previus_reviewstatus);
   ...
   else if(previus_reviewstatus == 0)
   {
               ...
               //***** add data ends
                ...
                //**** bind delete to skill starts
                    ...
                    $("#image_name").change(function(){
                                 ...
                                 if (fileext!='')
                                 {
                                     ...
                                     if (chkvalidfiletype==-1)
                                     {
                                             // file type error
                                              ...
                                              errorstr+=' <p> "'+namedata+'" Sorry, this type of file can not be accepted </p>';
                         ...
                         {
                             toastr.remove();// Immediately remove current toasts without using animation
                             poptriggerfunc(msgtype='error',titledata='',msgdata=errorstr,sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width'); 
                                 ...
                                 if (fileext!='')
                                 {
                                     ...
                                     if (chkvalidfiletype==-1)
                                     {
                                             // file type error
                                              ...
                                              errorstr+=' <p>Sorry, but "'+namedata+'" is not a recognised file type </p>';
    ...
    //                             $( "#pagemetatagcust" ).on('blur', function () {
    //                                             var currentVal = $(this).val();
		  //                                      $(this).parents('.btn_row').find('.outPut').text(currentVal);
		  //                                      $(this).parents('.btn_row').removeClass('editable');
    //                                              $(this).parents('.btn_row').find('.editInput').hide();
    ...
    //         	});
                //***** Page-meta-tag data respective code block ends
				        ...
				        //********for calendar show and hide starts
                ...
                //********for calendar show and hide ends
               ...
               //****** calling ajax to save ABN data into db starts
                function callsaveabncustfunc() {
                                ...
                                var cmsgdata="Your ABN has been saved";         
                                $.ajax({
                                                url:callingurl,
                                                type:'POST',
                                                dataType:'json',
             ...
             //****** calling ajax to save GST data into db starts
                function callsavegstcustfunc() {
                                ...
                                var cmsgdata="GST is now applied to your fees";         
                                $.ajax({
                                                url:callingurl,
                                                type:'POST',
                                                dataType:'json',
                                                 ...
                                                 // console.log("Booking response==========>"+d);
                                                   toastr.remove();// Immediately remove current toasts without using animation
                                                                ...
                                                                if (d.errorflagmsghck==0 && d.errormsgdata!='')
                                                                {
                                                                                ...
                                                                                poptriggerfunc(msgtype='error',titledata='',msgdata=error_message_data,sd=1000,hd=1500,tmo=3000,etmo=3000,poscls='toast-top-full-width');          
                                                                }
                                                                else if(d.errorflagmsghck==3)
{
  var error_message=d.errormsgdata;
  var error_message_data='';
  poptriggerfunc(msgtype='error',titledata='',msgdata=error_message,sd=1000,hd=1500,tmo=3000,etmo=3000,poscls='toast-top-full-width');          
}
                                                                else
                                                                {
                                                                               //  $(window).animate({ scrollTop: 0 }, 'slow');
                                                                                 // $(document).scrollTop(0,'slow');
                                                                                 poptriggerfunc(msgtype='success',titledata='',msgdata="Your venue amenities and address have been saved",sd=1000,hd=1500,tmo=1000,etmo=3000,poscls='toast-top-full-width');
                                                                                 var body = $("html, body");
               ...
               function bookingoptionstosave()
             {
              ...
              /********* added date 22th november 2016 end ***********/
                ...
                if(chkbookingoptionvalidation === true)
                {
                                ...
                                var cmsgdata="Your venue default Booking Options have been saved";   
          ...
          if (!confirm('Are you sure?')) return false;
                            ...
                            $.ajax({
                                ...
                                success:function(d){
                                                ...
                                                if (d.flag_id==0 && d.error_message!='')
                                                {
                                                                ...
                                                                poptriggerfunc(msgtype='error',titledata='',msgdata=d.error_message,sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width');
           ...
           // {
                                  ...
                                  $('input:radio[name="revShow"]').change(function(){
                                    ...
                                    // alert(csrf_token_data);
                                //    var venuereviewstatus_prev = $("#venuehiddenval").val();

//if(ld!=1){
                                var venueownid = venuehiddenid;//$("#venuehiddenid").val();
                                var review_url = "showreviewinprofile";
                                var callingurl_review=base_url_data+"/"+review_url;
                                var callurlwithdata={_token:csrf_token_data,'type_flag':3,'reviewyesorno':chkreviewIS_trueORnot,'venueID':venueownid};
                                ...
                                success:function(d)
                                {
                                                ...
                                                //***************** Check response starts
                                                 ...
                                                 if (d.update_flag==0)
                                                {
                                                                poptriggerfunc(msgtype='error',titledata='',msgdata="Something went wrong",sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width');               
                                                }
                                                else
                                                {
                                                  if(d.flag_type == 1)
...
// }
             ...
             // }
                ...
                //*********for checking if the review will be shown or not ends here