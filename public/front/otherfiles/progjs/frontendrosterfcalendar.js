...
//                        }
                ...
                if (rcsipsbb_data=='YELLOWCLOCK')
                         ...
                         else if (rcsipsbb_data=='STARICON')
                        {
                            ...
                            /*
                                 if(chktdsdtandevntdt==true )
                                 {
                                    dificon_cls="bluepersonrevdevroster"; // previously was "yellowgreystardevroster"
                                 }
                            */
                        ...
                        else if (rcsipsbb_data=='BLUEBOOK')
                        {
                                ...
                                /*
                                     if(chktdsdtandevntdt==true )
                                     {
                                        dificon_cls="bluepersonrevdevroster"; 
                                     }
                                 */
                        ...
                        else if (rcsipsbb_data=='PROFILEREVIEW')
                        {
                            // if BLUEBOOK or STARICON  event end time has passed php server time
                                 dificon_cls="bluepersonrevdevroster";
                        }
	...
	$(document).ready(function() {
        ...
        getallrosterCategory(); // populate category
        ...
        $(".commnevttypecls").click(function(event){
         ...
         if(evnttypeshowflag=="REDCLOCK")
         {
            ...
            if(evntshowstatus_data==0)
            {
                ...
                $(this).find(".evnttxtcls").html("Show my pending bookings");
                    ...
                    //remove plus class add minus
                
                     $(this).find(".commonaddminus").removeClass("add_icon");
                     $(this).find(".commonaddminus").addClass("remove_icon");
            ...
            else if(evntshowstatus_data==1)
            {
                ...
                $(this).find(".evnttxtcls").html("Hide my pending bookings");
                    ...
                    //remove minus class add plus class
                
                     $(this).find(".commonaddminus").removeClass("remove_icon");
                     $(this).find(".commonaddminus").addClass("add_icon");
         ...
         else if(evnttypeshowflag=="PROFILEEVENTSHIDE")
         {
                //***** special case scenario differnt from above 
                ...
                {
                    $(this).data("evntshowstatus",'1');
                    $(this).find(".evnttxtcls").html("Show profile events");
                ...
                else if(evntshowstatus_data==1)
                {
                    ...
                    $(this).data("evntshowstatus",'0');
                    $(this).find(".evnttxtcls").html("Hide profile events");
          ...
          callleftlistbycurdt();
            ...
            $("#expoertEvents").on('click', function() {
                ...
                var todt = Date.parse(endDate) / 1000;
                 ...
                 var callingurl=base_url_data+"/"+"totalexporteddata";
                var callurlwithdata={_token:csrf_token_data,fromdt:fromdt,todt:todt};
                ...
                $.ajax({
                    ...
                    success:function(d){
                        if (d.totaldata>0) {
                            $('#exportICS').modal('hide');
                            window.open(base_url_data+'/exportingics/'+fromdt+'/'+todt);
                        }
                        else{
                            $('#exportICS').modal('hide');
                            poptriggerfunc(msgtype='error',titledata='',msgdata="Sorry, but there's no events in this date range to export",sd=1000,hd=1500,tmo=3000,etmo=4000,poscls='toast-top-full-width');
                        }
                    }
                });
            });
