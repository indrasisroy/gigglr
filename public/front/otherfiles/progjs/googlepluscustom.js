                                                ...
                                                if(user_type=='')
                                                    {
                                                       ...
                                                       if(googleloginfiredfrom!="signupmodal")
                                                       {
                                                           ...
                                                           poptriggerfunc(msgtype='success',titledata='',msgdata=error_message_data,sd=1000,hd=1000,tmo=1000,etmo=1000,poscls='toast-top-full-width'); 
