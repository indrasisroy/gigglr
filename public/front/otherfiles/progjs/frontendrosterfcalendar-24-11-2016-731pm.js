                ...
                $.ajax({
                    ...
                    success:function(d){
                        if (d.totaldata>0) {
                            ...
                            $('#exportICS').modal('hide');
                            poptriggerfunc(msgtype='error',titledata='',msgdata="Data can not be exported as there is no data in these date range",sd=1000,hd=1500,tmo=3000,etmo=4000,poscls='toast-top-full-width');
                        }
                    }
                });
            });
