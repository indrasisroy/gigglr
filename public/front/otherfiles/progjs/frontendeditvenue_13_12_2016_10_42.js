                                   ...
                                   var slider_contents=d.slider_contents;
                                    ...
                                    bindimagedelclick();
                                        ...
                                        showhideprevnextimgslider(totalItems,curritemnum);
                                         ...
                                         toastr.remove();// Immediately remove current toasts without using animation
                                        poptriggerfunc(msgtype='success',titledata='',msgdata="Venue image deleted successfully",sd=1000,hd=1500,tmo=1000,etmo=1000,poscls='toast-top-full-width');
  ...
  poptriggerfunc(msgtype='error',titledata='',msgdata=error_message,sd=1000,hd=1500,tmo=3000,etmo=3000,poscls='toast-top-full-width');          
                                                                ...
                                                                else
                                                                {
                                                                               //  $(window).animate({ scrollTop: 0 }, 'slow');
                                                                                 ...
                                                                                 poptriggerfunc(msgtype='success',titledata='',msgdata="Address and Amenities updated successfully ",sd=1000,hd=1500,tmo=1000,etmo=3000,poscls='toast-top-full-width');
                                                                                 var body = $("html, body");
